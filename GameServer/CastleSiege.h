...
public:
	...
	void CS_ClearAllNPC();
	void CS_CreateDbNPC();
	void CS_CreateNonDbNPC(BOOL bDelFirst);
	int CS_CheckAddDbNPC(int iIndex, int iNpcType, int iNpcIndex, BYTE & btResult);
	int CS_AddDbNPC(int iNpcType, int iNpcIndex);
	int CS_RepairDbNPC(int iNpcType, int iNpcIndex, int iNpcHP, int iNpcMaxHP);
	int CS_PayForUpgradeDbNpc(int iIndex, int iNpcType, int iNpcIndex, int iNpcUpType, int iNpcUpValue, int iNpcUpIndex);
	int CS_UpgradeDbNPC(int iIndex, int iNpcType, int iNpcIndex, int iNpcUpType, int iNpcUpValue, int iNpcUpIndex);
