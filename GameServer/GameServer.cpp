...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
	...
	ShowWindow(ghWnd, SW_NORMAL);// Show GameServer Window
...
BOOL GameServerStart(void) {
	...
	g_Log.Add("Created and developed by IGC-Network.");
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow) {
	HWND hWnd;
    hWnd = CreateWindowExA(0, szWindowClass, szTitle, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, 0, CW_USEDEFAULT, 0, NULL, NULL, hInstance, NULL);
			...
			switch (wmId) {
				...
				case ID_DISCONNECTWITHMESSAGE_5MINUTES:
					if (gCloseMsg == 0) {
						gCloseMsgTime = 300;
						gCloseMsg = 1;
						GSProtocol.PROTOCOL_SendServerAnnounce(Lang.GetText(0,38));
					}
				break;
				...
				case ID_DISCONNECTWITHMESSAGE_3MINUTES:
					if (gCloseMsg == 0) {
						gCloseMsgTime = 180;
						gCloseMsg = 2;
						GSProtocol.PROTOCOL_SendServerAnnounce(Lang.GetText(0,39));
					}
				break;
				...
				case ID_DISCONNECTWITHMESSAGE_1MINUTE:
					if (gCloseMsg == 0) {
						gCloseMsgTime = 60;
						gCloseMsg = 3;
						GSProtocol.PROTOCOL_SendServerAnnounce(Lang.GetText(0,40));
					}
				break;
