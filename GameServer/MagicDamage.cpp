...
void CMagicDamage::Init() {
	for (int n = 0; n < MAX_SKILL; n++) this->m_Damage[n] = -1;
}
...
void CMagicDamage::LogSkillList(char * filename) {
	...
	for (pugi::xml_node skill = main.child("Skill"); skill; skill = skill.next_sibling()) {
		...
		if (g_ConfigRead.SeasonX == false) attr = skill.attribute("Attribute").as_int();
		else attr = skill.attribute("Element").as_int();
...
void CMagicDamage::Set(char* name, int skill, int damage,  int rlevel,  int mana,  int bp,  int dis, int Attr,  int iSkillType, unsigned char* ReqClass, int rEnergy, int rLeadership, int rdelay, BYTE byItemSkill, BYTE byIsDamage, BYTE byBufIndex) {
	...
	if (this->m_RequireEnergy[skill] <= 0) this->m_RequireEnergy[skill] = 0;
	...
	if (skill == 41) this->m_RequireLevel[skill] = 80;
	else if (skill == 42) this->m_RequireLevel[skill] = 170;
	else if (skill == 43) this->m_RequireLevel[skill] = 160;
	else if (skill == 47) this->m_RequireLevel[skill] = 28;
	else if (skill == 48) this->m_RequireLevel[skill] = 120;
	else if (skill == 52) this->m_RequireLevel[skill] = 130;

	if (skill == 30) this->m_RequireEnergy[skill] = 30;
	else if (skill == 31) this->m_RequireEnergy[skill] = 60;
	else if (skill == 32) this->m_RequireEnergy[skill] = 90;
	else if (skill == 33) this->m_RequireEnergy[skill] = 130;
	else if (skill == 34) this->m_RequireEnergy[skill] = 170;
	else if (skill == 35) this->m_RequireEnergy[skill] = 210;
	else if (skill == 36) this->m_RequireEnergy[skill] = 300;
	else if (skill == 41) this->m_RequireEnergy[skill] = 0;
	else if (skill == 42) this->m_RequireEnergy[skill] = 0;
	else if (skill == 43) this->m_RequireEnergy[skill] = 0;
	else if (skill == 47) this->m_RequireEnergy[skill] = 0;
	else if (skill == 48) this->m_RequireEnergy[skill] = 0;
	else if (skill == 49) this->m_RequireEnergy[skill] = 0;
	else if (skill == 55) this->m_RequireEnergy[skill] = 0;
	else if (skill == 51) this->m_RequireEnergy[skill] = 0;
	else if (skill == 52) this->m_RequireEnergy[skill] = 0;
	else if (skill == 24) this->m_RequireEnergy[skill] = 0;
	else if (skill == 17) this->m_RequireEnergy[skill] = 0;
	else if (skill == 18) this->m_RequireEnergy[skill] = 0;
	else if (skill == 19) this->m_RequireEnergy[skill] = 0;
	else if (skill == 20) this->m_RequireEnergy[skill] = 0;
	else if (skill == 21) this->m_RequireEnergy[skill] = 0;
	else if (skill == 22) this->m_RequireEnergy[skill] = 0;
	else if (skill == 23) this->m_RequireEnergy[skill] = 0;
	else if (skill == 25) this->m_RequireEnergy[skill] = 0;
	else if (skill == 56) this->m_RequireEnergy[skill] = 0;
	else if (skill == 60) this->m_RequireEnergy[skill] = 0;
	else if (skill == 44) this->m_RequireEnergy[skill] = 0;
	else if (skill == 45) this->m_RequireEnergy[skill] = 0;
	else if (skill == 46) this->m_RequireEnergy[skill] = 0;
	else if (skill == 57) this->m_RequireEnergy[skill] = 0;
	else if (skill == 73) this->m_RequireEnergy[skill] = 0;
	else if (skill == 74) this->m_RequireEnergy[skill] = 0;
	else if (skill == 67) this->m_RequireEnergy[skill] = 0;
	else if (skill == 68) this->m_RequireEnergy[skill] = 0;
	else if (skill == 69) this->m_RequireEnergy[skill] = 0;
	else if (skill == 70) this->m_RequireEnergy[skill] = 0;
	else if (skill == 71) this->m_RequireEnergy[skill] = 0;
	else if (skill == 72) this->m_RequireEnergy[skill] = 0;
	else if (skill == 76) this->m_RequireEnergy[skill] = 0;
	else if (skill == 77) this->m_RequireEnergy[skill] = 0;
	else if (skill == 78) this->m_RequireEnergy[skill] = 0;
	else if (skill == 79) this->m_RequireEnergy[skill] = 0;
	else if (skill == 62) this->m_RequireEnergy[skill] = 0;
	else if (skill == 214) this->m_RequireEnergy[skill] = 0;
	else if (skill == 215) this->m_RequireEnergy[skill] = 0;
	else if (skill == 216) this->m_RequireEnergy[skill] = 0;
	else if (skill == 217) this->m_RequireEnergy[skill] = 0;
	else if (skill == 219) this->m_RequireEnergy[skill] = 0;
	else if (skill == 220) this->m_RequireEnergy[skill] = 0;
	else if (skill == 223) this->m_RequireEnergy[skill] = 0;
	else if (skill == 224) this->m_RequireEnergy[skill] = 0;
	else if (skill == 221) this->m_RequireEnergy[skill] = 0;
	else if (skill == 222) this->m_RequireEnergy[skill] = 0;
	else if (skill == 225) this->m_RequireEnergy[skill] = 0;
	else if (skill == 230) this->m_RequireEnergy[skill] = 0;
	else if (skill == 218) this->m_RequireEnergy[skill] = 0;
	else if (skill == 232) this->m_RequireEnergy[skill] = 0;
	else if (skill == 233) this->m_RequireEnergy[skill] = 0;
	else if (skill == 234) this->m_RequireEnergy[skill] = 0;
	else if (skill == 235) this->m_RequireEnergy[skill] = 0;
	else if (skill == 236) this->m_RequireEnergy[skill] = 0;
	else if (skill == 237) this->m_RequireEnergy[skill] = 0;
	else if (skill == 238) this->m_RequireEnergy[skill] = 0;
	else if (skill == 239) this->m_RequireEnergy[skill] = 0;
	else if (skill == 260) this->m_RequireEnergy[skill] = 0;
	else if (skill == 261) this->m_RequireEnergy[skill] = 0;
	else if (skill == 262) this->m_RequireEnergy[skill] = 0;
	else if (skill == 263) this->m_RequireEnergy[skill] = 0;
	else if (skill == 264) this->m_RequireEnergy[skill] = 0;
	else if (skill == 265) this->m_RequireEnergy[skill] = 0;
	else if (skill == 266) this->m_RequireEnergy[skill] = 0;
	else if (skill == 267) this->m_RequireEnergy[skill] = 0;
	else if (skill == 268) this->m_RequireEnergy[skill] = 0;
	else if (skill == 269) this->m_RequireEnergy[skill] = 0;
	else if (skill == 270) this->m_RequireEnergy[skill] = 0;
}
...
int CMagicDamage::MAGIC_GetManaUsage(int skill)
{
	if (skill < 0 || skill > MAX_SKILL-1)
	{
		g_Log.Add("Skill limit error: (%s %d), ID: %d", __FILE__, __LINE__, skill);
...
int CMagicDamage::MAGIC_GetStamUsage(int skill) {
	if (skill < 0 || skill > MAX_SKILL - 1)	{
		g_Log.Add("Skill limit error: (%s %d), ID: %d", __FILE__, __LINE__, skill);
		return FALSE;
	}
...
int CMagicDamage::MAGIC_GetRequireEnergy(int skill)
{
	if (skill < 0 || skill > MAX_SKILL-1)
	{
		g_Log.Add("Skill limit error: (%s %d), ID: %d", __FILE__, __LINE__, skill);
...
BOOL CMagicDamage::MAGIC_GetRequireClass(int Cclass, int ChangeUP,  int skill) {
	if (skill < 0 || skill > MAX_SKILL - 1) {
		g_Log.Add("Skill limit error: (%s %d), ID: %d", __FILE__, __LINE__, skill);
		return -1;
	}
	...
	if (requireclass > 1) {
		if (requireclass > (ChangeUP + 1)) return FALSE;
	}
...
int CMagicDamage::MAGIC_GetSkillAttr(int skill) {
	if (skill < 0 || skill > MAX_SKILL - 1) return -1;
...
int CMagicDamage::MAGIC_GetRequireLeadership(int skill)
{
	if (skill < 0 || skill > MAX_SKILL-1)
	{
		g_Log.Add("Skill limit error: (%s %d), ID: %d", __FILE__, __LINE__, skill);
