...
void CMarry::Propose(int aIndex, int uIndex)
{
	...
	if (this->m_iMarryNeedMoney > gObj[aIndex].CharacterData->Money || this->m_iMarryNeedMoney > gObj[uIndex].CharacterData->Money)
	{
...
bool CMarry::Accept(int aIndex)
{
	...
	if (gObj[uIndex].CharacterData->Money < gObj[uIndex].CharacterData->Money - this->m_iMarryNeedMoney || gObj[aIndex].CharacterData->Money < gObj[aIndex].CharacterData->Money - this->m_iMarryNeedMoney)
	{
	...
	gObj[aIndex].CharacterData->Money -= this->m_iMarryNeedMoney;
	...
	gObj[uIndex].CharacterData->Money -= this->m_iMarryNeedMoney;
	GSProtocol.GCMoneySend(uIndex, gObj[uIndex].CharacterData->Money);
	...
	GSProtocol.PROTOCOL_SendServerAnnounce(info);
