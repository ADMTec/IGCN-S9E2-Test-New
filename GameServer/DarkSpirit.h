...
public:
  ...
  int CalcAttackDamage(LPOBJ lpObj, int targetDefense, int criticaldamage);
  int ATTACK_MissCheck(LPOBJ lpObj, LPOBJ lpTargetObj, int skill,  int skillSuccess, int& bAllMiss);
  int ATTACK_MissCheckPvP(LPOBJ lpObj, LPOBJ lpTargetObj, int skill,  int skillSuccess, int& bAllMiss);
