...
public:
	...
	void PROTOCOL_Core(BYTE protoNum, LPBYTE aRecv, int aLen, int aIndex, BOOL Encrypt);
	...
	void PROTOCOL_CheckMainExeKeySend(int aIndex);
	WORD EncryptCheckSumKey(WORD wSource);
	void PROTOCOL_CheckMainChecksum(PMSG_CHECK_MAINEXE_RESULT* lpMsg, int aIndex);
	...
	void PROTOCOL_ChatSend(LPOBJ lpObj, char* szChat);
	void PROTOCOL_vChatSend(LPOBJ lpObj, char* szChat, ...);
	void PROTOCOL_SendServerAnnounce(char* chatmsg);
	void PROTOCOL_DataSendAll(unsigned char* lpMsg, int iMsgSize);
	void PROTOCOL_NPCChatSend(LPOBJ lpObj, char* szChat, int senduser);
	void PROTOCOL_ChatSpecial(PMSG_CHATDATA* lpChat, short aIndex);
	...
	void PROTOCOL_ChatWhisper(PMSG_CHATDATA_WHISPER* lpMsg, int aIndex);
	...
	void PROTOCOL_WarehouseStateSend(int aIndex, unsigned char state);
	void PROTOCOL_WarehouseReceivePassword(int aIndex,PMSG_WAREHOUSEPASSSEND* lpMsg);
	void PROTOCOL_UserChaosBoxSend(LPOBJ lpObj, int iChaosBoxType);
	void PROTOCOL_ChaosBoxItemMixButtonClick(PMSG_CHAOSMIX* aRecv, int aIndex);
	void PROTOCOL_ChaosBoxUseEnd(int aIndex);
	void PROTOCOL_MoveProc(PMSG_MOVE* lpMove, int aIndex);
	void PROTOCOL_RecvPositionSetProc(PMSG_POSISTION_SET* lpMove, int aIndex);
	void PROTOCOL_Attack(PMSG_ATTACK* lpMsg, int aIndex);
	void PROTOCOL_DamageSendPoison(int aIndex, int damage, int iShieldDamage);
	void PROTOCOL_DamageSend(int aIndex, int TargetIndex, int AttackDamage, int MSBFlag, int MSBDamage, int iShieldDamage);
	void PROTOCOL_PlayerExperienceSend(int aIndex, int TargetIndex, int exp, int AttackDamage, BOOL MSBFlag);
	void PROTOCOL_DiePlayerSend(LPOBJ lpObj, int TargetIndex, BYTE skill, int KillerIndex);
	void PROTOCOL_ActionSend(LPOBJ lpObj, BYTE ActionNumber, int aIndex, int aTargetIndex);
	void PROTOCOL_ActionRecv(PMSG_ACTION* lpMsg, int aIndex);
	void PROTOCOL_MagicAttack(LPBYTE lpRecv, int aIndex);
	void PROTOCOL_RageFighterAttack(LPBYTE lpRecv, int aIndex);
	void PROTOCOL_RageFighterAttackRange(PMSG_RAGE_ATTACK_RANGE* lpMsg, int aIndex);
	void PROTOCOL_MagicAttackNumberSend(LPOBJ lpObj, WORD MagicNumber, int usernumber, unsigned char skillsuccess);
	void PROTOCOL_RageFighterMagicAttack(LPOBJ lpObj, WORD MagicNumber, int usernumber,  unsigned char skillsuccess);
	void PROTOCOL_MagicCancelSend(LPOBJ lpObj, WORD MagicNumber);
	void GCMagicCancel(PMSG_MAGICCANCEL * lpMsg, int aIndex);
	void PROTOCOL_UseEffectItem(LPOBJ lpObj, int iEffectUseOption, int iOptionType, int iEffectType, int iLeftTime);
	void GCUseEffectItem2(LPOBJ lpObj, int iEffectUseOption, int iOptionType, int iEffectType, int iLeftTime);
	void PROTOCOL_MagicCancel(PMSG_MAGICCANCEL* lpMsg, int aIndex);
	void PROTOCOL_UseMonsterSkillSend(LPOBJ lpObj, LPOBJ lpTargetObj, int iSkillNumber);
	void PROTOCOL_StateInfoSend(LPOBJ lpObj, unsigned char state, int BuffViewport);
	void PROTOCOL_TeleportRecv(PMSG_TELEPORT* lpMsg, int aIndex);
	void PROTOCOL_ReqMapMove(PMSG_REQ_MAPMOVE *lpMsg, int iIndex);
	void PROTOCOL_SendMapMoveCheckSum(LPOBJ lpObj);
	void PROTOCOL_TargetTeleportRecv(PMSG_TARGET_TELEPORT* lpMsg, int aIndex);
	void PROTOCOL_TeleportSend(LPOBJ lpObj, unsigned short MoveNumber, BYTE MapNumber, BYTE MapX, BYTE MapY, BYTE Dir);
	void PROTOCOL_CheckAttackRecv(unsigned char* lpRecv, int aIndex, int magic_send);
	void PROTOCOL_DurationMagicRecv(LPBYTE lpRecv, int aIndex);
	void ObjectMapJoinPositionSend(short aIndex);
	void PROTOCOL_UseItemRecv(PMSG_USEITEM* lpMsg, int aIndex);
	void PROTOCOL_ReFillSend(int aIndex, int Life, BYTE Ipos, unsigned char flag,  WORD wShield);
	void PROTOCOL_ManaSend(int aIndex, int Mana, BYTE Ipos, unsigned char flag,  WORD Stamina);
	void PROTOCOL_InventoryItemDeleteSend(int aIndex, BYTE pos, unsigned char flag);
	...
	void PROTOCOL_ChaosCastleEntry(PMSG_REQ_MOVECHAOSCASTLE* lpMsg, int iIndex);
	...
	void PROTOCOL_SendEffectInfo(int aIndex, BYTE btType);
	...
	void PROTOCOL_GetCastleNpcData(PMSG_REQ_NPCDBLIST* lpMsg, int iIndex);
	...
	void PROTOCOL_CheckJewelPack(PMSG_REQ_JEWEL_MIX* lpMsg, int iIndex);
	void PROTOCOL_JewelPack(int iIndex, int iResult);
	void PROTOCOL_CheckJewelUnpack(PMSG_REQ_JEWEL_UNMIX* lpMsg, int iIndex);
	void PROTOCOL_JewelUnpack(int iIndex, int iResult);
	...
	void PROTOCOL_CrywolfBenefitChaosSuccessRate(PMSG_REQ_CRYWOLF_BENEFIT_PLUS_CHAOSRATE* lpMsg, int iIndex);
	...
	void PROTOCOL_LandOfTrialsEntry(PMSG_REQ_MOVE_TO_CASTLE_HUNTZONE* aRecv, int aIndex);
	void GCSendObjectCreationState(int iObjectIndex);
	void GCSendObjectHP(int aIndex, int aTargetIndex);
	void PROTOCOL_CheckSpeedHack(int aIndex, PMSG_SEND_AH_INFO * aRecv);
	void PROTOCOL_CheckCRC(int aIndex, PMSG_REQ_CRCDATA * aRecv);
	void PROTOCOL_ElementalDamageSend(int aIndex, int TargetIndex, int Damage, int Elemental);
	void GCSendErtelInfo(int aIndex);
	void PROTOCOL_AcheronEntry(int aIndex);
	...
	void PROTOCOL_AttackSpeedSend(int iIndex);
	...
	void PROTOCOL_CheckHackBreach(int aIndex, PMSG_ANTIHACK_BREACH *lpMsg);
	void PROTOCOL_HookAntiHack(int aIndex, PMSG_ANTIHACK_CHECK *lpMsg);
	...
	void PROTOCOL_CheckHitHack(int aIndex, PMSG_SEND_HITHACK_INFO * lpMsg);
private:
