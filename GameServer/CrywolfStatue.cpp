...
void CCrywolfStatue::SetStatueViewState(LPOBJ lpObj, int iPriestNumber) {
	switch (iPriestNumber) {
		case 0:
			BUFF_AddBuffEffect(lpObj, BUFFTYPE_CRYWOLF_STATUE_LV1, 0, 0, 0, 0, -10);
		break;

		case 1:
			BUFF_AddBuffEffect(lpObj, BUFFTYPE_CRYWOLF_STATUE_LV2, 0, 0, 0, 0, -10);
		break;

		case 2:
			BUFF_AddBuffEffect(lpObj, BUFFTYPE_CRYWOLF_STATUE_LV3, 0, 0, 0, 0, -10);
		break;

		case 3:
			BUFF_AddBuffEffect(lpObj, BUFFTYPE_CRYWOLF_STATUE_LV4, 0, 0, 0, 0, -10);
		break;

		case 4:
			BUFF_AddBuffEffect(lpObj, BUFFTYPE_CRYWOLF_STATUE_LV5, 0, 0, 0, 0, -10);
		break;
	}
}
...
void CCrywolfStatue::CrywolfStatueAct(int iIndex) {
	...
	if (gObj[iIndex].Type != OBJ_NPC || CHECK_CLASS(204, gObj[iIndex].Class) == FALSE) return;
