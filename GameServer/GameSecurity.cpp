...
void CGameSecurity::DebugInfo(int aIndex)
{
	...
	else
	{
		...
		g_Log.AddC(TColor::Orange,"[Debug ANTI-HACK][%d][%s][%s] Attack Speed: %d Time Between last attack = %f",aIndex, gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].AttackSpeed, realAttackSpeed);
