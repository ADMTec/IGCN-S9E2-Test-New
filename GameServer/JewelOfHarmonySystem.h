...
struct JEWELOFHARMONY_ITEM_EFFECT {
	short JoH_MinimumPhysicalDamage;	// 0
	short JoH_MaximumPhysicalDamage;	// 2
	short JoH_ReduceStrengthRequirement;	// 4
	short JoH_ReduceAgilityRequirement;	// 6
	short JoH_PhysicalDamage;	// 8
	short CriticalDamage;	// A
	short SkillDamage;	// C
	short HitRatingPvP;	// E
	short ShieldBypassRate;	// 10
	short ShieldPenetrationChance;	// 12
	short JoH_SpellDamage;	// 14
	short JoH_Defense;	// 16
	short JoH_MaximumStamina;	// 18
	short JoH_MaximumLife;	// 1A
	short JoH_LifeRegeneration;	// 1C
	short JoH_ManaRegeneration;	// 1E
	short EvasionRatingPvP;	// 20
	short JoH_ReduceDamageTaken;	// 22
	short ReduceShieldDamageTaken;	// 24
};
