...
// PROTOCOL_MoveProc - Weird form of compilation
...
void GameProtocol::PROTOCOL_Core(BYTE protoNum, unsigned char * aRecv, int aLen, int aIndex, BOOL Encrypt) {
	...
	if (gStalkProtocol) {
		if (gStalkProtocolId[0] == gObj[aIndex].AccountID[0]) {
			if (gStalkProtocolId[1] == gObj[aIndex].AccountID[1]) {
				if (!strcmp(gStalkProtocolId, gObj[aIndex].AccountID)) g_Log.AddHeadHex("DATA RECV", aRecv, aLen);
			}
		}
	}
	...
	if (protoNum == 0xF1 || protoNum == 0xF3) {
		switch (protoNum) {
			case 0xF1: {
				...
				switch (lpMsg2->subcode) {
					case 0x01:					if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CSPJoinIdPassRequest((PMSG_IDPASS *)aRecv, aIndex);																			break;
					case 0x02:					if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CGClientCloseMsg((PMSG_CLIENTCLOSE *)aRecv, aIndex);																			break;
					case 0x03:					if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CGClientMsg((PMSG_CLIENTMSG *)aRecv, aIndex);																					break;
					default:					g_Log.AddC(TColor::Blue,  "UNKNOWN F1 PACKET: %x %x %x %x %x %x %x %x %x %x", aRecv[0], aRecv[1], aRecv[2], aRecv[3], aRecv[4], aRecv[5], aRecv[6], aRecv[7], aRecv[8], aRecv[9]);					break;
			...
			case 0xF3: {
				...
				switch (lpDef->subcode) {
					case 0x00:		DataServerGetCharListRequest(aIndex);									break;
					case 0x01:		this->CGPCharacterCreate((PMSG_CHARCREATE *)aRecv, aIndex);				break;
					case 0x02:		this->CGPCharDel((PMSG_CHARDELETE *)aRecv, aIndex);						break;
					case 0x03:		this->CGPCharacterMapJoinRequest((PMSG_CHARMAPJOIN*)aRecv, aIndex);		break;
					case 0x06:		this->CGLevelUpPointAdd((PMSG_LVPOINTADD *)aRecv, aIndex);				break;
					case 0x10:																				break;
					case 0x12:		gObjMoveDataLoadingOK(aIndex);											break;
					case 0x15: {
					...
					case 0x21:		this->CGReqUseTransformationRing((PMSG_REQ_USETRANSFORMATIONRING *)aRecv, aIndex);																																		break;
					case 0x26:		this->CGReqDoUsePopupType(aIndex);																																														break;
					case 0x30:		this->GCSkillKeyRecv((PMSG_SKILLKEY *)aRecv, aIndex);																																									break;
					case 0x52:		g_MasterLevelSkillTreeSystem.CGReqGetMasterLevelSkill((PMSG_REQ_MASTERLEVEL_SKILL *)aRecv, aIndex);																														break;
					case 0x31:		g_Log.AddC(TColor::Blue,  "WARNING: TRAP MESSAGE PACKET FROM MAIN: %x %x %x %x %x %x %x %x %x %x", Encrypt, aRecv[0], aRecv[1], aRecv[2], aRecv[3], aRecv[4], aRecv[5], aRecv[6], aRecv[7], aRecv[8], aRecv[9]);		break;
					default:		g_Log.AddC(TColor::Blue,  "UNKNOWN F3 PACKET: %x %x %x %x %x %x %x %x %x %x", aRecv[0], aRecv[1], aRecv[2], aRecv[3], aRecv[4], aRecv[5], aRecv[6], aRecv[7], aRecv[8], aRecv[9]);										break;
				}
			}
			break;
		}
		...
		switch (protoNum) {
			case 0x00:		this->PROTOCOL_ChatSpecial((PMSG_CHATDATA *)aRecv, aIndex);																						break;
			case 0x01:		this->CGChatRecv((PMSG_CHATDATA_NUMBER *)aRecv, aIndex);																						break;
			case 0x02:		this->PROTOCOL_ChatWhisper((PMSG_CHATDATA_WHISPER *)aRecv, aIndex);																				break;
			case 0x03:		this->PROTOCOL_CheckMainChecksum((PMSG_CHECK_MAINEXE_RESULT *)aRecv, aIndex);																	break;
			case 0x0E:		this->CGLiveClient((PMSG_CLIENTTIME *)aRecv, aIndex);																							break;
			case 0xD4:		this->PROTOCOL_MoveProc((PMSG_MOVE *)aRecv, aIndex);																									break;
			case 0x15:		this->PROTOCOL_RecvPositionSetProc((PMSG_POSISTION_SET *)aRecv, aIndex);																					break;
			case 0x11:		this->PROTOCOL_Attack((PMSG_ATTACK *)aRecv, aIndex);																									break;
			case 0x18:		this->PROTOCOL_ActionRecv((PMSG_ACTION *)aRecv, aIndex);																								break;
			case 0x19:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->PROTOCOL_MagicAttack(aRecv, aIndex);												break;
			case 0x1B:		this->PROTOCOL_MagicCancel((PMSG_MAGICCANCEL *)aRecv, aIndex);																							break;
			case 0x1C:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->PROTOCOL_TeleportRecv((PMSG_TELEPORT *)aRecv, aIndex);							break;
			case 0x8E:		if (aRecv[3] == 0x02) this->PROTOCOL_ReqMapMove((PMSG_REQ_MAPMOVE *)aRecv, aIndex);																	break;
			case 0xB0:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->PROTOCOL_TargetTeleportRecv((PMSG_TARGET_TELEPORT *)aRecv, aIndex);				break;
			case 0xDF:		this->PROTOCOL_CheckAttackRecv(aRecv, aIndex, FALSE);																							break;
			case 0x1E:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->PROTOCOL_DurationMagicRecv(aRecv, aIndex);										break;
			case 0x22:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CGItemGetRequest((PMSG_ITEMGETREQUEST *)aRecv, aIndex);					break;
			case 0x23:		this->CGItemDropRequest((PMSG_ITEMTHROW *)aRecv, aIndex, 0);																					break;
			case 0x24:		this->CGInventoryItemMove((PMSG_INVENTORYITEMMOVE *)aRecv, aIndex);																				break;
			case 0x26:		this->PROTOCOL_UseItemRecv((PMSG_USEITEM *)aRecv, aIndex);																								break;
			case 0x30:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE)	this->CGTalkRequestRecv((PMSG_TALKREQUEST *)aRecv, aIndex);						break;
			case 0x31:		this->CGCloseWindow(aIndex);																													break;
			case 0x32:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CGBuyRequestRecv((PMSG_BUYREQUEST *)aRecv, aIndex);						break;
			case 0x33:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) CGSellRequestRecv((PMSG_SELLREQUEST *)aRecv, aIndex);							break;
			case 0x34:		this->CGModifyRequestItem((PMSG_ITEMDURREPAIR *)aRecv, aIndex);																					break;
			case 0x36:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CGTradeRequestSend((PMSG_TRADE_REQUEST *)aRecv, aIndex);					break;
			case 0x37:		this->CGTradeResponseRecv((PMSG_TRADE_RESPONSE *)aRecv, aIndex);																				break;
			case 0x3A:		this->CGTradeMoneyRecv((PMSG_TRADE_GOLD *)aRecv, aIndex);																						break;
			case 0x3C:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CGTradeOkButtonRecv((PMSG_TRADE_OKBUTTON *)aRecv, aIndex);				break;
			case 0x3D:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CGTradeCancelButtonRecv(aIndex);											break;
			case 0x3F: {
				PMSG_DEFAULT2 * lpDef = (PMSG_DEFAULT2 *)aRecv;

				switch (lpDef->subcode) {
					case 0x01:				g_PersonalStore.CGPShopReqSetItemPrice((PMSG_REQ_PSHOP_SETITEMPRICE *)aRecv, aIndex);				break;
					case 0x02:				g_PersonalStore.CGPShopReqOpen((PMSG_REQ_PSHOP_OPEN *)aRecv, aIndex);								break;
					case 0x03:				g_PersonalStore.CGPShopReqClose(aIndex);															break;
					case 0x05:				g_PersonalStore.CGPShopReqBuyList((PMSG_REQ_BUYLIST_FROM_PSHOP *)aRecv, aIndex);					break;
					case 0x06:				g_PersonalStore.CGPShopReqBuyItem(aRecv, aIndex);													break;
					case 0x07:				g_PersonalStore.CGPShopReqCloseDeal((PMSG_REQ_PSHOPDEAL_CLOSE *)aRecv, aIndex);						break;
				}
			}
			break;

			case 0x40:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CGPartyRequestRecv((PMSG_PARTYREQUEST *)aRecv, aIndex);					break;
			case 0x41:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CGPartyRequestResultRecv((PMSG_PARTYREQUESTRESULT *)aRecv, aIndex);		break;
			case 0x42:		this->CGPartyList(aIndex);																														break;
			case 0x43:		if (this->PacketCheckTime(aIndex) == TRUE) this->CGPartyDelUser((PMSG_PARTYDELUSER *)aRecv, aIndex, 1);											break;
			case 0x4A:		this->PROTOCOL_RageFighterAttack(aRecv, aIndex);																												break;
			case 0x4B:		this->PROTOCOL_RageFighterAttackRange((PMSG_RAGE_ATTACK_RANGE *)aRecv, aIndex);																				break;
			case 0x50:		this->CGGuildRequestRecv((PMSG_GUILDJOINQ *)aRecv, aIndex);																						break;
			case 0x51:		this->CGGuildRequestResultRecv((PMSG_GUILDQRESULT *)aRecv, aIndex);																				break;
			case 0x52:		this->CGGuildListAll(aIndex);																													break;
			case 0x53:		this->CGGuildDelUser((PMSG_GUILDDELUSER *)aRecv, aIndex);																						break;
			case 0x54:		this->CGGuildMasterAnswerRecv((PMSG_GUILDMASTERANSWER *)aRecv, aIndex);																			break;
			case 0x55:		this->CGGuildMasterInfoSave(aIndex, (PMSG_GUILDINFOSAVE *)aRecv);																				break;
			case 0x57:		this->CGGuildMasterCreateCancel(aIndex);																										break;
			case 0x61:		this->GCGuildWarRequestSendRecv((PMSG_GUILDWARSEND_RESULT *)aRecv, aIndex);																		break;
			case 0x66:		this->GCGuildViewportInfo((PMSG_REQ_GUILDVIEWPORT *)aRecv, aIndex);																				break;
			case 0x6F: {
				PMSG_DEFAULT2 * lpDef = (PMSG_DEFAULT2 *)aRecv;
					
				switch (lpDef->subcode) {
					case 0x00:		g_CancelItemSale.CGReqSoldItemList(aIndex);									break;
					case 0x01:		g_CancelItemSale.CGReqEndCancelItemSale(aIndex);							break;
					case 0x02:		g_CancelItemSale.CGReqReBuyItem((PMSG_REQ_REBUY_ITEM *)aRecv, aIndex);		break;
				}
			}
			break;
			...
			case 0xB1: {
				...
				if (lpDef->subcode == 0x01) {
					if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->CGReqMapSvrAuth((PMSG_REQ_MAPSERVERAUTH *)aRecv, aIndex);
				}
			}
			break;
			...
			case 0xB2: {
				...
				switch (lpDef->subcode) {
					case 0x00:		this->CGReqCastleSiegeState((PMSG_REQ_CASTLESIEGESTATE *)aRecv, aIndex);		break;
					case 0x01:		this->CGReqRegCastleSiege((PMSG_REQ_REGCASTLESIEGE *)aRecv, aIndex);			break;
					case 0x02:		this->CGReqGiveUpCastleSiege((PMSG_REQ_GIVEUPCASTLESIEGE *)aRecv, aIndex);		break;
					case 0x03:		this->CGReqGuildRegInfo((PMSG_REQ_GUILDREGINFO *)aRecv, aIndex);				break;
					case 0x04:		this->CGReqRegGuildMark((PMSG_REQ_REGGUILDMARK *)aRecv, aIndex);				break;
					case 0x05:		this->CGReqNpcBuy((PMSG_REQ_NPCBUY *)aRecv, aIndex);							break;
					case 0x06:		this->CGReqNpcRepair((PMSG_REQ_NPCREPAIR *)aRecv, aIndex);						break;
					case 0x07:		this->CGReqNpcUpgrade((PMSG_REQ_NPCUPGRADE *)aRecv, aIndex);					break;
					case 0x08:		this->CGReqTaxMoneyInfo((PMSG_REQ_TAXMONEYINFO *)aRecv, aIndex);				break;
					case 0x09:		this->CGReqTaxRateChange((PMSG_REQ_TAXRATECHANGE *)aRecv, aIndex);				break;
					case 0x10:		this->CGReqMoneyDrawOut((PMSG_REQ_MONEYDRAWOUT *)aRecv, aIndex);				break;
					case 0x12:		this->CGReqCsGateOperate((PMSG_REQ_CSGATEOPERATE *)aRecv, aIndex);				break;
					case 0x1B:		this->CGReqCsMiniMapData((PMSG_REQ_MINIMAPDATA *)aRecv, aIndex);				break;
					case 0x1C:		this->CGReqStopCsMiniMapData((PMSG_REQ_STOPMINIMAPDATA *)aRecv, aIndex);		break;
					case 0x1D:		this->CGReqCsSendCommand((PMSG_REQ_CSCOMMAND *)aRecv, aIndex);					break;
					case 0x1F:		this->CGReqCsSetEnterHuntZone((PMSG_REQ_CSHUNTZONEENTER *)aRecv, aIndex);		break;
				}
			}
			break;

			case 0xB3:		this->PROTOCOL_GetCastleNpcData((PMSG_REQ_NPCDBLIST*)aRecv, aIndex);																						break;
			case 0xB4:		this->CGReqCsRegGuildList((PMSG_REQ_CSREGGUILDLIST *)aRecv, aIndex);																			break;
			case 0xB5:		this->CGReqCsAttkGuildList((PMSG_REQ_CSATTKGUILDLIST *)aRecv, aIndex);																			break;
			case 0xB7: {
				PMSG_DEFAULT2 * lpDef = (PMSG_DEFAULT2 *)aRecv;

				switch (lpDef->subcode) {
					case 0x01:		this->CGReqWeaponUse((PMSG_REQ_USEWEAPON *)aRecv, aIndex);							break;
					case 0x04:		this->CGReqWeaponDamageValue((PMSG_REQ_WEAPON_DAMAGE_VALUE *)aRecv, aIndex);		break;
				}
			}
			break;
			...
			case 0xB9: {
				...
				switch (lpDef->subcode) {
					case 0x02:		this->CGReqGuildMarkOfCastleOwner((PMSG_REQ_GUILDMARK_OF_CASTLEOWNER *)aRecv, aIndex);		break;
					case 0x05:		PROTOCOL_LandOfTrialsEntry((PMSG_REQ_MOVE_TO_CASTLE_HUNTZONE *)aRecv, aIndex);				break;
				}
			}
			break;
			...
			case 0xBC: {
				...
				switch (lpDef->subcode) {
					case 0x00:		this->PROTOCOL_CheckJewelPack((PMSG_REQ_JEWEL_MIX *)aRecv, aIndex);				break;
					case 0x01:		this->PROTOCOL_CheckJewelUnpack((PMSG_REQ_JEWEL_UNMIX *)aRecv, aIndex);			break;
				}
			}
			break;
			...
			case 0xBD: {
				...
				switch (lpDef->subcode) {
					case 0x00:		this->CGReqCrywolfInfo((PMSG_REQ_CRYWOLF_INFO *)aRecv, aIndex);													break;
					case 0x03:		this->CGReqAlatrContract((PMSG_REQ_CRYWOLF_ALTAR_CONTRACT *)aRecv, aIndex);										break;
					case 0x09:		this->PROTOCOL_CrywolfBenefitChaosSuccessRate((PMSG_REQ_CRYWOLF_BENEFIT_PLUS_CHAOSRATE *)aRecv, aIndex);		break;
				}
			}
			break;
			...
			case 0xBF: {
				...
				switch (lpDef->subcode) {
					case 0x02:		this->CGReqIllusionTempleUseSkill((PMSG_REQ_USEILLUSIONTEMPLESKILL*)aRecv, aIndex);					break;
					case 0x05:		this->GCIllusionTempleSendReward(aIndex);															break;
					case 0x0B:		this->CGReqLuckyCoinInfo(aIndex);																	break;
					case 0x0C:		this->CGReqLuckyCoinRegister(reinterpret_cast<PMSG_REQ_LUCKYCOIN_REGISTER *>(aRecv), aIndex);		break;
					case 0x0D:		this->CGReqLuckyCoinTrade(reinterpret_cast<PMSG_REQ_LUCKYCOIN_TRADE *>(aRecv), aIndex);				break;
					case 0x0E:		this->CGReqEnterDoppelGanger(reinterpret_cast<PMSG_REQ_ENTER_DOPPELGANGER *>(aRecv), aIndex);		break;
					case 0x17:		if (gObj[aIndex].MapNumber == MAP_INDEX_LORENMARKET) gObjMoveGate(aIndex, 17);
									else gObjMoveGate(aIndex, 333);																		break;
					case 0x20:		this->CGInventoryEquipment((_tagPMSG_REQ_INVENTORY_EQUIPMENT_ITEM *)aRecv, aIndex);					break;
					case 0x51:		this->CGReqMuBotUse(aIndex, reinterpret_cast<PMSG_MUBOT_SWITCH *>(aRecv));							break;
					case 0x6A:		this->CGReq_ITL_Relics((PMSG_REQ_ITL_RELATE_RELICS *)aRecv, aIndex);								break;
					case 0x70:		this->CG_Req_Enter_ITR((PMSG_REQ_ENTER_ITR *)aRecv, aIndex);										break;
					case 0x71:		this->CG_ReqAcceptEnterITR((PMSG_REQ_ACCEPTENTER_ITR *)aRecv, aIndex);								break;
				}
			}
			break;
			...
			case 0xCD: {
				...
				switch (lpDef->subcode) {
					case 0x01:		this->CGReqUBFMyCharacterInfo((PMSG_REQ_UBF_INFO *)aRecv, aIndex);									break;
					case 0x02:		this->CGReqUBFJoin((PMSG_REQ_UBF_JOIN *)aRecv, aIndex);												break;
					case 0x06:		this->CGReqUBFGetReward((PMSG_REQ_GET_REWARD *)aRecv, aIndex);										break;
					case 0x07:		this->CGReqUBFCancel((PMSG_REQ_UBF_CANCEL *)aRecv, aIndex);											break;
					case 0x08:		this->CGReqUBFGetRealName((PMSG_REQ_UBF_REAL_NAME *)aRecv, aIndex);									break;
				}
			}
			break;

			case 0xE1:		this->CGGuildAssignStatus((PMSG_GUILD_ASSIGN_STATUS_REQ *)aRecv, aIndex);																		break;
			case 0xE2:		this->CGGuildAssignType((PMSG_GUILD_ASSIGN_TYPE_REQ *)aRecv, aIndex);																			break;
			case 0xE5:		CGRelationShipReqJoinBreakOff((PMSG_RELATIONSHIP_JOIN_BREAKOFF_REQ *)aRecv, aIndex);															break;
			case 0xE6:		this->CGRelationShipAnsJoinBreakOff((PMSG_RELATIONSHIP_JOIN_BREAKOFF_ANS *)aRecv, aIndex);														break;
			case 0xE7: {
				PMSG_DEFAULT2 * lpDef = (PMSG_DEFAULT2 *)aRecv;

				switch (lpDef->subcode) {
					case 0x01:			this->CGReqSendMemberPosInfoStart(aIndex);									break;
					case 0x02:			this->CGReqSendMemberPosInfoStop(aIndex);									break;
					case 0x03:			this->GCReqSendNpcPosInfo((PMSG_REQ_NPC_POSITION *)aRecv, aIndex);			break;
				}
			}
			break;

			case 0xE9:		this->CGUnionList((PMSG_UNIONLIST_REQ *)aRecv, aIndex);																							break;
			case 0xEB: {
				PMSG_DEFAULT2 * lpDef = (PMSG_DEFAULT2 *)aRecv;

				if (lpDef->subcode == 0x01) this->CGRelationShipReqKickOutUnionMember((PMSG_KICKOUT_UNIONMEMBER_REQ *)aRecv, aIndex);
			}
			break;

			case 0x71:		this->GCPingSendRecv((PMSG_PING_RESULT *)aRecv, aIndex);																						break;
			case 0x72:		if (this->DataEncryptCheck(aIndex, protoNum, Encrypt) != FALSE) this->GCPacketCheckSumRecv((PMSG_PACKETCHECKSUM *)aRecv, aIndex);				break;
			case 0x81:		this->CGWarehouseMoneyInOut(aIndex, (PMSG_WAREHOUSEMONEYINOUT *)aRecv);																			break;
			case 0x82:		this->CGWarehouseUseEnd(aIndex);																												break;
			case 0x83:		this->PROTOCOL_WarehouseReceivePassword(aIndex, (PMSG_WAREHOUSEPASSSEND *)aRecv);																		break;
			case 0x86:		this->PROTOCOL_ChaosBoxItemMixButtonClick((PMSG_CHAOSMIX *)aRecv, aIndex);																				break;
			case 0x87:		this->PROTOCOL_ChaosBoxUseEnd(aIndex);																													break;
			case 0x88:		g_MixSystem.CheckEmptySpace_MultiMix((PMSG_REQ_CHAOS_MULTIMIX_CHECK *)aRecv, aIndex);															break;
			case 0x90:		this->GCReqmoveDevilSquare((PMSG_REQ_MOVEDEVILSQUARE *)aRecv, aIndex);																			break;
			case 0x91:		this->GCReqDevilSquareRemainTime((PMSG_REQ_DEVILSQUARE_REMAINTIME *)aRecv, aIndex);																break;
			case 0x95:		this->GCRegEventChipRecv((PMSG_REGEVENTCHIP *)aRecv, aIndex);																					break;
			case 0x96:		this->GCGetMutoNumRecv((PMSG_GETMUTONUMBER *)aRecv, aIndex);																					break;
			case 0x97:		this->GCUseEndEventChipRescv(aIndex);																											break;
			case 0x98:		this->GCUseRenaChangeZenRecv((PMSG_EXCHANGE_EVENTCHIP *)aRecv, aIndex);																			break;
			case 0x99:		this->CGReqMoveOtherServer((PMSG_REQ_MOVE_OTHERSERVER *)aRecv, aIndex);																			break;
			case 0xA0:		this->CGRequestQuestInfo(aIndex);																												break;
			case 0xA2:		this->CGSetQuestState((PMSG_SETQUEST *)aRecv, aIndex);																							break;
			case 0xA7:		this->CGRequestPetItemCommand((PMSG_REQUEST_PET_ITEM_COMMAND *)aRecv, aIndex);																	break;
			case 0xA9:		this->CGRequestPetItemInfo((PMSG_REQUEST_PET_ITEMINFO *)aRecv, aIndex);																			break;
			case 0xAA: {
				PMSG_DEFAULT2 * lpDef = (PMSG_DEFAULT2 *)aRecv;
			...
			case 0x9A:		this->CGRequestEnterBloodCastle((PMSG_REQ_MOVEBLOODCASTLE*)aRecv, aIndex);																		break;
			case 0x9F:		this->CGRequestEventEnterCount((PMSG_REQ_CL_ENTERCOUNT *)aRecv, aIndex);																		break;
			case 0x9D:		this->CGRequestLottoRegister((PMSG_REQ_2ANV_LOTTO_EVENT *)aRecv, aIndex);																		break;
			case 0xAE:		this->CGReqMuBotSaveData(aIndex, reinterpret_cast<PMSG_MUBOT_DATASAVE *>(aRecv));																break;
			case 0xAF: {
				PMSG_DEFAULT2 * lpDef = (PMSG_DEFAULT2 *)aRecv;

				switch (lpDef->subcode) {
					case 0x01:			this->PROTOCOL_ChaosCastleEntry((PMSG_REQ_MOVECHAOSCASTLE *)aRecv, aIndex);						break;
					case 0x02:			this->CGRequestRepositionUserInChaosCastle((PMSG_REQ_REPOSUSER_IN_CC *)aRecv, aIndex);			break;
					case 3:				CGReqCCF_DayTime(aIndex);																		break;
					case 5:				CGReqCCF_EnterCheck(aIndex);																	break;
					case 6:				CGRequestRepositionUserInCCF((PMSG_REQ_REPOSUSER_IN_CCF *)aRecv, aIndex);						break;
					case 7:				CGReq_CCF_Ranking((PMSG_REQ_CCF_RANKING *)aRecv, aIndex);										break;
					case 8:				CG_CCF_UI_OnOff((PMSG_CCF_UI_ONOFF *)aRecv, aIndex);											break;
				}
			}
			break;

			case 0xC0:		FriendListRequest(aIndex);																														break;
			case 0xC1:		FriendAddRequest((PMSG_FRIEND_ADD_REQ *)aRecv, aIndex);																							break;
			case 0xC2:		WaitFriendAddRequest((PMSG_FRIEND_ADD_SIN_RESULT *)aRecv, aIndex);																				break;
			case 0xC3:		FriendDelRequest((PMSG_FRIEND_DEL_REQ *)aRecv, aIndex);																							break;
			case 0xC4:		FriendStateClientRecv((PMSG_FRIEND_STATE_C *)aRecv, aIndex);																					break;
			case 0xC5:		FriendMemoSend((PMSG_FRIEND_MEMO *)aRecv, aIndex);																								break;
			case 0xC7:		FriendMemoReadReq((PMSG_FRIEND_READ_MEMO_REQ *)aRecv, aIndex);																					break;
			case 0xC8:		FriendMemoDelReq((PMSG_FRIEND_MEMO_DEL_REQ *)aRecv, aIndex);																					break;
			case 0xC9:		FriendMemoListReq(aIndex);																														break;
			case 0xCA:		FriendChatRoomCreateReq((PMSG_FRIEND_ROOMCREATE_REQ *)aRecv, aIndex);																			break;
			case 0xCB:		FriendRoomInvitationReq((PMSG_ROOM_INVITATION *)aRecv, aIndex);																					break;
			case 0xD0: {			
				PMSG_DEFAULT2 * lpDef = (PMSG_DEFAULT2 *)aRecv;

				switch (lpDef->subcode) {
					case 0x07:				this->WereWolfQuarrelCheck(aIndex);						break;
					case 0x08:				this->GateKeeperCheck(aIndex);							break;
					case 0x0A:				
						if (gGateC.CheckGateLevel(aIndex, 22) == true) gObjMoveGate(aIndex, 22);
						else {
							char szTemp[256];
					...
					break;
					case 0x10:				EGReqSantaGift(aIndex);									break;
				}
			}
			break;
			...
			case 0xD1: {
				...
				switch (lpDef->subcode) {
					case 0x00:			this->CGReqKanturuStateInfo((PMSG_REQ_KANTURU_STATE_INFO *)aRecv, aIndex);					break;
					case 0x01:			this->GCReqEnterKanturuBossMap((PMSG_REQ_ENTER_KANTURU_BOSS_MAP *)aRecv, aIndex);			break;
				}
			}
			break;
			...
			case 0xD2: {					
				...
				switch (lpDef->subcode) {
					case 0x01:			g_CashShop.CGCashPoint(lpObj);																break;
					case 0x02:			g_CashShop.CGCashShopOpen(lpObj, (PMSG_REQ_INGAMESHOPOPEN *)aRecv);							break;
					case 0x03:			g_CashShop.CGCashItemBuy(lpObj, (PMSG_REQ_INGAMESHOP_ITEMBUY *)aRecv);						break;
					case 0x04:			g_CashShop.CGCashItemGift(lpObj, (PMSG_REQ_CASHITEM_GIFT *)aRecv);							break;
					case 0x05:			g_CashShop.CGCashInventoryItemCount(lpObj, (PMSG_REQ_INGAMESHOP_INVENTORY *)aRecv);			break;
					case 0x0B:			g_CashShop.CGCashInventoryItemUse(lpObj, (PMSG_REQ_INGAMESHOP_ITEMUSE *)aRecv);				break;
					default:			g_Log.AddC(TColor::Red,  "InGameShop Unknown Packet: %X %X", lpDef->h.headcode, lpDef->subcode);
				}
			}
			break;
			...
			case 0xEC: {
				...
				switch (lpDef->subcode) {
					case 0:			this->CGReqInJewelPentagramItem((PMSG_REQ_IN_PENTAGRAM_JEWEL *)aRecv, aIndex);																														break;
					case 1:			this->CGReqOutJewelPentagramItem((PMSG_REQ_OUT_PENTAGRAM_JEWEL *)aRecv, aIndex);																													break;
					case 2:			this->CGReqRefinePentagramJewel((PMSG_REQ_REFINE_PENTAGRAM_JEWEL *)aRecv, aIndex);																													break;
					case 3:			this->CGReqUpgradePentagramJewel((PMSG_REQ_UPGRADE_PENTAGRAM_JEWEL *)aRecv, aIndex);																												break;
					case 0x31:		g_PersonalStore.CGReqSearchItemInPShop((PMSG_REQ_SEARCH_ITEM_PSHOP *)aRecv, aIndex);																												break;
					case 0x33:		g_PersonalStore.CGReqPShopLog((PMSG_REQ_PSHOP_LOG *)aRecv, aIndex);																																	break;
					default:		g_Log.AddC(TColor::Red,  "%X %X %X %X %X %X %X %X %X %X %X %X", aRecv[0], aRecv[1], aRecv[2], aRecv[3], aRecv[4], aRecv[5], aRecv[6], aRecv[7], aRecv[8], aRecv[9], aRecv[10], aRecv[11]);			break;
				}
			}
			break;
			...
			case 0xDB: {
				...
				switch (lpDef->subcode) {
					case 0x00:		this->CGReqDSFSchedule(aIndex);														break;
					case 0x01:		GDReqDSFCanPartyEnter(aIndex);														break;
					case 0x02:		this->CGReqAcceptEnterDSF((PMSG_REQ_DSF_ACCEPTENTER *)aRecv, aIndex);				break;
					case 0x03:		this->CGReqDSFGoFinalParty((PMSG_REQ_DSF_GO_FINAL_PARTY_INFO *)aRecv, aIndex);		break;
					case 0x09:		this->CGReqDSFGetReward((PMSG_REQ_DSF_GET_REWARD *)aRecv, aIndex);					break;
				}
			}
			break;
			...
			case 0xED: {	// Guild Matching
				...
				switch (lpDef->subcode) {
					case 0:			this->CGReqGuildMatchingList((PMSG_REQ_GUILDMATCHINGLIST *)aRecv, aIndex);								break;
					case 1:			this->CGReqGuildMatchingListSearchWord((PMSG_REQ_GUILDMATCHINGLISTSEARCHWORD *)aRecv, aIndex);			break;
					case 2:			this->CGReqRegGuildMatchingList((PMSG_REQ_REGGUILDMATCHINGDATA *)aRecv, aIndex);						break;
					case 3:			this->CGReqCancelGuildMatchingList((PMSG_REQ_CANCEL_GUILDMATCHINGLIST *)aRecv, aIndex);					break;
					case 4:			this->CGReqJoinGuildMatching((PMSG_REQ_JOIN_GUILDMATCHING *)aRecv, aIndex);								break;
					case 5:			this->CGReqCancelJoinGuildMatching(aIndex);																break;
					case 6:			this->CGReqAllowJoinGuildMatching((PMSG_REQ_ALLOW_JOIN_GUILDMATCHING *)aRecv, aIndex);					break;
					case 7:			this->CGReqGetAllowListJoinGuildMatching((PMSG_REQ_ALLOWLIST_GUILDMATCHING *)aRecv, aIndex);			break;
					case 8:			this->CGReqGetWaitStateListGuildMatching(aIndex);														break;
					default:		return;
				}
			}
			break;
			...
			case 0xEF: {	// Party Matching
				...
				switch (lpDef->subcode) {
					case 0:			this->CGReqRegWantedPartyMember((PMSG_REQ_REG_WANTED_PARTYMEMBER *)aRecv, aIndex);						break;
					case 1:			this->CGReqGetPartyMatchingList((PMSG_REQ_GET_PARTYMATCHINGLIST *)aRecv, aIndex);						break;
					case 2:			this->CGReqJoinMemberPartyMatching((PMSG_REQ_MEMBERJOIN_PARTYMATCHINGLIST *)aRecv, aIndex);				break;
					case 3:			this->CGReqMemberJoinStateList((PMSG_REQ_MEMBERJOIN_STATELIST_PARTYMATCHING *)aRecv, aIndex);			break;
					case 4:			this->CGReqMemberJoinStateListLeader((PMSG_REQ_WAITLIST_PARTYMATCHING *)aRecv, aIndex);					break;
					case 5:			this->CGReqAcceptJoinMemberPartyMatching((PMSG_REQ_ACCEPTMEMBER_PARTYMATCHING *)aRecv, aIndex);			break;
					case 6:			this->CGReqCancelPartyMatching((PMSG_REQ_CANCEL_JOIN_PARTYMATCHING *)aRecv, aIndex);					break;
					default:		return;
				}
			}
			break;
			...
			case 0xF6: {
				switch (aRecv[3]) {
					case 0x30:		CGReqQuestExp((PMSG_REQ_NPC_QUESTEXP *)aRecv, aIndex);												break;
					case 0x31:		CGReqAttDefPowerInc((PMSG_REQ_ATTDEF_POWER_INC *)aRecv, aIndex);									break;
					case 0x21:		CGReqEventItemQuestList((PMSG_REQ_EVENT_ITEM_EP_LIST *)aRecv, aIndex);								break;
					case 0x0A:		CGReqQuestSwitch((PMSG_REQ_QUESTEXP *)aRecv, aIndex);												break;
					case 0x0B:		CGReqQuestProgress((PMSG_REQ_QUESTEXP *)aRecv, aIndex);												break;
					case 0x0D:		CGReqQuestComplete((PMSG_REQ_QUESTEXP_COMPLETE *)aRecv, aIndex);									break;
					case 0x0F:		CGReqQuestGiveUp((PMSG_REQ_QUESTEXP_GIVEUP *)aRecv, aIndex);										break;
					case 0x1A:		CGReqProgressQuestList((PMSG_REQ_QUESTEXP_PROGRESS_LIST *)aRecv, aIndex);							break;
					case 0x1B:		CGReqProgressQuestInfo((PMSG_REQ_QUESTEXP_PROGRESS_INFO *)aRecv, aIndex);							break;
					case 0x10:		CGReqTutorialKeyComplete((PMSG_REQ_QUESTEXP_ASK_COMPLETE *)aRecv, aIndex);							break;
					default:		g_Log.AddC(TColor::Red, "UNKNOWN QUEST PROTOCOL (%x/%x/%x)", aRecv[2], aRecv[3], aRecv[4]);			break;
				}
			}
			break;
			...
			case 0xF7: {
				...
				if (lpDef->subcode == 0x01) this->CGReqEnterZone((PMSG_REQ_ENTER_ZONE *)aRecv, aIndex);
			}
			break;
			...
			case 0xF8: {
				...
				switch (lpDef->subcode) {
					case 0x01:		this->CGReqRegGensMember((_tagPMSG_REQ_REG_GENS_MEMBER *)aRecv, aIndex);																												break;
					case 0x03:		this->CGReqSecedeGensMember((_tagPMSG_REQ_SEGEDE_GENS_MEMBER *)aRecv, aIndex);																											break;
					case 0x09:		this->CGReqGensReward((_tagPMSG_GENS_REWARD_CODE *)aRecv, aIndex);																														break;
					case 0x0B:		this->CGReqGensMemberInfo((_tagPMSG_REQ_GENS_INFO *)aRecv, aIndex);																														break;
					case 0x20:		this->CGReqAcheronEnter((_tagPMSG_REQ_ACHERON_ENTER *)aRecv, aIndex);																													break;
					case 0x30:		this->CGReqArcaBattleGuildMasterJoin((_tagPMSG_REQ_ARCA_BATTLE_JOIN *)aRecv, aIndex);																									break;
					case 0x32:		this->CGReqArcaBattleGuildMemberJoin((_tagPMSG_REQ_ARCA_BATTLE_JOIN *)aRecv, aIndex);																									break;
					case 0x34:		this->CGReqArcaBattleEnter((_tagPMSG_REQ_ARCA_BATTLE_ENTER *)aRecv, aIndex);																											break;
					case 0x36:		this->CGReqArcaBattleBootyExchange(aIndex);																																				break;
					case 0x3C:		this->CGReqSpritemapExchange(aIndex);																																					break;
					case 0x41:		this->CGReqRegisteredMemberCnt(aIndex);																																					break;
					case 0x43:		g_ArcaBattle.CGReqMarkReg(aIndex);																																						break;
					case 0x45:		g_ArcaBattle.CGReqMarkRank(aIndex);																																						break;
					case 0x4B:		g_AcheronGuardianEvent.CGReqAcheronEventEnter((_tagPMSG_REQ_ACHERON_EVENT_ENTER *)aRecv, aIndex);																						break;
					default:		g_Log.AddC(TColor::Blue, "UNKNOWN F8 PACKET: %x %x %x %x %x %x %x %x %x %x", aRecv[0], aRecv[1], aRecv[2], aRecv[3], aRecv[4], aRecv[5], aRecv[6], aRecv[7], aRecv[8], aRecv[9]);		break;
				}
			}
			break;
			...
			case 0xFA: {
				...
				switch (lpDef->subcode) {
					case 0x08:		this->PROTOCOL_CheckSpeedHack(aIndex, (PMSG_SEND_AH_INFO *)aRecv);			break;
					case 0x09:		gObjUseSkill.SkillChangeUse(lpObj->m_Index);
									DGGuildMemberInfoRequest(aIndex);										break;
					case 0x0A:		this->PROTOCOL_CheckHackBreach(aIndex, (PMSG_ANTIHACK_BREACH *)aRecv);	break;
					case 0x0D:		this->PROTOCOL_CheckCRC(aIndex, (PMSG_REQ_CRCDATA *)aRecv);				break;
					case 0x11:		this->PROTOCOL_HookAntiHack(aIndex, (PMSG_ANTIHACK_CHECK *)aRecv);		break;
					case 0x15:		this->PROTOCOL_CheckHitHack(aIndex,(PMSG_SEND_HITHACK_INFO*)aRecv);		break;
				}
			}
			break;
			...
			case 0x4C: {
				...
				switch (lpDef->subcode) {
					case 0x00:		g_MineSystem.MineTwinkle((PMSG_REQ_MINETWINKLE *)aRecv, aIndex);								break;
					case 0x01:		g_MineSystem.RewardMineTwinkle((PMSG_REQ_MINETWINKLE_REWARD *)aRecv, aIndex);					break;
					case 0x03:		g_MineSystem.FailMineTwinkle((PMSG_ANS_MINETWINKLE_END_ANIMATION *)aRecv, aIndex, false);		break;
				}
			}
			break;
			...
			case 0x4D: {
				...
				switch (lpDef->subcode) {
					case 0x00:		if (DataEncryptCheck(aIndex, protoNum, Encrypt)) this->CGEventItemGetRequest((PMSG_EVENTITEM_GETREQUEST *)aRecv, aIndex);		break;
					case 0x01: 		this->CGEventItemDropRequest((PMSG_EVENTITEM_THROW *)aRecv, aIndex);															break;
					case 0x0F:		this->CGReqEventInvenOpen(aRecv, aIndex);																						break;
					case 0x10:		g_CMuRummyMng.CGReqMuRummyStart((_tagPMSG_REQ_MURUMMY_INFO *)aRecv, aIndex);													break;
					case 0x11:		g_CMuRummyMng.CGReqCardReveal((_tagPMSG_REQ_REVEAL_CARD *)aRecv, aIndex);														break;
					case 0x12:		g_CMuRummyMng.CGReqCardMove((_tagPMSG_REQ_CARD_MOVE *)aRecv, aIndex);															break;
					case 0x13:		g_CMuRummyMng.CGReqCardReMove((_tagPMSG_REQ_CARD_REMOVE *)aRecv, aIndex);														break;
					case 0x14:		g_CMuRummyMng.CGReqCardMatch((_tagPMSG_REQ_CARD_MATCH *)aRecv, aIndex);															break;
					case 0x15:		g_CMuRummyMng.CGReqMuRummyEnd((_tagPMSG_REQ_MURUMMY_END *)aRecv, aIndex);														break;
				}
			}
			break;
			...
			case 0x4E: {
				...
				switch (lpDef->subcode) {
					case 0x00:		if (DataEncryptCheck(aIndex, protoNum, Encrypt)) this->CGMuunItemGetRequest((PMSG_MUUNITEM_GETREQUEST *)aRecv, aIndex);			break;
					case 0x08:		g_CMuunSystem.CGMuunInventoryUseItemRecv((PMSG_USEITEM_MUUN_INVEN *)aRecv, aIndex);												break;
					case 0x09:		if (DataEncryptCheck(aIndex, protoNum, Encrypt)) CGMuunItemSellRequestRecv((PMSG_MUUN_ITEM_SELLREQUEST *)aRecv, aIndex);		break;	
					case 0x11:		g_CMuunSystem.CGReqRideSelect((PMSG_MUUN_RIDE_SELECT*)aRecv,aIndex);															break;
					case 0x13:		g_CMuunSystem.CGMuunExchangeItem((PMSG_REQ_MUUN_EXCHANGE *)aRecv, aIndex);														break;
				}
			}
			break;
			...
			case 0x4F: {
				...
				switch (lpDef->subcode) {
					case 0x02:		g_GremoryCase.CGReqGetItemFromGremoryCase((PMSG_ADD_GREMORYCASE_ITEM_TO_INVENTORY_REQ *)aRecv, aIndex);			break;
					case 0x05:		g_GremoryCase.CGReqOpenGremoryCase(aIndex);																		break;
				}
			}
			break;
			...
			case 0xFB:																																						break;
			case 0xFC:																																						break;
			default:	g_Log.AddC(TColor::Red,  "error-L2 (ProtocolCore) : Account: %s Name: %s : Invalid packet received OP: %X (%s,%d) Connection State: %d", gObj[aIndex].AccountID, gObj[aIndex].Name, protoNum, __FILE__, __LINE__, gObj[aIndex].Connected);
						this->GCSendDisableReconnect(aIndex);																												break;
		}	
	}
}
...
void GameProtocol::MsgSendV2(LPOBJ lpObj, unsigned char* Msg, int size) {
	for (int n = 0; n < MAX_VIEWPORT; n++) {
		if (lpObj->VpPlayer2[n].type == OBJ_USER) {
			if (lpObj->VpPlayer2[n].state != 0) IOCP.DataSend(lpObj->VpPlayer2[n].number, Msg, size);
		}
	}
}

void GameProtocol::CGLiveClient(PMSG_CLIENTTIME * lpClientTime, short aIndex) {
	if (gObj[aIndex].Connected > PLAYER_CONNECTED) gObj[aIndex].ConnectCheckTime = GetTickCount();		
	if (strcmpi(lpClientTime->Version, DLL_VERSION) != 0) {
		g_Log.AddC(TColor::Red, "[IP: %s][AccountID: %s] using invalid version of DLL, review and correct Server/Client configuration. Required version of DLL for actual Game Server is %s", gObj[aIndex].CharacterData->Ip_addr, gObj[aIndex].AccountID, DLL_VERSION);
	...
	if (gObj[aIndex].Connected == PLAYER_PLAYING) {
		if (gObj[aIndex].AttackSpeed < lpClientTime->AttackSpeed || gObj[aIndex].MagicSpeed < lpClientTime->MagicSpeed) {
			g_Log.AddC(TColor::Red, "[%s][%s][%s] ClientHack Detected : Editing AttackSpeed [%d][%d] [%d][%d]", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr, gObj[aIndex].AttackSpeed, lpClientTime->AttackSpeed, gObj[aIndex].MagicSpeed, lpClientTime->MagicSpeed);	
			AntiHackLog->Output("[%s][%s][%s] ClientHack Detected : Editing AttackSpeed [%d][%d] [%d][%d]", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr, gObj[aIndex].AttackSpeed, lpClientTime->AttackSpeed, gObj[aIndex].MagicSpeed, lpClientTime->MagicSpeed);	
		...
		} else gObj[aIndex].m_AttackSpeedHackDetectedCount = 0;
	}

	if (g_ConfigRead.antihack.EnabledAgiCheck == false) return;

	EnterCriticalSection(&gObj[aIndex].CharacterData->AgiCheckCriti);

	if (GetTickCount() - gObj[aIndex].CharacterData->AgilityCheckDelay < g_ConfigRead.antihack.AgilityDelayCheckTime) {
		LeaveCriticalSection(&gObj[aIndex].CharacterData->AgiCheckCriti);
		return;
	}

	if (gObj[aIndex].Connected == PLAYER_PLAYING) {
		if (lpClientTime->Agility > (gObj[aIndex].CharacterData->Dexterity + gObj[aIndex].AddDexterity)) {
			gObj[aIndex].CharacterData->AgilityCheckCount++;
			g_Log.AddC(TColor::Red, "[ANTI-HACK] [%s][%s][%s] Agility check FAILED - Server:%d Client:%d (Count:%d/3)", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr, gObj[aIndex].CharacterData->Dexterity + gObj[aIndex].AddDexterity, lpClientTime->Agility, gObj[aIndex].CharacterData->AgilityCheckCount);
			AntiHackLog->Output("[ANTI-HACK] [%s][%s][%s] Agility check FAILED - Server:%d Client:%d (Count:%d/3)", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr, gObj[aIndex].CharacterData->Dexterity + gObj[aIndex].AddDexterity, lpClientTime->Agility, gObj[aIndex].CharacterData->AgilityCheckCount);
		
			if (gObj[aIndex].CharacterData->AgilityCheckCount >= 3) this->GCSendDisableReconnect(aIndex);
		} else gObj[aIndex].CharacterData->AgilityCheckCount = 0;
	} else gObj[aIndex].CharacterData->AgilityCheckCount = 0;
...
void GameProtocol::PROTOCOL_CheckMainExeKeySend(int aIndex) {
...
void GameProtocol::PROTOCOL_CheckMainChecksum(PMSG_CHECK_MAINEXE_RESULT * lpMsg, int aIndex) {
	if (gObj[aIndex].Type != OBJ_USER) return;
	if (!gCheckSumSwitch) {
	...
	if (dwgCheckSum[gObj[aIndex].CheckSumTableNum] != lpMsg->m_dwKey) {
		g_Log.Add("error-L1 : CheckSum-Exe error %d %d %d [%s]", dwgCheckSum[gObj[aIndex].CheckSumTableNum], lpMsg->m_dwKey, gObj[aIndex].CheckSumTableNum, gObj[aIndex].AccountID);
		this->GCSendDisableReconnect(aIndex);
		return;
	}
...
void GameProtocol::PEchoProc(unsigned char * aMsg, int aLen, short aIndex) {
	for (int n = 0; n < g_ConfigRead.server.GetObjectMax(); n++) {
		if (gObj[n].Connected >= PLAYER_CONNECTED) IOCP.DataSend(n, aMsg, aLen);
	}
}
...
void GameProtocol::PROTOCOL_ChatSend(LPOBJ lpObj, char *szChat) {
	int len = strlen(szChat);

	if (len < 1) return;
	if (len > MAX_CHAT_LEN - 1) return;
...
void GameProtocol::PROTOCOL_vChatSend(LPOBJ lpObj, char* szChat, ...) {
	char szBuffer[256] = "";
	va_list pArguments;
	...
	int len = strnlen_s(szBuffer, sizeof(szBuffer));
...
void GameProtocol::PROTOCOL_SendServerAnnounce(char* chatmsg) {
	PMSG_NOTICE pNotice;
	...
	for (int n = g_ConfigRead.server.GetObjectStartUserIndex(); n < g_ConfigRead.server.GetObjectMax(); n++) {
		if (gObj[n].Connected == PLAYER_PLAYING) {
			if (gObj[n].Type == OBJ_USER) IOCP.DataSend(n, (unsigned char*)&pNotice , pNotice.h.size);
		}
	}
}

void GameProtocol::PROTOCOL_DataSendAll(unsigned char* lpMsg, int iMsgSize) {			
	for (int n = g_ConfigRead.server.GetObjectStartUserIndex(); n < g_ConfigRead.server.GetObjectMax(); n++) {
		if (gObj[n].Connected == PLAYER_PLAYING) {
			if (gObj[n].Type == OBJ_USER) IOCP.DataSend(n, (unsigned char*)lpMsg , iMsgSize);
		}
	}
}

void GameProtocol::PROTOCOL_NPCChatSend(LPOBJ lpObj, char *szChat, int senduser) {
	int len = strnlen_s(szChat, sizeof(szChat));

	if (len < 1 || len > MAX_CHAT_LEN - 1) return;
...
void GameProtocol::PROTOCOL_ChatSpecial(PMSG_CHATDATA * lpChat, short aIndex) {
	...
	if (slen > MAX_CHAT_LEN - 1) {
		g_Log.Add("[Anti-HACK][PROTOCOL_ChatSpecial][%s][%s] Chat Message Len : %d", lpObj->AccountID, lpObj->Name, slen);
		return;
	}
	...
	if (g_ConfigRead.server.GetServerType() != SERVER_BATTLECORE) memcpy(szId, gObj[aIndex].Name, MAX_ACCOUNT_LEN);
	else memcpy(szId, gObj[aIndex].CharacterData->m_RealNameOfUBF, MAX_ACCOUNT_LEN);
	if (g_ConfigRead.server.GetServerType() == SERVER_BATTLECORE) {
		char szBuff[100];

		memset(szBuff, 0x00, sizeof(szBuff));

		if (lpChat->chatmsg[0] != '!' && lpChat->chatmsg[0] != '`' && lpChat->chatmsg[0] != '@' && lpChat->chatmsg[0] != '$' && lpChat->chatmsg[0] != '~') {
			if (lpChat->chatmsg[0] == '/') sprintf(szBuff, "%s", lpChat->chatmsg);
			else sprintf(szBuff, "[#%d]%s", gObj[aIndex].CharacterData->m_nServerCodeOfHomeWorld, lpChat->chatmsg);
		} else sprintf(szBuff, "%c[#%d]%s", lpChat->chatmsg[0], gObj[aIndex].CharacterData->m_nServerCodeOfHomeWorld, lpChat->chatmsg);
	...
	if (lpObj->CharacterData->m_bSecurityCheck == false) {
		char seps[2] = " ";
		char string[256];
		char *szCmdToken;

		strcpy_s(string, sizeof(string),  lpChat->chatmsg);
	...
	switch (lpChat->chatmsg[0]) {
		case '~':
		case ']':	// Party Chat
			if (lpObj->CharacterData->m_bUsePartyMatching == false || lpObj->CharacterData->m_nPartyMatchingIndex < 0) {
					...
					if (partycount >= 0) {
						...
						for (n = 0; n < MAX_USER_IN_PARTY; n++) {
							...
							if (number >= 0) {
								...
								if (gWriteChatLog) {
									strcpy_s(pChatMsg.szTargetName[szTargetNameCount], sizeof(pChatMsg.szTargetName[szTargetNameCount]), gObj[number].Name);
									szTargetNameCount++;
								}
							}
						}
				...
				GDSendChatMsgPartyMatching(lpChat->chatmsg, lpObj->Name, lpObj->CharacterData->m_nPartyMatchingIndex);
			}
		break;

		case '$':	// Clan Chat
			if (lpObj->CharacterData->m_GensInfluence == DUPRIAN_INFLUENCE || lpObj->CharacterData->m_GensInfluence == VANERT_INFLUENCE) {
				for (n = g_ConfigRead.server.GetObjectStartUserIndex(); n < g_ConfigRead.server.GetObjectMax(); n++) {
					if (gObjIsConnected(n) && gObj[n].CharacterData->m_GensInfluence == lpObj->CharacterData->m_GensInfluence) IOCP.DataSend(n, (LPBYTE)lpChat, lpChat->h.size);
				}

				GDGensServerGroupChattingSend(lpObj->CharacterData->m_GensInfluence, lpChat);
			}
		break;

		case '@':	// Guild Chat
			if (lpObj->CharacterData->GuildNumber > 0) {
				if (lpChat->chatmsg[1] == '>') {	// Guild Announcement
					if (lpObj->Name[0] == lpObj->CharacterData->lpGuild->Names[0][0]) {
						if (!strcmp(lpObj->Name, lpObj->CharacterData->lpGuild->Names[0])) {
							...
							GDGuildNoticeSave(lpObj->CharacterData->lpGuild->Name, &lpChat->chatmsg[2]);
							g_Log.Add("Guild announcement %s %s", lpObj->CharacterData->lpGuild->Name, lpChat->chatmsg);
				...
				} else if (lpChat->chatmsg[1] == '@' && lpObj->CharacterData->lpGuild->iGuildUnion) {	// Alliance Chat
					int iGuildCount = 0;
					int iGuildList[MAX_UNION_GUILD] = { 0 };

					if (UnionManager.GetGuildUnionMemberList(lpObj->CharacterData->lpGuild->iGuildUnion, iGuildCount, iGuildList) == TRUE) {
						for (int i = 0; i < iGuildCount; i++) {
							_GUILD_INFO_STRUCT* lpGuildInfo = Guild.SearchGuild_Number(iGuildList[i]);

							if (!lpGuildInfo) continue;
								...
								if (lpGuildInfo->Use[n]) {
									...
									if (number >= 0) {
										if (lpGuildInfo->Names[n][0] == gObj[number].Name[0]) {
											if (!strcmp(lpGuildInfo->Names[n], gObj[number].Name)) IOCP.DataSend(number, (LPBYTE)lpChat, lpChat->h.size);
										}
									}
								}
							}
					...
					if (g_iServerGroupUnionChatting == TRUE) GDUnionServerGroupChattingSend(lpObj->CharacterData->lpGuild->iGuildUnion, lpChat);
				} else {
					int count = lpObj->CharacterData->lpGuild->Count;

					if (count >= 0) {
						for (n = 0; n < MAX_USER_GUILD; n++) {
							if (lpObj->CharacterData->lpGuild->Use[n]) {
								number = lpObj->CharacterData->lpGuild->Index[n];

								if (number >= 0) {
									if (lpObj->CharacterData->lpGuild->Names[n][0] == gObj[number].Name[0]) {
										if (!strcmp(lpObj->CharacterData->lpGuild->Names[n], gObj[number].Name)) IOCP.DataSend(number, (LPBYTE)lpChat, lpChat->h.size);
									}
								}
							}
						}
					...
					if (g_iServerGroupGuildChatting == TRUE) {
						if (lpObj->CharacterData->lpGuild->Count > 1) GDGuildServerGroupChattingSend(lpObj->CharacterData->lpGuild->Number, lpChat);
					}
				...
				if (gWriteChatLog) {
					strcpy_s(pChatMsg.szTargetName[szTargetNameCount], sizeof(pChatMsg.szTargetName[szTargetNameCount]), lpObj->CharacterData->GuildName);
					szTargetNameCount++;
				}
			}
		break;
		...
		default:
			if ((gObj[aIndex].Authority & 0x20) == 0x20 && BUFF_TargetHasBuff(&gObj[aIndex], BUFFTYPE_INVISABLE) == TRUE) return;
			if (!g_prohibitedSymbols.Validate(lpChat->chatmsg, strnlen_s(lpChat->chatmsg, sizeof(lpChat->chatmsg)), TYPE_CHAT)) {
				MsgOutput(aIndex, Lang.GetText(0, 545));
				return;
			}

			if (SwearFilter.CompareText(lpChat->chatmsg) == true && lpChat->chatmsg[0] != '@' && lpChat->chatmsg[0] != '~') {
				++lpObj->CharacterData->SwearWarning;

				if (lpObj->CharacterData->SwearWarning >= 3) {
					MsgOutput(aIndex, Lang.GetText(0, 515));
					this->GCSendDisableReconnect(aIndex);
				} else MsgOutput(aIndex, Lang.GetText(0, 516), lpObj->CharacterData->SwearWarning);

				return;
			}

			if (g_NewPVP.IsDuel(*lpObj) || g_NewPVP.IsObserver(*lpObj)) g_NewPVP.ChatMsgSend(*lpObj, (LPBYTE)lpChat, lpChat->h.size);
			else {
				IOCP.DataSend(aIndex, (LPBYTE)lpChat, lpChat->h.size);

				if (g_GensSystem.IsMapBattleZone(lpObj->MapNumber)) g_GensSystem.BattleZoneChatMsgSend(lpObj, (LPBYTE)lpChat, lpChat->h.size);
				else this->MsgSendV2(lpObj, (LPBYTE)lpChat, lpChat->h.size);
			}
...
void GameProtocol::CGChatRecv(PMSG_CHATDATA_NUMBER * lpMsg, int aIndex) {
	...
	if (PacketCheckTime(aIndex) == FALSE) return;
...
void GameProtocol::GCServerMsgStringSendAll(LPSTR  szMsg, BYTE type) {
	...
	TNotice::MakeNoticeMsg((TNotice*)&pNotice, type, szMsg);
	this->PROTOCOL_DataSendAll((UCHAR*)&pNotice, pNotice.h.size);
}
...
void GameProtocol::GCServerMsgStringSendGuild(_GUILD_INFO_STRUCT* lpNode, LPSTR szMsg, BYTE type) {
	...
	for (int n = 0; n < MAX_USER_GUILD; n++) {
		if (lpNode->Use[n] > 0 && lpNode->Index[n] >= 0) GCServerMsgStringSend((char*)szMsg, lpNode->Index[n], type);
	}
}
...
void GameProtocol::GCMapEventStateSend(int map, BYTE state, BYTE event) {
	...
	for (int n = 0; n < g_ConfigRead.server.GetObjectMax(); n++) {
		if (gObj[n].Connected == PLAYER_PLAYING && gObj[n].Type == OBJ_USER && map == gObj[n].MapNumber) IOCP.DataSend(n, (UCHAR*)&pMsg, pMsg.h.size);
	}
}

void GameProtocol::PROTOCOL_ChatWhisper(PMSG_CHATDATA_WHISPER* lpMsg, int aIndex) {
	char tid[11];
	...
	if ((lpObj->Penalty & 2) == 2) return;
	if (g_ConfigRead.data.common.SavePrivateChat == true) MsgLog->Output(Lang.GetText(0,517), gObj[aIndex].AccountID, lpMsg->id, lpMsg->chatmsg);

	tid[10] = 0;
	memcpy(tid, lpMsg->id, sizeof(lpMsg->id));
	index = WhisperCash.AddCash(tid);

	// Cross-Server Whisper
	if (index < 0) {
	...
	len = strnlen_s(pWhisper.chatmsg, sizeof(pWhisper.chatmsg));

	if (gObj[index].CharacterData->bActiveSetParty == true) {
		if (len >= 4) {
			if (!strcmp(pWhisper.chatmsg, gObj[index].CharacterData->PartyPassword)) gObjAutoPartySet(&gObj[index], &gObj[aIndex]);
		}
	}
	if (len > 0) {
		...
		if (g_GensSystem.IsMapBattleZone(lpObj->MapNumber)) {
			...
			if (OwnInfluence == TarInfluence || CheckAuthorityCondition(98, lpObj) || CheckAuthorityCondition(98, &gObj[index])) IOCP.DataSend(index, (UCHAR*)&pWhisper, pWhisper.h.size);
		} else IOCP.DataSend(index, (UCHAR*)&pWhisper, pWhisper.h.size);
	}
}
...
void GameProtocol::CSPJoinIdPassRequest(PMSG_IDPASS* lpMsg, int aIndex) {
	if (aIndex < g_ConfigRead.server.GetObjectStartUserIndex() || aIndex > g_ConfigRead.server.GetObjectMax()) return;

	char serial[17];
	char id[11];
	char hwid[25];

	if (lpMsg->CliVersion[0] != szClientVersion[0] || lpMsg->CliVersion[1] != szClientVersion[1] || lpMsg->CliVersion[2] != szClientVersion[2] || lpMsg->CliVersion[3] != szClientVersion[3] || lpMsg->CliVersion[4] != szClientVersion[4]) {
	...
	if (PercentSyntaxCheck(id) == FALSE) {
		g_Log.AddC(TColor::Red, "[%d] Possible Crash attempt IP: %s ", aIndex, gObj[aIndex].CharacterData->Ip_addr);
	...
	if (lpMsg->HWID == NULL) {
		g_Log.AddC(TColor::Red, "[LOGIN ERROR] HWID is EMPTY, [Index]: %d [IP]: %s", aIndex, gObj[aIndex].CharacterData->Ip_addr);
		IOCP.CloseClient(aIndex);
		return;
	}
	...
	if (gObj[aIndex].LoginMsgSnd != FALSE) {
		if (gObj[aIndex].LoginMsgSnd == TRUE) g_Log.Add("error: It is after authentication information is sended [%d][%s][%s]", aIndex, id, gObj[aIndex].CharacterData->Ip_addr);
		else g_Log.Add("error: %d %s %d", gObj[aIndex].LoginMsgSnd, __FILE__, __LINE__);
	...
	strcpy_s(spMsg.IpAddress, sizeof(spMsg.IpAddress),  gObj[aIndex].CharacterData->Ip_addr);
	...
	memcpy(gObj[aIndex].CharacterData->HWID, hwid, sizeof(hwid));
	gObj[aIndex].m_cAccountItemBlock = 0;
	gObj[aIndex].CharacterData->VipType = 0;
	gObj[aIndex].CharacterData->VipEffect = VIP_EFFECT_NONE;
	gObj[aIndex].CharacterData->AntiHackCheckTime = GetTickCount();
	gObj[aIndex].CharacterData->dwLastHitHackTick = GetTickCount64();
...
void GameProtocol::CGPCharacterCreate(PMSG_CHARCREATE * lpMsg, int aIndex)
{
	...
	{
		g_Log.Add("Requested to create character before authentication [%d][%s]", aIndex, gObj[aIndex].CharacterData->Ip_addr);
		IOCP.CloseClient(aIndex);
	...
	if (gObj[aIndex].CharacterData->m_bSecurityCheck == false)
	{
...
void GameProtocol::CGPCharDel(PMSG_CHARDELETE * lpMsg,int aIndex)
{
	...
	if (gObj[aIndex].CharacterData->GuildNumber > 0 && gObj[aIndex].CharacterData->lpGuild != NULL)
	{
		g_Log.Add("[Anti-HACK][CGPCharDel] Attempted Character Delete which belongs to guild. [%s][%s] [%s]", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->lpGuild->Name);
		this->GCSendDisableReconnect(aIndex);
		//IOCP.CloseClient(aIndex);
		return;
	}
...
void GameProtocol::CGPCharacterMapJoinRequest(PMSG_CHARMAPJOIN * lpMsg, int aIndex)
{
	...
	if (g_ConfigRead.server.GetServerType() == SERVER_BATTLECORE)
	{
		...
		if (gObj[aIndex].CharacterData->m_NameConvertOfUBF.IsDuplicationOfName() == TRUE)
		{
			memcpy(_name, gObj[aIndex].CharacterData->m_NameConvertOfUBF.ConvertSlotIndexToName(lpMsg->btSlotIndex), MAX_ACCOUNT_LEN);
		}

		else
		{
			memcpy(_name, gObj[aIndex].CharacterData->m_NameConvertOfUBF.ConvertRealNameToName(tmpCmpName.c_str()), MAX_ACCOUNT_LEN);
		}
	}
...
void GameProtocol::GCLevelUpMsgSend(int aIndex, int iSendEffect) {
	...
	pMsg.LevelUpPoint = gObj[aIndex].CharacterData->LevelUpPoint;
	pMsg.MaxLife = gObj[aIndex].MaxLife+gObj[aIndex].AddLife;
	pMsg.MaxMana = gObj[aIndex].MaxMana+gObj[aIndex].AddMana;
	pMsg.MaxStamina = gObj[aIndex].MaxStamina + gObj[aIndex].AddStamina;
	...
	if (iSendEffect == 1) PROTOCOL_SendEffectInfo(aIndex, 0x10);
}
...
void GameProtocol::CGLevelUpPointAdd(PMSG_LVPOINTADD * lpMsg, int aIndex)
{
	...
	gObj[aIndex].CharacterData->AgilityCheckDelay = GetTickCount();
	...
	if (::CHARACTER_LevelUpPointAdd(lpMsg->Type, &gObj[aIndex]) == TRUE)
	{
...
void GameProtocol::GCSkillKeyRecv(PMSG_SKILLKEY * lpMsg, int aIndex) {
	if (!gObjIsGamePlaing(&gObj[aIndex])) return;
	if (gObj[aIndex].Type != OBJ_USER) return;
	DGOptionDataSend(aIndex, gObj[aIndex].Name, lpMsg->SkillKey, lpMsg->GameOption, lpMsg->QkeyDefine, lpMsg->WkeyDefine, lpMsg->EkeyDefine, lpMsg->ChatWindow, lpMsg->RkeyDefine, ntohl(lpMsg->QWERLevel), gObj[aIndex].CharacterData->m_EnableUseChangeSkin);
}
...
void GameProtocol::CGItemGetRequest(PMSG_ITEMGETREQUEST * lpMsg, int aIndex) {
	...
	if (gObj[aIndex].Type != OBJ_USER) return;
	if (gObj[aIndex].CloseType != -1) return;
	...
	if (!::gObjFixInventoryPointer(aIndex)) g_Log.Add("[Fix Inv.Ptr] False Location - %s, %d", __FILE__, __LINE__);
	if (gObj[aIndex].pTransaction == TRUE) {
		g_Log.Add("[%s][%s] CGItemGetRequest() Failed : Transaction == 1, IF_TYPE : %d", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].m_IfState.type);
		return;
	}

	CMuRummyInfo * pMuRummyInfo = gObj[aIndex].CharacterData->m_pCMuRummyInfo;

	if (!pMuRummyInfo) {
		g_Log.Add("[MuRummy][Error] pCMuRummyInfo is NULL [%s][%s] [%s, %d]", gObj[aIndex].AccountID, gObj[aIndex].Name, __FILE__, __LINE__);
		return;
	}
	...
	if (lpItem->IsItem() == TRUE && lpItem->Give == false && lpItem->live == true) {
		...
		if (lpItem->m_Type == ITEMGET(13, 20)) {
			switch (lpItem->m_Level) {
				case 0: {
					...
					if (iWRCount > 0) {
						g_Log.Add("[Ring Event] Too many have Magician's Ring [%s][%s] (Name:%s, Count:%d)", gObj[aIndex].AccountID, gObj[aIndex].Name, lpItem->GetName(), iWRCount);
						pResult.result = -1;
						pResult.h.size -= sizeof(pResult.Data);
						IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
		...
		if (lpItem->m_Type == ITEMGET(13,38)) {	// MoonStonePendant
			...
			if (count > 0) {
				g_Log.Add("[MoonStonePendant] Too many have MoonStonePendant [%s][%s] (Name:%s, Count:%d)", gObj[aIndex].AccountID, gObj[aIndex].Name, lpItem->GetName(), count);
				pResult.result = -1;
				pResult.h.size -= sizeof(pResult.Data);
				IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);	
		...
		if (lpItem->m_Type == ITEMGET(13,39)) {	// ChangeRing
			...
			if (count > 0) {
				g_Log.Add("[ChangeRing] Too many have ChangeRing [%s][%s] (Name:%s, Count:%d)", gObj[aIndex].AccountID, gObj[aIndex].Name, lpItem->GetName(), count);
				pResult.result = -1;
				pResult.h.size -= sizeof(pResult.Data);
				IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);	
		...
		if (lpItem->m_Type == ITEMGET(14,15)) { // Zen
			if (MapC[map_num].ItemGive(aIndex, item_num, false) == TRUE) {
				if (!gObjCheckMaxZen(aIndex, lpItem->m_BuyMoney)) {
					if (gObj[aIndex].CharacterData->Money < MAX_ZEN) {
						gObj[aIndex].CharacterData->Money = MAX_ZEN;
						pResult.result = -2;
						WORD hiWord = SET_NUMBERHW(gObj[aIndex].CharacterData->Money);
						WORD loWord = SET_NUMBERLW(gObj[aIndex].CharacterData->Money);
				...
				gObj[aIndex].CharacterData->Money += lpItem->m_BuyMoney;
				pResult.result = -2;
				WORD hiWord = SET_NUMBERHW(gObj[aIndex].CharacterData->Money);
				WORD loWord = SET_NUMBERLW(gObj[aIndex].CharacterData->Money);
				pResult.Data[0] = SET_NUMBERH(hiWord);
					...
					if (MAIN_INVENTORY_RANGE(pos)) {
						if (MapC[map_num].ItemGive(aIndex, item_num, true) == TRUE) {
							...
							if (gObj[aIndex].pInventory[pos].m_Durability >= IsOverlapItem(lpItem->m_Type)) {
								...
								this->PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
								::ItemSerialCreateSend(aIndex, 235, gObj[aIndex].X, gObj[aIndex].Y, ItemGetNumberMake(14, 28), lpItem->m_Level, 0, 0, 0, 0, aIndex, 0, 0, 0, 0, 0);
								g_Log.Add("[Kalima] [%s][%s] Make Lost Kalima Map (Left Kundun Mark:%d)", gObj[aIndex].AccountID, gObj[aIndex].Name, NewDur);
							...
							} else GCItemDurSend(aIndex,pos, gObj[aIndex].pInventory[pos].m_Durability, 0);
							return;
						}
					} else break;
				}
			...
			if (lpItem->m_Type == ITEMGET(14,110)) { // Dimensional Remnant
				...
				if (MAIN_INVENTORY_RANGE(pos)) {
					...
					if (gObj[aIndex].pInventory[pos].m_Durability >= IsOverlapItem(lpItem->m_Type)) {
						...
						gObj[aIndex].pInventory[pos].Clear();
						this->PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
						::ItemSerialCreateSend(aIndex, 235, gObj[aIndex].X, gObj[aIndex].Y, ItemGetNumberMake(14, 111), lpItem->m_Level, 0, 0, 0, 0, aIndex, 0, 0, 0, 0, 0);
						g_Log.Add("[DoppelGanger] [%s][%s] Make Mirror of Dimension (Left Marker %d)", gObj[aIndex].AccountID, gObj[aIndex].Name, NewDur);
			...
			if (lpItem->m_Type == ITEMGET(12,144) || lpItem->m_Type == ITEMGET(12,146)) { // Mithril & Elixir
				for (int j = 0; j < MAIN_INVENTORY_SIZE; j++) {
					...
					if (!MAIN_INVENTORY_RANGE(iInventoryPos)) break;
					int Dur = gObj[aIndex].pInventory[iInventoryPos].m_Durability + lpItem->m_Durability;

					if (Dur <= IsOverlapItem(lpItem->m_Type) && MapC[map_num].ItemGive(aIndex, item_num, true) == TRUE) {
						BYTE NewOption[MAX_EXOPTION_SIZE];
						...
						this->PROTOCOL_InventoryItemDeleteSend(aIndex, iInventoryPos, 1);

						if (lpItem->m_Type == ITEMGET(12, 144)) {
							ItemSerialCreateSend(aIndex, 233, gObj[aIndex].X, gObj[aIndex].Y, ItemGetNumberMake(12, 148), 0, 0, 0, 0, 0, aIndex, 0, 0, 0, 0, lpItem->m_BonusSocketOption);
							...
							ItemSerialCreateSend(aIndex, 233, gObj[aIndex].X, gObj[aIndex].Y, ItemGetNumberMake(12, 149), 0, 0, 0, 0, 0, aIndex, 0, 0, 0, 0, 0);
			...
			if (lpItem->m_Type == ITEMGET(14,101)) { // Imperial Fort
				...
				if (MAIN_INVENTORY_RANGE(pos)) {
					...
					if (gObj[aIndex].pInventory[pos].m_Durability >= IsOverlapItem(lpItem->m_Type)) {
						...
						gObj[aIndex].pInventory[pos].Clear();
						this->PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
						::ItemSerialCreateSend(aIndex, 235, gObj[aIndex].X, gObj[aIndex].Y, ItemGetNumberMake(14, 102), lpItem->m_Level, 0, 0, 0, 0, aIndex, 0, 0, 0, 0, 0);
						g_Log.Add("[Imperial] [%s][%s] Make Gaion's order letter (Left Scraps %d)", gObj[aIndex].AccountID, gObj[aIndex].Name, NewDur);
			...
			if (g_LuckyItemManager.IsLuckyItemEquipment(lpItem->m_Type) && g_ConfigRead.data.common.AllowGetLuckyItemGround == false) {
				...
				if (gSetItemOption.IsSetItem(lpItem->m_Type)) {
					if (lpItem->m_SetOption & 1) tmpSetOption = 1;
					else {
						if (lpItem->m_SetOption & 2) tmpSetOption = 2;
					}
			...
			if (lpItem->m_QuestItem == true && g_QuestExpManager.IsQuestItemAtt(lpItem->m_Type, 1) == true) {
				for (int n = 12; n < INVENTORY_SIZE; n++) {
					...
					if (gObj[aIndex].pInventory[n].m_Type == lpItem->m_Type && gObj[aIndex].pInventory[n].m_Durability < IsOverlapItem(lpItem->m_Type)) pos = n;
			...
			if (pResult.result != 0xFF) {
				ItemByteConvert((LPBYTE)&pResult.Data[0], lpItem->m_Type, lpItem->m_Option1, lpItem->m_Option2, lpItem->m_Option3, lpItem->m_Level, lpItem->m_Durability, lpItem->m_NewOption, lpItem->m_SetOption, lpItem->m_JewelOfHarmonyOption, lpItem->m_ItemOptionEx, lpItem->m_SocketOption, lpItem->m_BonusSocketOption, 0);

				if (MapC[map_num].ItemGive(aIndex, item_num, false) == TRUE) {
					BYTE pos = ::gObjInventoryInsertItem(aIndex, lpItem);
					if (pos == 0xFF) pResult.result = -1;
					IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
					...
					if (pos == 0xFF) {
						...
						if (BC_MAP_RANGE(map_num)) {
							...
							if (g_BloodCastle.CheckQuestItemSerial(iBridgeIndex, lpItem)) g_BloodCastle.CatchQuestItemByUser(iBridgeIndex, aIndex, lpItem->m_Level);
						}
						...
						if (IT_MAP_RANGE(map_num) && lpItem->m_Type == ITEMGET(14, 223)) {
							if (g_ConfigRead.server.GetServerType() == SERVER_MARKET) {
								...
								g_Log.Add("[ITR] (%d) (Account:%s, Name:%s) picked up Relics Item(serial:%I64d)", map_num - 44, gObj[aIndex].AccountID, gObj[aIndex].Name, lpItem->m_Number);
							}
						}

						if (g_ConfigRead.server.GetServerType() == SERVER_BATTLECORE) {
							if (gObj[aIndex].MapNumber == MAP_INDEX_CHAOSCASTLE_SURVIVAL) g_ChaosCastleFinal.SetUBFGetReward(aIndex, lpItem->m_Type, lpItem->m_Number, pos);
							else if (gObj[aIndex].MapNumber == MAP_INDEX_DEVILSQUARE_FINAL) g_DevilSquareFinal.SetUBFGetReward(aIndex, lpItem->m_Type, lpItem->m_Number, pos);
							else if (CC_MAP_RANGE(gObj[aIndex].MapNumber) == TRUE) g_ChaosCastle.SetUBFGetReward(aIndex, lpItem->m_Type, lpItem->m_Number, pos);
						}

						if (g_ArcaBattle.IsArcaBattleServer() == TRUE && lpItem->m_Type == ITEMGET(13,147)) g_ArcaBattle.BootyItemGetCnt(&gObj[aIndex]);
...
bool GameProtocol::CGItemDropRequest(PMSG_ITEMTHROW * lpMsg, int aIndex, BOOL drop_type) {
	...
	if (!PacketCheckTime(aIndex)) return FALSE;
	...
	if (gObj[aIndex].CloseType != -1) pResult.Result = false;
	if (gObj[aIndex].m_bMapSvrMoveQuit == true) {
		g_Log.Add("[ANTI-HACK][Item Duplication] - Item Drop during MapServer Move [%s][%s]", gObj[aIndex].AccountID, gObj[aIndex].Name);
		pResult.Result = false;
	}

	if (!::gObjFixInventoryPointer(aIndex)) g_Log.Add("[Fix Inv.Ptr] False Location - %s, %d", __FILE__, __LINE__);
	if (gObj[aIndex].pTransaction == 1) {
		g_Log.Add("[%s][%s] CGItemDropRequest() Failed : Transaction == 1, IF_TYPE : %d", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].m_IfState.type);
		pResult.Result = false;		
		return false;
	}
	...
	if (lpMsg->Ipos < 0 || lpMsg->Ipos > MAIN_INVENTORY_SIZE - 1) pResult.Result = false;	// Out of Bounds
	if (!gObjCanItemTouch(lpObj, 0)) pResult.Result = false;
	if (!IsDumpItem(lpObj->pInventory[lpMsg->Ipos].m_Type) && (lpObj->pInventory[lpMsg->Ipos].m_Type != ITEMGET(13, 20) || !lpObj->pInventory[lpMsg->Ipos].m_Level)) pResult.Result = false;
	if (g_LuckyItemManager.IsLuckyItemEquipment(lpObj->pInventory[lpMsg->Ipos].m_Type) || g_LuckyItemManager.IsLuckyItemTicket(lpObj->pInventory[lpMsg->Ipos].m_Type)) pResult.Result = false;
	...
	if (gObj[aIndex].MapNumber == MAP_INDEX_ICARUS) {
		if (lpMsg->Ipos == lpObj->m_btInvenPetPos) {
			if (lpObj->pInventory[lpMsg->Ipos].m_Type == ITEMGET(13, 3)) {
				if (lpObj->pInventory[7].IsItem() == FALSE) pResult.Result = false;
			}
		} else if (lpMsg->Ipos == 7) {
			if (lpObj->pInventory[lpObj->m_btInvenPetPos].m_Type != ITEMGET(13, 3)) pResult.Result = false;
		}
	}

	if (lpObj->pInventory[lpMsg->Ipos].m_Type == ITEMGET(12,30) || lpObj->pInventory[lpMsg->Ipos].m_Type == ITEMGET(12,31) || lpObj->pInventory[lpMsg->Ipos].m_Type == ITEMGET(13,36) || lpObj->pInventory[lpMsg->Ipos].m_Type == ITEMGET(13,37)) pResult.Result = false;
	if (GetWingType(lpObj->pInventory[lpMsg->Ipos].m_Type, WCF_ITEMNUMBER) != NONE_WING && g_ConfigRead.pk.bPkPenaltyDisable== FALSE) pResult.Result = false;
	if ((lpObj->pInventory[lpMsg->Ipos].m_Type >= ITEMGET(13,0) && lpObj->pInventory[lpMsg->Ipos].m_Type <= ITEMGET(13,3)) || lpObj->pInventory[lpMsg->Ipos].m_Type == ITEMGET(14,13) || lpObj->pInventory[lpMsg->Ipos].m_Type == ITEMGET(14,14) || lpObj->pInventory[lpMsg->Ipos].m_Type == ITEMGET(14,16) || (lpObj->pInventory[lpMsg->Ipos].m_Type >= ITEMGET(12,0) && lpObj->pInventory[lpMsg->Ipos].m_Type <= ITEMGET(12,6)) || (lpObj->pInventory[lpMsg->Ipos].m_Type >= ITEMGET(12,36) && lpObj->pInventory[lpMsg->Ipos].m_Type <= ITEMGET(12,40)) || lpObj->pInventory[lpMsg->Ipos].m_Type == ITEMGET(12,15) || (lpObj->pInventory[lpMsg->Ipos].m_Level > g_ConfigRead.pk.iPkMaxLevelItemDrop && lpObj->pInventory[lpMsg->Ipos].m_Type < ITEMGET(12,0)) || (lpObj->pInventory[lpMsg->Ipos].IsSetItem() != FALSE && !g_ConfigRead.pk.bPkDropExpensiveItems) || (lpObj->pInventory[lpMsg->Ipos].IsExtItem() != FALSE && !g_ConfigRead.pk.bPkDropExpensiveItems)) {
		if (g_ConfigRead.pk.bPkPenaltyDisable == FALSE) pResult.Result = false;
	}
	...
	if (g_kJewelOfHarmonySystem.IsJewelOfHarmonyOriginal(lpObj->pInventory[lpMsg->Ipos].m_Type) || g_kJewelOfHarmonySystem.IsJewelOfHarmonyPurity(lpObj->pInventory[lpMsg->Ipos].m_Type) || g_kJewelOfHarmonySystem.IsJewelOfHarmonySmeltingItems(lpObj->pInventory[lpMsg->Ipos].m_Type)) pResult.Result = false;
	if (lpObj->pInventory[lpMsg->Ipos].m_Type == ITEMGET(13, 39)) pResult.Result = false;
	if (lpObj->pInventory[lpMsg->Ipos].IsPeriodItem() == TRUE) pResult.Result = false;
	if (g_NewPVP.IsDuel(*lpObj)) pResult.Result = false;
	if (IsJumpingEventItem(lpObj->pInventory[lpMsg->Ipos].m_Type) == TRUE) pResult.Result = false;
	if (pResult.Result == 1) {
		...
		if (gObjCheckSerial0ItemList(&lpObj->pInventory[lpMsg->Ipos]) != FALSE) {
			...
			g_Log.Add("[ANTI-HACK][Serial 0 Item] [ItemDrop] (%s)(%s) Item(%s) Pos(%d)", lpObj->AccountID, lpObj->Name, lpObj->pInventory[lpMsg->Ipos].GetName(), lpMsg->Ipos);
			CopyItem = TRUE;
			pResult.Result = false;
			bIsItem = FALSE;
		}
		...
		if (bIsItem == TRUE) {
			...
			if (g_BagManager.SearchAndUseBag(lpObj->m_Index, BAG_COMMON, type, level) == true) {
				...
				g_Log.Add("[%s][%s][Used Item Bag] : (%d)(X:%d/Y:%d)", lpObj->AccountID, lpObj->Name, lpObj->MapNumber, lpObj->X, lpObj->Y);
			} else if (type == ITEMGET(14, 51)) {
				gObjInventoryDeleteItem(aIndex, lpMsg->Ipos);
				FireworksOpenEven(&gObj[aIndex]);
				g_Log.Add("[%s][%s][Used Star Fireworks Effect] : (%d)(X:%d/Y:%d)", lpObj->AccountID, lpObj->Name, lpObj->MapNumber, lpObj->X, lpObj->Y);
			} else if (type == ITEMGET(14,63)) {
				gObjInventoryDeleteItem(aIndex, lpMsg->Ipos);
				FireworksOpenEven(&gObj[aIndex]);
				g_Log.Add("[%s][%s][Used Pounch Fireworks Effect] : (%d)(X:%d/Y:%d)", lpObj->AccountID, lpObj->Name, lpObj->MapNumber, lpObj->X, lpObj->Y);
				...
				switch (level) {
					case 0: {
						...
						if (randor < 10) Level = 3;
						else if (randor < 45) Level = 1;
						else Level = 2;

						ItemSerialCreateSend(aIndex, lpObj->MapNumber, lpObj->X, lpObj->Y, ltype, Level, 1, 0, 0, 0, lpObj->m_Index, 0, 0, 0, 0, 0);							
						g_Log.Add("[Hidden TreasureBox Event] [%s][%s] Throw Mysterious Bead : Drop (%d) - serial:%I64d", lpObj->AccountID, lpObj->Name, Level, serial);
					}
					break;
					...
					case 3: {
						...
						g_Log.Add("[Hidden TreasureBox Event] [%s][%s] Throw Crystal (%d) - serial:%I64d", lpObj->AccountID, lpObj->Name, level, serial);
					}
					break;

					case 4:	break;
					case 5:
						g_Log.Add("[Hidden TreasureBox Event] [%s][%s] Throw Surprise Treasure Box - serial:%I64d", lpObj->AccountID, lpObj->Name,  serial);
						gObjInventoryDeleteItem(aIndex, lpMsg->Ipos);
						pResult.Result = true;

						if ((rand() % 10000) < g_iHiddenTreasureBoxOfflineRate) EGReqRegHTOfflineGift(lpObj->m_Index);
						else {
							int money = 1000000;
							MapC[lpObj->MapNumber].MoneyItemDrop(money, lpObj->X, lpObj->Y);							
							g_Log.Add("[Hidden TreasureBox Event] [%s][%s] Event ZenDrop : %d : (%d)(%d/%d)", lpObj->AccountID, lpObj->Name, money, lpObj->MapNumber, lpObj->X, lpObj->Y);
						}
					break;
				}
			} else if (type == ITEMGET(13, 20) && level == 1) {	// Warrior Ring +1
			...
			} else if (type == ITEMGET(13, 20) && level == 2) {	// Warrior Ring +2
				...
				if (g_KalimaGate.CreateKalimaGate(aIndex, level, lpMsg->px, lpMsg->py)) {
					g_Log.Add("[Kalima] [%s][%s] Success to Make Kalima Gate (Lost Kalima Map Serial:%I64d)", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].pInventory[lpMsg->Ipos].m_Number);
					gObjInventoryDeleteItem(aIndex, lpMsg->Ipos);
				} else {
					pResult.Result = false;
					IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
				...
				IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
				return FALSE;
			} else if (type == ITEMGET(14, 20) && (((level - 1 < 0) ? FALSE : (level - 1 > 4) ? FALSE : TRUE) != FALSE)) gObjInventoryDeleteItem(aIndex, lpMsg->Ipos);	// Remedy of Love
			else if (type == ITEMGET(13, 7)) {	// Contract Summon
				int iMonsterID = 0;

				if (level == 0) iMonsterID = 286;
				else if (level == 1) iMonsterID = 287;


				if (g_CsNPC_Mercenary.CreateMercenary(aIndex, iMonsterID, lpMsg->px, lpMsg->py)) ::gObjInventoryDeleteItem(aIndex, lpMsg->Ipos);
				else {
					pResult.Result = false;
					IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
					return FALSE;
				}
			} else if (type == ITEMGET(13, 11)) {
				BOOL bResult = FALSE;

				if (level == 0) bResult = g_CsNPC_Guardian.CreateGuardian(aIndex);
				else if (g_ConfigRead.server.GetServerType() == SERVER_CASTLE && level == 1) bResult = g_CsNPC_LifeStone.CreateLifeStone(aIndex);
				if (bResult == TRUE) ::gObjInventoryDeleteItem(aIndex, lpMsg->Ipos);
				else {
					pResult.Result = false;
					IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
					return FALSE;
				...
				switch (type) {
					case ITEMGET(14, 236):						g_BagManager.SearchAndUseBag(aIndex, BAG_EVENT, EVENTBAG_ITR_1, aIndex);						break;
					case ITEMGET(14, 237):						g_BagManager.SearchAndUseBag(aIndex, BAG_EVENT, EVENTBAG_ITR_2, aIndex);						break;
					case ITEMGET(14, 238):						g_BagManager.SearchAndUseBag(aIndex, BAG_EVENT, EVENTBAG_ITR_3, aIndex);						break;
					case ITEMGET(14, 239):						g_BagManager.SearchAndUseBag(aIndex, BAG_EVENT, EVENTBAG_ITR_4, aIndex);						break;
					case ITEMGET(14, 240):						g_BagManager.SearchAndUseBag(aIndex, BAG_EVENT, EVENTBAG_ITR_5, aIndex);						break;
					case ITEMGET(14, 241):						g_BagManager.SearchAndUseBag(aIndex, BAG_EVENT, EVENTBAG_ITR_6, aIndex);						break;
				}

				g_Log.Add("[%s][%s][%d]%d/%d Illusion Pot Item Serial:%I64d (%s:%d/level:%d/skill:%d/op2:%d/op3:%d)", lpObj->AccountID, lpObj->Name, lpObj->MapNumber, lpObj->X, lpObj->Y, serial, szItemName, type, level, Option1, Option2, Option3);
			} else {
				int OwnerIndex = aIndex;

				if ((type >= ITEMGET(14, 0) && type <= ITEMGET(14, 10)) || (type == ITEMGET(4, 7)) || type == ITEMGET(4, 15) || type == ITEMGET(14, 64)) OwnerIndex = -1;

				if (MapC[map].ItemDrop(type, level, dur, lpMsg->px, lpMsg->py, Option1, Option2, Option3, NOption, SOption, serial2, OwnerIndex, PetLevel, PetExp, btItemEffectEx, SocketOption, SocketIndex, 0) == TRUE) {
					gObjInventoryDeleteItem(aIndex, lpMsg->Ipos);
					pResult.Result = true;

					if (drop_type == FALSE) g_Log.Add("[%s][%s][%d]%d/%d Throw away Serial:%I64d [%s][%d][%d][%d][%d][%d] dur:[%d] Ex:[%d,%d,%d,%d,%d,%d,%d] Set:[%d] 380:[%d] HO:[%d,%d] E:[%d]", lpObj->AccountID, lpObj->Name, lpObj->MapNumber, lpObj->X, lpObj->Y, serial, szItemName, type, level, Option1, Option2, Option3, (int)dur, NewOption[0], NewOption[1], NewOption[2], NewOption[3], NewOption[4], NewOption[5], NewOption[6], SOption, btItemEffectEx>>7, JOHOption, JOHOptionLevel, gObj[aIndex].pInventory[lpMsg->Ipos].m_BonusSocketOption);
					else g_Log.Add("[%s][%s][%d]%d/%d Throw away (Drop) Serial:%I64d [%s][%d][%d][%d][%d][%d] dur:[%d] Ex:[%d,%d,%d,%d,%d,%d,%d] Set:[%d] 380:[%d] HO:[%d,%d] E:[%d]", lpObj->AccountID, lpObj->Name, lpObj->MapNumber, lpObj->X, lpObj->Y, serial, szItemName, type, level, Option1, Option2, Option3, (int)dur, NewOption[0], NewOption[1], NewOption[2], NewOption[3], NewOption[4], NewOption[5], NewOption[6], SOption, btItemEffectEx, JOHOption, JOHOptionLevel, gObj[aIndex].pInventory[lpMsg->Ipos].m_BonusSocketOption);
				} else pResult.Result = false;
			}
		} else {
	...
	if (pResult.Result == 1) {
		if (lpMsg->Ipos < 12) {
			if (lpMsg->Ipos == 10 || lpMsg->Ipos == 11) gObjUseSkill.SkillChangeUse(aIndex);
...
void GameProtocol::CGInventoryItemMove(PMSG_INVENTORYITEMMOVE * lpMsg, int aIndex) {
	...
	if (lpObj->CharacterData->m_ReqWarehouseOpen != false) {
		g_Log.AddC(TColor::Red, "[%s][%d] error-L3", __FILE__, __LINE__);
	...
	if (lpMsg->tFlag == 2 || lpMsg->sFlag == 2) it_type = 6;
	if (lpMsg->tFlag == 0 && lpMsg->sFlag == 0) it_type = 8;
	if ((lpMsg->tFlag == 0 && lpMsg->sFlag == 4) || (lpMsg->tFlag == 4 && lpMsg->sFlag == 0) || (lpMsg->tFlag == 4 && lpMsg->sFlag == 4)) it_type = 8;
	...
	if (lpMsg->sFlag == 6 || lpMsg->sFlag == 7 || lpMsg->sFlag == 8 || lpMsg->tFlag == 6 || lpMsg->tFlag == 7 || lpMsg->tFlag == 8) {
		...
		if (lpObj->ChaosLock == TRUE) {
			g_Log.Add("[%s][%s] error-L3 : JewelOfHarmony Mixing", gObj[aIndex].AccountID, gObj[aIndex].Name);
			this->GCItemMoveResultSend(aIndex, -1, 0, (LPBYTE)&ItemInfo);
			return;
		}
	}
	...
	if (lpMsg->sFlag == 11 || lpMsg->sFlag == 12 || lpMsg->sFlag == 13 || lpMsg->sFlag == 14 || lpMsg->sFlag == 15 || lpMsg->sFlag == 16 || lpMsg->sFlag == 17 || lpMsg->tFlag == 11 || lpMsg->tFlag == 12 || lpMsg->tFlag == 13 || lpMsg->tFlag == 14 || lpMsg->tFlag == 15 || lpMsg->tFlag == 16 || lpMsg->tFlag == 17 || lpMsg->tFlag == 19) {
		if (lpObj->m_IfState.use < 1 || lpObj->m_IfState.type != 7) {
			this->GCItemMoveResultSend(aIndex, -1, 0, (LPBYTE)&ItemInfo);
			g_Log.Add("[%s][%s] error-L1 : used not ChaosBox", gObj[aIndex].AccountID, gObj[aIndex].Name);
			return;
		...
		if (lpObj->ChaosLock == TRUE) {
			g_Log.Add("[%s][%s] error-L3 : SocketItem Mixing", gObj[aIndex].AccountID, gObj[aIndex].Name);
			this->GCItemMoveResultSend(aIndex, -1, 0, (LPBYTE)&ItemInfo);
			return;
		}
	}
	...
	if (lpMsg->sFlag == 2 && lpMsg->tFlag == 0) {
		...
		if ((lpObj->CharacterData->Money - money) < 1 && (lpObj->WarehouseMoney - money) < 1) {
			this->GCItemMoveResultSend(aIndex, -1, 0, (LPBYTE)&ItemInfo);
	...
	if ((lpMsg->sFlag == 0 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 2 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 2) || (lpMsg->sFlag == 2 && lpMsg->tFlag == 2) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 3) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 5) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 6) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 7) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 8) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 9) || (lpMsg->sFlag == 9 && lpMsg->tFlag == 9) || (lpMsg->sFlag == 9 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 4) || (lpMsg->sFlag == 4 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 4 && lpMsg->tFlag == 4) || (lpMsg->sFlag == 5 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 5 && lpMsg->tFlag == 5) || (lpMsg->sFlag == 6 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 6 && lpMsg->tFlag == 6) || (lpMsg->sFlag == 7 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 7 && lpMsg->tFlag == 7) || (lpMsg->sFlag == 8 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 8 && lpMsg->tFlag == 8) || (lpMsg->sFlag == 3 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 3 && lpMsg->tFlag == 3) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 10) || (lpMsg->sFlag == 10 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 11) || (lpMsg->sFlag == 11 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 12) || (lpMsg->sFlag == 12 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 13) || (lpMsg->sFlag == 13 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 14) || (lpMsg->sFlag == 14 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 15) || (lpMsg->sFlag == 15 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 16) || (lpMsg->sFlag == 16 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 17) || (lpMsg->sFlag == 17 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 11 && lpMsg->tFlag == 11) || (lpMsg->sFlag == 12 && lpMsg->tFlag == 12) || (lpMsg->sFlag == 13 && lpMsg->tFlag == 13) || (lpMsg->sFlag == 14 && lpMsg->tFlag == 14) || (lpMsg->sFlag == 15 && lpMsg->tFlag == 15) || (lpMsg->sFlag == 16 && lpMsg->tFlag == 16) || (lpMsg->sFlag == 17 && lpMsg->tFlag == 17) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 19) || (lpMsg->sFlag == 19 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 19 && lpMsg->tFlag == 19) || (lpMsg->sFlag == 0 && lpMsg->tFlag == 20) || (lpMsg->sFlag == 20 && lpMsg->tFlag == 0) || (lpMsg->sFlag == 20 && lpMsg->tFlag == 20)) {
		BOOL DurSSend;
		BOOL DurTSend;

		result = gObjInventoryMoveItem(aIndex, source, target, DurSSend, DurTSend, lpMsg->sFlag, lpMsg->tFlag, (LPBYTE)&ItemInfo);

		if (lpObj->m_IfState.use == 1 && lpObj->m_IfState.type == 3) this->GCPriceSend(lpObj->m_Index, 1, 0);	// Shop

		this->GCItemMoveResultSend(aIndex, result, target, (LPBYTE)&ItemInfo);

		if (DurSSend != FALSE) this->GCItemDurSend(aIndex, source, lpObj->pInventory[source].m_Durability, FALSE);
		if (DurTSend != FALSE) this->GCItemDurSend(aIndex, target, lpObj->pInventory[target].m_Durability, FALSE);
		if (result != 0xFF && lpMsg->sFlag == 2 && lpMsg->tFlag == 0) {
			int money = ::GetWarehouseUsedHowMuch(lpObj->Level, lpObj->WarehousePW);

			if ((lpObj->CharacterData->Money - money) > 0) {
				int iZen = lpObj->CharacterData->Money;

				lpObj->CharacterData->Money -= money;
				this->GCMoneySend(lpObj->m_Index, lpObj->CharacterData->Money);
				g_Log.Add("Pay WareHouse Money(In Inventory) : %d - %d = %d", iZen, money, lpObj->CharacterData->Money);
				...
				this->GCWarehouseInventoryMoneySend(aIndex, 1, lpObj->CharacterData->Money, lpObj->WarehouseMoney);
			}
		}
	...
	if (lpMsg->sFlag == 1 && lpMsg->tFlag == 21) {
		...
		} else this->GCItemMoveResultSend(aIndex, result, target, ItemInfo);
	...
	if (lpMsg->sFlag == 21 && lpMsg->tFlag == 21) {
		...
		if (DurSSend) this->GCEventItemDurSend(aIndex, source, lpObj->pEventInventory[source].m_Durability);
		if (DurTSend) this->GCEventItemDurSend(aIndex, target, lpObj->pEventInventory[source].m_Durability);
		if (lpObj->pEventInventory[target].m_Durability == 0.0) GCEventInventoryItemDeleteSend(aIndex, target, TRUE);
	...
	if (lpMsg->sFlag == 1 && lpMsg->tFlag == 0) {
		...
		if (result == 0xFF) {
			...
			this->CGTradeCancelButtonRecv(aIndex);
		} else this->GCItemMoveResultSend(aIndex, result, target, (LPBYTE)&ItemInfo);
...
void GameProtocol::CGTalkRequestRecv(PMSG_TALKREQUEST * lpMsg, int aIndex) {
	...
	if (!PacketCheckTime(aIndex)) return;
	if (!gObjIsConnectedGP(aIndex))	{
		g_Log.Add("[ANTI-HACK][NPC Talk] Couldn't talk.. (%s)(%s)",	gObj[aIndex].AccountID, gObj[aIndex].Name);
		return;
	}
	...
	if (DealerNumber < 0 || DealerNumber > g_ConfigRead.server.GetObjectMax() - 1) return;
	if (lpObj->MapNumber != gObj[DealerNumber].MapNumber) return;
	if (g_ConfigRead.server.GetServerType() != SERVER_CASTLE) {
		if (gObj[DealerNumber].Class == 367) {
			if ((lpObj->X < (gObj[DealerNumber].X - 5)) || (lpObj->X>(gObj[DealerNumber].X + 5)) || (lpObj->Y < (gObj[DealerNumber].Y - 10)) || (lpObj->Y >(gObj[DealerNumber].Y + 5))) return;
		} else if ((lpObj->X < (gObj[DealerNumber].X - 5)) || (lpObj->X>(gObj[DealerNumber].X + 5)) || (lpObj->Y < (gObj[DealerNumber].Y - 5)) || (lpObj->Y >(gObj[DealerNumber].Y + 5))) return;
	} else {
		if ((lpObj->X < (gObj[DealerNumber].X - 5)) || (lpObj->X>(gObj[DealerNumber].X + 5)) || (lpObj->Y < (gObj[DealerNumber].Y - 5)) || (lpObj->Y >(gObj[DealerNumber].Y + 5))) return;
	}
	...
	if (gObj[aIndex].pTransaction == 1) {
		g_Log.Add("[%s][%s] CGTalkRequestRecv() Failed : Transaction == 1, IF_TYPE : %d", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].m_IfState.type);
		return;
	}
	...
	if (gObj[DealerNumber].Type == OBJ_NPC && gObj[DealerNumber].m_btNpcType == NPC_TYPES::NPC_NONE) return;
	if (gObj[DealerNumber].m_btNpcType == NPC_TYPES::NPC_SHOP) {
		SHOP_DATA * lpShopData = g_ShopMng.GetShop(lpObj, &gObj[DealerNumber]);

		if (!lpShopData) return;
	}

	if (gMerryXMasNpcEvent == TRUE) {
		if ((rand() % 6) == 0) PROTOCOL_ChatSend(&gObj[DealerNumber], Lang.GetText(0,55));
	}

	if (::gHappyNewYearNpcEvent == TRUE) {
		if ((rand() % 6) == 0) PROTOCOL_ChatSend(&gObj[DealerNumber], Lang.GetText(0,56));
	}
	...
	if (gObj[DealerNumber].m_btNpcType == NPC_TYPES::NPC_SHOP && lpShopData->btIsMossMerchant == TRUE) pResult.result = 0x22;
	else pResult.result = 0x00;
	...
	if (gObj[DealerNumber].m_btNpcType == NPC_TYPES::NPC_WAREHOUSE) {		
		if (gObj[aIndex].CharacterData->m_JoinUnityBattle == true || g_ConfigRead.server.GetServerType() == SERVER_BATTLECORE) {
		...
		if (g_ConfigRead.server.GetServerType() == SERVER_MARKET || gObj[aIndex].MapNumber == MAP_INDEX_LORENMARKET) {
			g_Log.Add("[Error][%s][%s] Try open Warehouse in Market Server or lorenmarket map.", lpObj->AccountID, lpObj->Name);
			return;
		}

		if (gObj[aIndex].CharacterData->m_ReqWarehouseOpen != false) {
			g_Log.Add("[%s][%s] is Already Opening Warehouse (ReqWarehouseOpen), open warehouse failed", lpObj->AccountID, lpObj->Name);
			return;
		}

		if (gObj[aIndex].CharacterData->m_bSecurityCheck == false) return;
		if (gObj[aIndex].m_btOpenWarehouse == TRUE) {
			g_Log.Add("[%s][%s] is Already Opening Warehouse, open warehouse failed", lpObj->AccountID, lpObj->Name);
			return;
		}

		lpObj->CharacterData->m_ReqWarehouseOpen = true;
		...
		if (bCanChaosBox == TRUE) {
			...
			if (gObj[DealerNumber].Class == 450) pResult.result = 22;
			else if (gObj[DealerNumber].Class == 478) pResult.result = 32;
		...
		pResult.result = 34;
		IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
	} else IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);

	if (gObj[DealerNumber].m_btNpcType == NPC_TYPES::NPC_WAREHOUSE) {
		if (gObj[aIndex].m_bMapSvrMoveReq == true) {
			gObj[aIndex].CharacterData->m_ReqWarehouseOpen = false;
			g_Log.Add("[CGTalkRequestRecv] MapServerMove User. Can't Open WhareHouse. return!! [%s], IP [%s] ", gObj[aIndex].AccountID, gObj[aIndex].CharacterData->Ip_addr);
			return;
		}
		...
		if (gObj[aIndex].m_IfState.use && gObj[aIndex].m_IfState.type == 19) {
			g_Log.Add("[CGTalkRequestRecv][SHOPITEMCOPY][InGameShop Interface Using].[Can't Open WhareHouse] return!! AccID:[%s], IP:[%s], Name :[%s]", gObj[aIndex].AccountID, gObj[aIndex].CharacterData->Ip_addr, gObj[aIndex].Name);
			return;
		}
	...
	if (gObj[DealerNumber].m_btNpcType == NPC_TYPES::NPC_CHAOSMIX) return;
...
void GameProtocol::GCUserWarehouseSend(LPOBJ lpObj) {
	if (lpObj->m_IfState.type != 6) return;
	if (lpObj->m_IfState.type == 6 && lpObj->m_IfState.state == 1) return;
	...
	this->GCWarehouseInventoryMoneySend(lpObj->m_Index, 1, lpObj->CharacterData->Money, lpObj->WarehouseMoney);
...
void GameProtocol::CGBuyRequestRecv(PMSG_BUYREQUEST * lpMsg, int aIndex)
{
	...
	if (lpObj->CharacterData->m_bIsCancelItemSale == true)
	{
		IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
		return;
	}
	...
	if (lpShopData->m_ShopData.m_item[lpMsg->Pos].IsItem() == TRUE)
	{
		...
		/*if (gObj[aIndex].CharacterData->VipType != 0) // not used for now
		{
		...
		if (lpObj->CharacterData->Money < iStoreTaxMoney)
			pResult.Result = -1;
		else
		{
			BOOL bNoItem = TRUE;
				...
				(lpShopData->m_ShopData.m_item[lpMsg->Pos].m_Type >= ITEMGET(14, 35) && lpShopData->m_ShopData.m_item[lpMsg->Pos].m_Type <= ITEMGET(14, 40)))
			{
				...
				{
					bNoItem = FALSE;
					lpObj->CharacterData->Money -= iStoreTaxMoney;
					::g_CastleSiegeSync.AddTributeMoney(iStoreTaxMoney2);

					if (lpObj->CharacterData->Money < 0)
						lpObj->CharacterData->Money = 0;

		
					this->GCMoneySend(aIndex, lpObj->CharacterData->Money);
				}
			}
			...
			if (bNoItem)
			{
				if (lpShopData->m_ShopData.m_item[lpMsg->Pos].m_Type == ITEMGET(13,239)) // Muun Energy Converter
				{
					...
					GCMoneySend(aIndex, lpObj->CharacterData->Money);
...
void GameProtocol::CGSellRequestRecv(PMSG_SELLREQUEST * lpMsg, int aIndex) {
	...
	if (!::gObjFixInventoryPointer(aIndex)) g_Log.Add("[Fix Inv.Ptr] False Location - %s, %d", __FILE__, __LINE__);
	if (gObj[aIndex].pTransaction == 1) {
		g_Log.Add("[%s][%s] CGSellRequestRecv() Failed : Transaction == 1, IF_TYPE : %d", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].m_IfState.type);
		return;
	}
	...
	if (gObjCheckSerial0ItemList(&lpObj->pInventory[lpMsg->Pos]) != FALSE) {
		...
		IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
		g_Log.Add("[ANTI-HACK][Serial 0 Item] [Sell Item] (%s)(%s) Item(%s) Pos(%d)", lpObj->AccountID, lpObj->Name, lpObj->pInventory[lpMsg->Pos].GetName(), lpMsg->Pos);
		return;
	}
	...
	if (g_ConfigRead.data.common.EnableSellAllItems == false) {
		...
		if (lpObj->pInventory[lpMsg->Pos].m_Type == ITEMGET(12, 26) && (lpObj->pInventory[lpMsg->Pos].m_Level == 1 || lpObj->pInventory[lpMsg->Pos].m_Level == 2 || lpObj->pInventory[lpMsg->Pos].m_Level == 3 || lpObj->pInventory[lpMsg->Pos].m_Level == 4 || lpObj->pInventory[lpMsg->Pos].m_Level == 5)) {
			IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
			return;
		}
		...
		if (lpObj->pInventory[lpMsg->Pos].IsPeriodItem() == TRUE) {
			if (lpObj->pInventory[lpMsg->Pos].m_Type == ITEMGET(12,266) || lpObj->pInventory[lpMsg->Pos].m_Type == ITEMGET(12,267)) {
	...
	if (lpObj->pInventory[lpMsg->Pos].m_Type == ITEMGET(14,12) && lpObj->pInventory[lpMsg->Pos].m_Level == 1) {
		pResult.Result = true;
		pResult.Money = lpObj->CharacterData->Money;
	...
	if (lpObj->pInventory[lpMsg->Pos].IsItem() == FALSE) {
		...
		if (type == ITEMGET(13, 4) || type == ITEMGET(13, 5)) lpObj->pInventory[lpMsg->Pos].PetValue(); // Pets
		else lpObj->pInventory[lpMsg->Pos].Value();

		iAddZen = lpObj->pInventory[lpMsg->Pos].m_SellMoney;

		/*if (lpObj->CharacterData->VipType != 0) // not used for now
		{
		...
		lpObj->CharacterData->Money += iAddZen;
		pResult.Result = true;
		pResult.Money = lpObj->CharacterData->Money;
		...
		if (g_PentagramSystem.IsPentagramItem(&lpObj->pInventory[lpMsg->Pos])) g_PentagramSystem.DelPentagramJewelInfo(aIndex, &lpObj->pInventory[lpMsg->Pos]);

		bool bSendEquip = false;

		if ((lpObj->pInventory[lpMsg->Pos].m_Type == ITEMGET(13,169) || lpObj->pInventory[lpMsg->Pos].m_Type == ITEMGET(13,170)) && (lpMsg->Pos == 10 || lpMsg->Pos == 11)) bSendEquip = true;
		if (IsExpensiveItem(&lpObj->pInventory[lpMsg->Pos]) == TRUE && lpObj->pInventory[lpMsg->Pos].IsPeriodItem() == FALSE) g_CancelItemSale.GDReqAddItemToList(aIndex, lpObj->pInventory[lpMsg->Pos], iAddZen);

		::gObjInventoryDeleteItem(aIndex, lpMsg->Pos);

		if (bSendEquip == true) this->GCEquipmentSend(aIndex);
		if (lpMsg->Pos == 10 || lpMsg->Pos == 11) ::gObjUseSkill.SkillChangeUse(aIndex);
...
int GameProtocol::GetNeedMoneyItemDurRepaire(/*int aIndex, */CItem *  DurItem, BOOL RequestPos)
{
	...
	if (::HasItemDurability(type) != FALSE)
	{
		...
		else
		{
			...
			/* switch (lpObj->CharacterData->VipType) // temporary disabled as requires display price fix on client side
			{
				case 1:
...
void GameProtocol::ItemDurRepaire(LPOBJ lpObj, /*int aIndex, */CItem * DurItem, int pos, int RequestPos)
{
	...
	if ((lpObj->CharacterData->Money - pResult.Money) < 1)
		pResult.Money = 0;
	else
	{
		lpObj->CharacterData->Money -= pResult.Money;
		pResult.Money = lpObj->CharacterData->Money;
...
void GameProtocol::CGTradeRequestSend(PMSG_TRADE_REQUEST * lpMsg, int aIndex)
{
	...
	if (gObj[number].CharacterData->m_bSecurityCheck == false)
	{
	...
	if (gObj[number].m_bMapSvrMoveReq == true || gObj[aIndex].m_bMapSvrMoveReq == true)
	{
		g_Log.Add("[CGTradeRequestSend] MapServerMove User. Can't Trade. return!! [%s], IP [%s] -> [%s], IP [%s]",
			gObj[number].AccountID, gObj[number].CharacterData->Ip_addr, gObj[aIndex].AccountID, gObj[aIndex].CharacterData->Ip_addr);
	...
	if (gObj[aIndex].CharacterData->m_JoinUnityBattle == true ||
		gObj[number].CharacterData->m_JoinUnityBattle == true ||
	...
	if (gObj[number].CharacterData->ISBOT == true && g_BotSystem.GetBotType(number) == BOT_TRADE)
	{
		g_BotSystem.AlchemistTradeOpen(aIndex,number);
		return;
	}
	if (gObj[number].CharacterData->ISBOT == true && g_BotSystem.GetBotType(number) == BOT_BUFFER)
	{
...
/*	if (gObj[number].CharacterData->ISBOT == true && g_BotSystem.GetBotType(number) == BOT_TRADE)
	...
	g_Log.Add("Request to trade [%s][%s][%s] to [%s][%s][%s]", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr,
		gObj[number].AccountID, gObj[number].Name, gObj[number].CharacterData->Ip_addr);

	TradeLog->Output("Request to trade [%s][%s][%s] to [%s][%s][%s]", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr,
		gObj[number].AccountID, gObj[number].Name, gObj[number].CharacterData->Ip_addr);
}
...
{	
	...
	if (gObj[aIndex].CharacterData->ISBOT == FALSE)
	{
	...
	else
	{
		...
		{
			lpMsg->Response = true;
			GCTradeResponseSend(lpMsg->Response, number, gObj[aIndex].Name, gObj[aIndex].Level, gObj[aIndex].CharacterData->GuildNumber);
			GCTradeResponseSend(lpMsg->Response, aIndex, gObj[number].Name, gObj[number].Level, gObj[number].CharacterData->GuildNumber);
...
void GameProtocol::CGTradeMoneyRecv(PMSG_TRADE_GOLD * lpMsg, int aIndex)
{
	...
	if ((gObj[aIndex].CharacterData->Money - money) < 0)
		return;

	GCMoneySend(aIndex, gObj[aIndex].CharacterData->Money - money);
	...
	g_Log.Add("[%s][%s][%s] -> [%s][%s][%s]: Trade Money %d",gObj[aIndex].AccountID,gObj[aIndex].Name,gObj[aIndex].CharacterData->Ip_addr,gObj[number].AccountID,gObj[number].Name,gObj[number].CharacterData->Ip_addr,money);
	TradeLog->Output("[%s][%s][%s] -> [%s][%s][%s]: Trade Money %d",gObj[aIndex].AccountID,gObj[aIndex].Name,gObj[aIndex].CharacterData->Ip_addr,gObj[number].AccountID,gObj[number].Name,gObj[number].CharacterData->Ip_addr,money);
}
...
bool GameProtocol::GCTradeOkButtonSend(int aIndex, BYTE flag)
{
	...
	pMsg.Flag = flag;
	/*if (gObj[gObj[aIndex].TargetNumber].CharacterData->ISBOT == TRUE && g_BotSystem.GetBotType(gObj[aIndex].TargetNumber) == BOT_TRADE)
	{
...
void GameProtocol::CGTradeOkButtonRecv(PMSG_TRADE_OKBUTTON * lpMsg, int aIndex)
{
	...
	if (gObj[number].Type == OBJ_USER && gObj[number].CharacterData->ISBOT == 1)
	{
		if (lpMsg->Flag == 1)
		{
	...
	if (!gObj[number].CharacterData->ISBOT)
	{
	...
	g_Log.Add("[%s][%s][%s] -> [%s][%s][%s]: Trade Accept!",gObj[aIndex].AccountID,gObj[aIndex].Name,gObj[aIndex].CharacterData->Ip_addr,gObj[number].AccountID,gObj[number].Name,gObj[number].CharacterData->Ip_addr);
	TradeLog->Output("[%s][%s][%s] -> [%s][%s][%s]: Trade Accept!",gObj[aIndex].AccountID,gObj[aIndex].Name,gObj[aIndex].CharacterData->Ip_addr,gObj[number].AccountID,gObj[number].Name,gObj[number].CharacterData->Ip_addr);
}
...
void GameProtocol::CGTradeCancelButtonRecv(int aIndex)
{
	...
	g_Log.Add("[%s][%s][%s]: Trade Cancel Button Press",gObj[aIndex].AccountID,gObj[aIndex].Name,gObj[aIndex].CharacterData->Ip_addr);
	TradeLog->Output("[%s][%s][%s]: Trade Cancel Button Press",gObj[aIndex].AccountID,gObj[aIndex].Name,gObj[aIndex].CharacterData->Ip_addr);
}
...
void GameProtocol::CGPartyRequestRecv(PMSG_PARTYREQUEST * lpMsg, int aIndex)
{
	...
	if (gObj[number].CharacterData->m_bUsePartyMatching)
	{
	...
	if (gObj[number].Type != OBJ_USER)
	{
		g_Log.AddC(TColor::Red, "[HACKTOOL] : NPC-PartyRequest npc:%d ip:%s account:%s name:%s State:%d",
			gObj[number].Class, gObj[aIndex].CharacterData->Ip_addr, gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].Connected);
		this->GCSendDisableReconnect(aIndex);
		//IOCP.CloseClient(aIndex);
		return;
	}
	...
	if (g_ArcaBattle.IsArcaBattleServer() &&  gObj[aIndex].CharacterData->GuildNumber != gObj[number].CharacterData->GuildNumber) 
	{
	...
	if (gObj[aIndex].CharacterData->RegisterdLMS == 1)
	{
		MsgOutput(aIndex,Lang.GetText(0,523));
		return;
	}

	if (gObj[number].CharacterData->RegisterdLMS == 1)
	{
	...
	if (result == 1)
	{
		...
		if (gObj[number].PartyNumber >= 0 )
		{
			...
			if (iPartyPos >= 0)
			{
				...
				if (g_ConfigRead.server.GetServerType() == SERVER_BATTLECORE)
				{
					wsprintf(szTemp, Lang.GetText(0,20), gObj[aIndex].CharacterData->m_RealNameOfUBF);
					this->GCServerMsgStringSend(szTemp, number, 1);
					wsprintf(szTemp, Lang.GetText(0,20), gObj[number].CharacterData->m_RealNameOfUBF);
					this->GCServerMsgStringSend(szTemp, aIndex, 1);
				}
				...
				if (gObj[number].CharacterData->m_bUsePartyMatching == true)
				{
		...
		for (int n=0;n<MAX_USER_IN_PARTY;n++)
		{
			...
			if (number >= 0)
			{
				if (gObjIsConnected(&gObj[number], gParty.m_PartyS[pnumber].DbNumber[n]) == TRUE)
				{
					...
					pList.nServerChannel = gObj[number].CharacterData->m_nServerChannel + 1;
	...
	for (int n=0;n<MAX_USER_IN_PARTY;n++)
	{
		...
		if (number >= 0)
		{
			if (gObjIsConnected(&gObj[number], gParty.m_PartyS[pnumber].DbNumber[n]) == TRUE)
			{
				...
				if (g_ConfigRead.server.GetServerType() == SERVER_BATTLECORE)
				{
					memcpy(pList.szId, gObj[number].CharacterData->m_RealNameOfUBF, MAX_ACCOUNT_LEN);
				}
...
void GameProtocol::CGPartyDelUser(PMSG_PARTYDELUSER * lpMsg, int aIndex, int nType)
{
	...
	if (gObj[aIndex].CharacterData->m_bUsePartyMatching == true)
	{
	...
	if (!DG_MAP_RANGE(gObj[usernumber].MapNumber))
	{
		if (!lpMsg->Number)
		{
			...
			if (bDPUser == TRUE && count > 2)
			{
				...
				gParty.UpdatePKPartyPenalty(pnumber);
		...
		if (!IMPERIAL_MAP_RANGE(gObj[usernumber].MapNumber))
		{
			...
			if (gObj[usernumber].CharacterData->lpGuild)
			{
				if (gObj[usernumber].CharacterData->lpGuild->WarState == 1 && gObj[usernumber].IsInBattleGround)
				{
				...
				if (usernumber == gParty.m_PartyS[pnumber].Number[0])
				{
					for (int j = 0; j < 5; j++)
					{
						...
						if (number >= 0
							&& gObj[number].CharacterData->lpGuild
							&& gObj[number].CharacterData->lpGuild->WarState == TRUE
...
void GameProtocol::CGGuildRequestRecv(PMSG_GUILDJOINQ * lpMsg, int aIndex)
{
	...
	if (gObj[number].Type != OBJ_USER)
	{
		g_Log.AddC(TColor::Red, "[HACKTOOL] : NPC-GuildRequest npc:%d ip:%s account:%s name:%s State:%d", gObj[number].Class, gObj[aIndex].CharacterData->Ip_addr, gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].Connected);
		this->GCSendDisableReconnect(aIndex);
		//IOCP.CloseClient(aIndex);
		return;
	}
	...
	if (gObj[number].CharacterData->GuildNumber > 0)
	{
		if (strcmp(gObj[number].CharacterData->lpGuild->Names[0], gObj[number].Name))
		{
			if (gObj[number].CharacterData->GuildStatus != 64)
			{
		...
		if (gObj[number].CharacterData->lpGuild->WarState)
		{
			GCResultSend(aIndex, 0x51, 0x06);
			return;
		}
		...
		if (gObj[number].Class == CLASS_DARKLORD)
			MaxGuildMember = (gObj[number].Level+gObj[number].CharacterData->MasterLevel) / 10 + gObj[number].Leadership / 10;
		else
			MaxGuildMember = (gObj[number].Level+gObj[number].CharacterData->MasterLevel) / 10;

		if (MaxGuildMember > g_ConfigRead.data.common.MaxGuildMember)
			MaxGuildMember = g_ConfigRead.data.common.MaxGuildMember;

		if (gObj[number].CharacterData->lpGuild->TotalCount >= MaxGuildMember)
		{
	...
	g_Log.Add("[%s][%s] Guild Request - Join : %s",
		gObj[aIndex].AccountID, gObj[aIndex].Name,
		gObj[number].CharacterData->lpGuild->Name);
}
...
void GameProtocol::CGGuildRequestResultRecv(PMSG_GUILDQRESULT * lpMsg, int aIndex) //GS-CS Decompiled 100%
{
	...
	if (result == 1)
	{
		if (gObj[aIndex].CharacterData->GuildNumber > 0)
		{
			GDGuildMemberAdd(number, gObj[aIndex].CharacterData->lpGuild->Name, gObj[number].Name);
...
void GameProtocol::CGGuildListAll(int pnumber)
{
	...
	if (gObj[pnumber].CharacterData->lpGuild == NULL)
		return;
	...
	if (gObj[pnumber].CharacterData->GuildNumber < 1)
	{
		IOCP.DataSend(pnumber, (LPBYTE)&pCount, lOfs);
		return;
	}

	pCount.Count = gObj[pnumber].CharacterData->lpGuild->Count;
	pCount.TotalScore = gObj[pnumber].CharacterData->lpGuild->TotalScore;
	pCount.Score = gObj[pnumber].CharacterData->lpGuild->PlayScore;
	memset(pCount.szRivalGuild, 0, sizeof(pCount.szRivalGuild));

	if (gObj[pnumber].CharacterData->lpGuild->iGuildRival)
	{
		int iGuildCount = 0;
		int iGuildList[MAX_UNION_GUILD] ={0};

		if (UnionManager.GetGuildUnionMemberList(gObj[pnumber].CharacterData->lpGuild->iGuildRival, iGuildCount, iGuildList) == TRUE)
		{
			for (int i=0;i<iGuildCount;i++)
			{
				_GUILD_INFO_STRUCT *lpGuildInfo = Guild.SearchGuild_Number(iGuildList[i]);
		...
		{
			memcpy(pCount.szRivalGuild[0], gObj[pnumber].CharacterData->lpGuild->szGuildRivalName, MAX_GUILD_LEN);
		}
	}
	...
	for (n=0;n<MAX_USER_GUILD;n++)
	{
		number = gObj[pnumber].CharacterData->lpGuild->Use[n];

		if (number > 0)
		{
			memset(&pList, 0, sizeof(pList));
			memcpy(pList.Name, gObj[pnumber].CharacterData->lpGuild->Names[n], sizeof(pList.Name));
			pList.Number = gObj[pnumber].CharacterData->lpGuild->pServer[n];
			pList.ConnectAServer = (short)gObj[pnumber].CharacterData->lpGuild->pServer[n] & 0x7F;

			if (gObj[pnumber].CharacterData->lpGuild->pServer[n] >= 0)
				pList.ConnectAServer |= 0x80;

			pList.btGuildStatus = gObj[pnumber].CharacterData->lpGuild->GuildStatus[n];
			memcpy(&sendbuf[lOfs], &pList, sizeof(pList));
			lOfs+= sizeof(pList);
			pCount.Count++;
		}
...
void GameProtocol::CGGuildDelUser(PMSG_GUILDDELUSER * lpMsg, int aIndex)
{
	...
	if (gObj[aIndex].CharacterData->GuildNumber < 1)
		return;
	...
	strcpy_s(guildname, sizeof(guildname),  gObj[aIndex].CharacterData->lpGuild->Name);

	if (!strcmp(gObj[aIndex].CharacterData->lpGuild->Names[0], gObj[aIndex].Name))
	{
		memset(joomin, 0, sizeof(joomin));
		...
		if (!strcmp(memberid, gObj[aIndex].Name))
		{
			...
			{
				if (strcmp(gObj[aIndex].CharacterData->lpGuild->Name, g_CastleSiegeSync.GetCastleOwnerGuild()) == 0)
				{
			...
			GDGuildDestroySend(aIndex, gObj[aIndex].CharacterData->lpGuild->Name, gObj[aIndex].Name);
			g_ArcaBattle.ReqRemoveRewardGuildBuff(gObj[aIndex].CharacterData->lpGuild->Name);
			g_ArcaBattle.GDReqMarkRegDel(aIndex, gObj[aIndex].CharacterData->GuildNumber);
		}
		else
		{
			if (Guild.GetGuildMemberStatus(gObj[aIndex].CharacterData->lpGuild->Name, memberid) == -1)
			{
				pMsg.Result = 0;
				IOCP.DataSend(aIndex, (LPBYTE)&pMsg, pMsg.h.size);
				return;
...
void GameProtocol::CGGuildMasterAnswerRecv(PMSG_GUILDMASTERANSWER * lpMsg, int aIndex)
{
	if (lpMsg->Result == 1)
	{
		if (!CHARACTER_GuildMasterCapacityTest(&gObj[aIndex]))
		{
...
void GameProtocol::GCGuildViewportNowPaint(int aIndex, char* guildname, BYTE* mark, BOOL isGuildMaster)
{
	...
	pMsg.GuildNumber = lpObj->CharacterData->lpGuild->Number;
	...
	if (isGuildMaster != FALSE)
		...
		pMsg.btGuildStatus = lpObj->CharacterData->GuildStatus;

	pMsg.btGuildType = lpObj->CharacterData->lpGuild->btGuildType;
	pMsg.btGuildRelationShip = 0;
	lpObj->CharacterData->iGuildUnionTimeStamp = 0;
...
void GameProtocol::GCGuildWarRequestResult(LPSTR GuildName, int aIndex, int type)
{
	...
	_GUILD_INFO_STRUCT * lpMyGuild = gObj[aIndex].CharacterData->lpGuild;
...
void GameProtocol::GCGuildWarRequestSendRecv(PMSG_GUILDWARSEND_RESULT * lpMsg, int aIndex)
{
	...
	_GUILD_INFO_STRUCT * lpMyNode = gObj[aIndex].CharacterData->lpGuild;
...
void GameProtocol::GCGuildWarScore(int aIndex)
{
	if (g_ConfigRead.server.GetServerType() != SERVER_CASTLE)
	{
		...
		if (gObj[aIndex].CharacterData->lpGuild != NULL)
		{
			pMsg.Score1 = gObj[aIndex].CharacterData->lpGuild->PlayScore;
			g_Log.Add("Score %s %d", gObj[aIndex].Name, gObj[aIndex].CharacterData->lpGuild->PlayScore);
		}

		if (gObj[aIndex].CharacterData->lpGuild->lpTargetGuildNode != NULL)
		{
			pMsg.Score2 = gObj[aIndex].CharacterData->lpGuild->lpTargetGuildNode->PlayScore;
			g_Log.Add("Target Score %s %d", gObj[aIndex].Name, gObj[aIndex].CharacterData->lpGuild->lpTargetGuildNode->PlayScore);
		}
...
void GameProtocol::CGWarehouseMoneyInOut(int aIndex, PMSG_WAREHOUSEMONEYINOUT* lpMsg)
{
	...
	switch (lpMsg->Type)
	{
		case 0x00:
			...
			if (money > lpObj->CharacterData->Money)
			{
				GCWarehouseInventoryMoneySend(aIndex, 0, 0, 0);
				return;
			}
		...
		case 0x01:
			{
				...
				if ((lpObj->CharacterData->Money-rZen) > 0)
				{
					int oldmoney = lpObj->CharacterData->Money;
					lpObj->CharacterData->Money -= rZen;
					GCMoneySend(lpObj->m_Index, lpObj->CharacterData->Money);
					
					g_Log.Add("Get WareHouse Money(In Inventory) : %d - %d = %d",
						oldmoney, rZen, lpObj->CharacterData->Money);
				}
				else if ((lpObj->WarehouseMoney-rZen) > 0)
				{
					...
					GCWarehouseInventoryMoneySend(aIndex, 1, lpObj->CharacterData->Money, lpObj->WarehouseMoney);
				}
				else
				{
					lpObj->WarehouseMoney +=money;
...
void GameProtocol::PROTOCOL_WarehouseStateSend(int aIndex, BYTE state) {
...
void GameProtocol::PROTOCOL_WarehouseReceivePassword(int aIndex, PMSG_WAREHOUSEPASSSEND* lpMsg) {
	if (bCanWarehouseLock == FALSE)	return;

	int pw = lpMsg->Pass;

	switch (lpMsg->Type) {
		case 0x00:							if (gObj[aIndex].WarehouseLock) {
												if (gObj[aIndex].WarehousePW == pw) {
													gObj[aIndex].WarehouseLock = FALSE;
													PROTOCOL_WarehouseStateSend(aIndex, 0x0C);
												} else PROTOCOL_WarehouseStateSend(aIndex, 0x0A);
											}																									break;
		case 0x01:							if (!gObj[aIndex].WarehouseLock || gObj[aIndex].WarehouseLock == 0xFF) {
												char szJoomin[21];
												...
												if (gObjPasswordCheck(aIndex, szJoomin) == FALSE) {
													PROTOCOL_WarehouseStateSend(aIndex, 0x0D);
													return;
												}
												...
												gObj[aIndex].WarehouseLock = FALSE;
												PROTOCOL_WarehouseStateSend(aIndex, 0x0C);
											} else PROTOCOL_WarehouseStateSend(aIndex, 0x0B);															break;
		case 0x02: {
				char szJoomin[21];
				...
				PROTOCOL_WarehouseStateSend(aIndex, gObj[aIndex].WarehouseLock);
			}																																	break;
	}
}

void GameProtocol::PROTOCOL_UserChaosBoxSend(LPOBJ lpObj, int iChaosBoxType) {
	if (iChaosBoxType == 1) {
		if (lpObj->m_IfState.type != 13) return;
		if (lpObj->m_IfState.type == 13 && lpObj->m_IfState.state == 1) return;
	} else {
		if (lpObj->m_IfState.type != 7) return;
		if (lpObj->m_IfState.type == 7 && lpObj->m_IfState.state == 1) return;
	}
	...
	if (iChaosBoxType == 1) pMsg.Type = 5;
	else pMsg.Type = 3;
...
void GameProtocol::PROTOCOL_ChaosBoxItemMixButtonClick(PMSG_CHAOSMIX* aRecv, int aIndex) {
	...
	if (g_ConfigRead.SeasonX == false) aRecv->MixCount = 1; // Disable Mass Combine

	LPOBJ lpObj = &gObj[aIndex];

	if (lpObj->ChaosLock == TRUE) {
		g_Log.Add("[%s][%s] Already Used Chaos", lpObj->AccountID, lpObj->Name);
	...
	if (aRecv->Type == 3 || aRecv->Type == 4 || aRecv->Type == 22 || aRecv->Type == 23) {
		int pos = 0;
	...
	switch (iMixType) {	// Season X Main ENG
		case CHAOS_TYPE_DEVILSQUARE:						if (aRecv->MixCount == 1) g_MixSystem.DevilSquareItemChaosMix(lpObj);
															else g_MixSystem.DevilSquareItemChaosMix_Multi(lpObj, aRecv->MixCount);								break;
		case CHAOS_TYPE_UPGRADE_10:							g_MixSystem.PlusItemLevelChaosMix(lpObj, CHAOS_TYPE_UPGRADE_10);									break;
		case CHAOS_TYPE_UPGRADE_11:							g_MixSystem.PlusItemLevelChaosMix(lpObj, CHAOS_TYPE_UPGRADE_11);									break;
		case CHAOS_TYPE_UPGRADE_12:							g_MixSystem.PlusItemLevelChaosMix(lpObj, CHAOS_TYPE_UPGRADE_12);									break;
		case CHAOS_TYPE_UPGRADE_13:							g_MixSystem.PlusItemLevelChaosMix(lpObj, CHAOS_TYPE_UPGRADE_13);									break;
		case CHAOS_TYPE_UPGRADE_14:							g_MixSystem.PlusItemLevelChaosMix(lpObj, CHAOS_TYPE_UPGRADE_14);									break;
		case CHAOS_TYPE_UPGRADE_15:							g_MixSystem.PlusItemLevelChaosMix(lpObj, CHAOS_TYPE_UPGRADE_15);									break;
		case CHAOS_TYPE_DINORANT:							if (aRecv->MixCount == 1) g_MixSystem.PegasiaChaosMix(lpObj);
															else g_MixSystem.PegasiaChaosMix_Multi(lpObj, aRecv->MixCount);										break;
		case CHAOS_TYPE_FRUIT:								if (aRecv->MixCount == 1) g_MixSystem.CircleChaosMix(lpObj);
															else g_MixSystem.CircleChaosMix_Multi(lpObj, aRecv->MixCount);										break;
		case CHAOS_TYPE_SECOND_WING:
		case CHAOS_TYPE_CLOAK:								g_MixSystem.WingChaosMix(lpObj);																	break;
		case CHAOS_TYPE_BLOODCATLE:							if (aRecv->MixCount == 1) g_MixSystem.BloodCastleItemChaosMix(lpObj);
															else g_MixSystem.BloodCastleItemChaosMix_Multi(lpObj, aRecv->MixCount);								break;
		case CHAOS_TYPE_DEFAULT:
		case CHAOS_TYPE_FIRST_WING:							g_MixSystem.DefaultChaosMix(lpObj);																	break;
		case CHAOS_TYPE_SETITEM:							g_MixSystem.SetItemChaosMix(lpObj);																	break;
		case CHAOS_TYPE_DARKHORSE:							g_MixSystem.DarkHorseChaosMix(lpObj);																break;
		case CHAOS_TYPE_DARKSPIRIT:							g_MixSystem.DarkSpiritChaosMix(lpObj);																break;
		case CHAOS_TYPE_BLESS_POTION:						if (aRecv->MixCount == 1) g_MixSystem.BlessPotionChaosMix(lpObj);
															else g_MixSystem.BlessPotionChaosMix_Multi(lpObj, aRecv->MixCount);									break;
		case CHAOS_TYPE_SOUL_POTION:						if (aRecv->MixCount == 1) g_MixSystem.SoulPotionChaosMix(lpObj);
															else g_MixSystem.SoulPotionChaosMix_Multi(lpObj, aRecv->MixCount);									break;
		case CHAOS_TYPE_LIFE_STONE:							g_MixSystem.LifeStoneChaosMix(lpObj);																break;
		case CHAOS_TYPE_CASTLE_SPECIAL_ITEM_MIX:			g_MixSystem.CastleSpecialItemMix(lpObj);															break;
		case CHAOS_TYPE_HT_BOX:								g_MixSystem.HiddenTreasureBoxItemMix(lpObj);														break;
		case CHAOS_TYPE_FENRIR_01:							g_MixSystem.Fenrir_01Level_Mix(lpObj);																break;
		case CHAOS_TYPE_FENRIR_02:							g_MixSystem.Fenrir_02Level_Mix(lpObj);																break;
		case CHAOS_TYPE_FENRIR_03:							g_MixSystem.Fenrir_03Level_Mix(lpObj);																break;
		case CHAOS_TYPE_FENRIR_04:							g_MixSystem.Fenrir_04Upgrade_Mix(lpObj);															break;
		case CHAOS_TYPE_COMPOUNDPOTION_LV1:					if (aRecv->MixCount == 1) g_MixSystem.ShieldPotionLv1_Mix(lpObj);
															else g_MixSystem.ShieldPotionLv1_Mix_Multi(lpObj, aRecv->MixCount);									break;
		case CHAOS_TYPE_COMPOUNTPOTION_LV2:					if (aRecv->MixCount == 1) g_MixSystem.ShieldPotionLv2_Mix(lpObj);
															else g_MixSystem.ShieldPotionLv2_Mix_Multi(lpObj, aRecv->MixCount);									break;
		case CHAOS_TYPE_COMPOUNTPOTION_LV3:					if (aRecv->MixCount == 1) g_MixSystem.ShieldPotionLv3_Mix(lpObj);
															else g_MixSystem.ShieldPotionLv3_Mix_Multi(lpObj, aRecv->MixCount);									break;
		case CHAOS_TYPE_JEWELOFHARMONY_PURITY:				if (aRecv->MixCount == 1) g_kJewelOfHarmonySystem.PurityJewelOfHarmony(lpObj);
															else g_kJewelOfHarmonySystem.PurityJewelOfHarmony_MultiMix(lpObj, aRecv->MixCount);					break;
		case CHAOS_TYPE_JEWELOFHARMONY_MIX_SMELTINGITEM:	if (aRecv->MixCount == 1) g_kJewelOfHarmonySystem.MakeSmeltingStoneItem(lpObj);
															else g_kJewelOfHarmonySystem.MakeSmeltingStoneItem_MultiMix(lpObj, aRecv->MixCount);				break;
		case CHAOS_TYPE_JEWELOFHARMONY_RESTORE_ITEM:		g_kJewelOfHarmonySystem.RestoreStrengthenItem(lpObj);												break;
		case CHAOS_TYPE_380_OPTIONITEM:						g_kItemSystemFor380.ChaosMix380ItemOption(lpObj);													break;
		case CHAOS_TYPE_LOTTERY_MIX:						g_MixSystem.LotteryItemMix(lpObj);																	break;
		case CHAOS_TYPE_OLD_PAPER:							g_MixSystem.IllusionTempleItemChaosMix(lpObj);														break;
		case CHAOS_TYPE_CONDOR_FEATHER:						g_MixSystem.ThirdWingLevel1ChaosMix(lpObj);															break;
		case CHAOS_TYPE_THIRD_WING:							g_MixSystem.ThirdWingLevel2ChaosMix(lpObj);															break;
		case CHAOS_TYPE_BLOSSOM_MIX:						g_MixSystem.CherryBlossomMix(lpObj);																break;
		case CHAOS_TYPE_SEED_EXTRACT:						g_MixSystem.SeedExtractMix(lpObj);																	break;
		case CHAOS_TYPE_SEED_SPHERE_COMPOSITE:				g_MixSystem.SeedSphereCompositeMix(lpObj);															break;
		case CHAOS_TYPE_SET_SEED_SPHERE:					g_MixSystem.SetSeedSphereMix(lpObj, aRecv->Pos);													break;
		case CHAOS_TYPE_SEED_SPHERE_REMOVE:					g_MixSystem.SeedSphereRemoveMix(lpObj, aRecv->Pos);													break;
		case CHAOS_TYPE_SECROMICON:							g_MixSystem.SecromiconMix(lpObj);																	break;
		case CHAOS_TYPE_PREMIUM_BOX:						if (aRecv->MixCount == 1) g_MixSystem.PremiumBoxMix(lpObj);
															else g_MixSystem.PremiumBoxMix_Multi(lpObj, aRecv->MixCount);										break;
		case CHAOS_TYPE_SUMMONS_MIX:						g_MixSystem.SummonsMix(lpObj);																		break;
		case CHAOS_TYPE_LUCKYITEM_EXCHANGE:					g_LuckyItemManager.LuckyItemTicketExchange(lpObj);													break;
		case CHAOS_TYPE_LUCKYITEM_REFINE:					g_LuckyItemManager.LuckyItemSmelting(lpObj);														break;
		case CHAOS_TYPE_SOCKETWEAPON:						g_MixSystem.ItemRefineMix(lpObj);																	break;
		case CHAOS_TYPE_ARCABATTLE_BOOTYMIX:				g_ArcaBattle.BootyExchange(lpObj);																	break;
		case CHAOS_TYPE_ARCABATTLE_SIGNOFLORD:				g_ArcaBattle.CGReqMarkRegButtonClick(lpObj);														break;
		case CHAOS_TYPE_MONSTERWING:						g_MixSystem.MonsterWingMix(lpObj);																	break;
		case CHAOS_TYPE_CCF_REWARD:							g_MixSystem.CCFRewardMix(lpObj);																	break;
		case CHAOS_TYPE_DSF_REWARD:							g_MixSystem.DSFRewardMix(lpObj);																	break;
		default:											g_Log.Add("[%s][%s] Undefine chaosmix type detect %d", lpObj->AccountID, lpObj->Name, iMixType);	break;
	}
}
void GameProtocol::PROTOCOL_ChaosBoxUseEnd(int aIndex) {
	if (!gObjIsConnectedGP(aIndex)) {
		g_Log.AddC(TColor::Red,  "error-L3 [%s][%d]", __FILE__, __LINE__);
		return;
	}
...
void GameProtocol::PROTOCOL_MoveProc(PMSG_MOVE* lpMove, int aIndex) {
	if (!ObjectMaxRange(aIndex)) {
		g_Log.Add("error-L3 : move protocol index error %s %d", __FILE__, __LINE__);
		return;
	}

	if (gObj[aIndex].m_bOffLevel == true) return;
	...
	if (lpObj->Connected != PLAYER_PLAYING) return; // for reconnect incase player is using MuBot
	if (MAX_MAP_RANGE(lpObj->MapNumber) == FALSE) return;
	if (lpObj->Type == OBJ_USER && lpObj->CharacterData->m_bSecurityCheck == false) {
		CHARACTER_Immobilize(aIndex, lpObj->X, lpObj->Y);
		return;
	}

	if (lpObj->RegenOk > 0) return;
	if (lpObj->m_bMapSvrMoveReq == true) return;
	if (lpObj->m_bMapSvrMoveReq_2 == true) return;
	...
	if (BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_ICE_ARROW) || BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_STUN) || BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_SLEEP) || BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_FREEZE) || BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_EARTHEN_PRISON)) {
		CHARACTER_Immobilize(lpObj->m_Index, lpObj->X, lpObj->Y);
		return;
	}
	...
	if (lpObj->PathCount > 15) {
		g_Log.Add("error-L3 : Path Count error %d id:%s %s %d", lpObj->PathCount, lpObj->AccountID, __FILE__, __LINE__);
		return;
	}
	...
	for (n = 1; n < lpObj->PathCount; n++) {
		if ((n % 2) == 1) pathtable = lpMove->Path[(n + 1) / 2] >> 4;
	...
	if (lpObj->Type == OBJ_USER && IMPERIAL_MAP_RANGE(lpObj->MapNumber)) {
		...
		for (int iCOUNT = 0; iCOUNT < 256; iCOUNT++) {
			...
			if (iCX == lpObj->TX && iCY == lpObj->TY) break;
			if (bSetStand == 1) {
				lpObj->m_Rest = 1;
				lpObj->PathCur = 0;
				lpObj->PathCount = 0;
	...
	if (g_ConfigRead.server.GetServerType() == SERVER_CASTLE) {
		if (lpObj->Type == OBJ_USER) {
			...
			for (int i = 0; i < 256; i++) {
				if (nextX > lpObj->TX) nextX -= 1;
				if (nextX < lpObj->TX) nextX += 1;
				if (nextY > lpObj->TY) nextY -= 1;
				if (nextY < lpObj->TY) nextY += 1;
	...
	if (lpObj->Type == OBJ_USER) {
		if (lpObj->m_byCCF_CanEnter == 0xFF) {
			...
			if (lpObj->m_bCCF_UI_Using == TRUE) lpObj->m_bCCF_UI_Using = FALSE;
		}
		...
		if (lpObj->VpPlayer2[n].state == TRUE) {
			...
			if (number >= 0) {
				if (gObj[number].Connected > PLAYER_CONNECTED) {
					if (gObj[number].Live) {
						if (gObj[number].Type == OBJ_USER) IOCP.DataSend(lpObj->VpPlayer2[n].number, (LPBYTE)&pMove, pMove.h.size);
					}
				} else {
	...
	if (lpObj->Type == OBJ_USER) {	// Recv Check
		if (rand() % 5 == 0) this->GCSendRecvCheck(lpObj->m_Index);
	}
}
void GameProtocol::PROTOCOL_RecvPositionSetProc(PMSG_POSISTION_SET * lpMove, int aIndex) {
	short n;
	...
	if (this->PacketCheckTime(aIndex) == FALSE) return;
	...
	if (lpObj->MapNumber == MAP_INDEX_CHAOSCASTLE_SURVIVAL) {
		if ((GetTickCount() - lpObj->m_nCCF_BlowTime) < 1000) return;
	}
	...
	if (lpObj->Type == OBJ_USER) IOCP.DataSend(aIndex, (UCHAR *)&pMove, pMove.h.size);
	...
	for (n = 0; n < MVL; n++) {
		if (lpObj->VpPlayer2[n].type == OBJ_USER) {
			if (lpObj->VpPlayer2[n].state == 1) {
				...
				if (ObjectMaxRange(Index) == false) continue;
				if (gObj[Index].Connected > PLAYER_CONNECTED && gObj[Index].Live != FALSE) IOCP.DataSend(lpObj->VpPlayer2[n].number, (UCHAR *)&pMove, pMove.h.size);
				else {
					lpObj->VpPlayer2[n].number = -1;
...
void GameProtocol::PROTOCOL_Attack(PMSG_ATTACK* lpMsg, int aIndex) {
	...
	if (usernumber < 0 || usernumber > g_ConfigRead.server.GetObjectMax() - 1) {
		g_Log.Add("[PROTOCOL_Attack] [UserIndex Error] :%s %d %d", __FILE__, __LINE__, usernumber);
		return;
	}

	if (!gObj[usernumber].Live) return;
	if (gObj[aIndex].Type == OBJ_USER && gObj[aIndex].CharacterData->m_bSecurityCheck == false) return;
	...
	if (bIsIgnorePacketSpeedHackDetect) {
		if (lpObj->m_SpeedHackPenalty > 0) {
			...
			g_Log.Add("[%s][%s] %s Apply Attack Speed Penalty (%d left)", lpObj->AccountID, lpObj->Name, Lang.GetText(0,202+lpObj->Class), lpObj->m_SpeedHackPenalty);
			return;
		}
	}
	...
	PROTOCOL_ActionSend(lpObj, lpMsg->AttackAction, aIndex, usernumber);
	gComboAttack.CheckCombo(aIndex, 0);
	gObjAttack(lpObj, lpTargetObj, NULL, FALSE, FALSE, 0, FALSE, 0, 0);	
	lpObj->UseMagicNumber = 0;
}
void GameProtocol::PROTOCOL_DamageSend(int aIndex, int TargetIndex, int AttackDamage, int MSBFlag, int MSBDamage, int iShieldDamage) {
	...
	if (gObj[TargetIndex].Type == OBJ_USER) IOCP.DataSend(TargetIndex, (LPBYTE)&pResult, pResult.h.size);
	if (cManager.WatchTargetIndex == TargetIndex || cManager.WatchTargetIndex == aIndex) cManager.DataSend((LPBYTE)&pResult, pResult.h.size);
	if (gObj[aIndex].Type == OBJ_USER) IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
}
...
void GameProtocol::PROTOCOL_DamageSendPoison(int aIndex, int damage, int iShieldDamage) {
	if (gObj[aIndex].Type != OBJ_USER) return;
...
void GameProtocol::PROTOCOL_PlayerExperienceSend(int aIndex, int TargetIndex, int exp, int AttackDamage, BOOL MSBFlag) {
	...
	if (BC_MAP_RANGE(gObj[aIndex].MapNumber) != FALSE) g_BloodCastle.AddExperience(aIndex, exp);
...
void GameProtocol::PROTOCOL_DiePlayerSend(LPOBJ lpObj, int TargetIndex, BYTE skill, int KillerIndex) {
	...
	if (lpObj->Type == OBJ_USER) IOCP.DataSend(lpObj->m_Index, (LPBYTE)&pDieMsg, iSize);
}

void GameProtocol::PROTOCOL_ActionSend(LPOBJ lpObj, BYTE ActionNumber, int aIndex, int aTargetIndex) {
	PMSG_ACTIONRESULT pActionResult;
...
void GameProtocol::PROTOCOL_ActionRecv(PMSG_ACTION * lpMsg, int aIndex) {
	if (!ObjectMaxRange(aIndex)) {
	...
	for (int n = 0; n < MVL; n++) {
		if (lpObj->VpPlayer2[n].type == OBJ_USER) {
			if (lpObj->VpPlayer2[n].state != 0 && lpObj->VpPlayer2[n].state != 0x10 && lpObj->VpPlayer2[n].state != 0x08) IOCP.DataSend(lpObj->VpPlayer2[n].number, (LPBYTE)&pResult, pResult.h.size);
		}
	}
}
void GameProtocol::PROTOCOL_MagicAttack(LPBYTE lpRecv, int aIndex) {
	if (aIndex < 0 || aIndex > g_ConfigRead.server.GetObjectMax() - 1) return;
	...
	if (gObj[usernumber].Live == 0 || gObj[usernumber].Connected < PLAYER_LOGGED) return;
	...
	if (attackret) {
		g_Log.Add("[%s][%s] Try Attack In Not Attack Area [Protocol] (%s:%d,%d) errortype = %d", lpObj->AccountID, lpObj->Name, Lang.GetMap(0,0+lpObj->MapNumber), lpObj->X, lpObj->Y, attackret);

		if (lpObj->Class == 275) lpObj->TargetNumber = -1;	// Kundun
		if (bIsIgnorePacketSpeedHackDetect) return;
	}

	if (lpObj->Type == OBJ_USER) {
		if (MagicNumber == 58) usernumber = 58; // Nova cast
		if (MagicNumber == 395) usernumber = 395;

		lpMagic = PLAYER_GetMagicSearch(lpObj, MagicNumber);

		if (!lpMagic) return;
		if (lpMagic->m_Skill == DL_SUMMON) {
			if (g_NewPVP.IsDuel(*lpObj) || g_NewPVP.IsDuel(*lpTargetObj)) return;
		}

		if (MagicDamageC.MAGIC_GetRequireClass(lpObj->Class, lpObj->CharacterData->ChangeUP, lpMagic->m_Skill) < 1) return;
		if (MagicDamageC.CheckStatus(lpMagic->m_Skill, lpObj->CharacterData->GuildStatus) == 0) {
			g_Log.AddC(TColor::Red,  "[0x19] PROTOCOL_MagicAttack() - Invalid Status");
			return;
		}

		if (MagicDamageC.CheckKillCount(lpMagic->m_Skill, lpObj->m_btKillCount) < 0) {
			g_Log.AddC(TColor::Red,  "[0x19] PROTOCOL_MagicAttack() - Invalid KillCount");
			return;
		}

		if (lpObj->Teleport && gObjUseSkill.m_SkillData.EnableWizardSkillWhileTeleport == false) return;
	} else {
		lpMagic = PLAYER_GetMagic(lpObj, MagicNumber);

		if (!lpMagic) return;
	}

	if (lpMagic->m_Skill != 24 && !gObjUseSkill.SpeedHackCheck(aIndex)) return;
	if (!CHARACTER_CheckSkillDistance(aIndex, usernumber, lpMagic->m_Skill)) {
		...
		if (lpObj->m_iSkillDistanceErrorCount > g_iSkillDistanceKickCount) {
			if (g_iSkillDistanceKick) {
				g_Log.Add("[SKILL DISTANCE CHECK] [%s][%s] Kick Invalid Skill Area User. count(%d)", lpObj->AccountID, lpObj->Name, lpObj->m_iSkillDistanceErrorCount);
...
void GameProtocol::PROTOCOL_RageFighterAttack(LPBYTE lpRecv, int aIndex) {
	LPOBJ lpObj;
	LPOBJ lpTargetObj;
	...
	if (MagicNumber == 263 || MagicNumber == 559 || MagicNumber == 563) {
		this->PROTOCOL_RageFighterMagicAttack(&gObj[aIndex], MagicNumber, gObj[aIndex].CharacterData->DarkSideTarget[0], TRUE);
		return;
	}
	...
	if (lpObj->Type == OBJ_USER) {
		...
		if (MagicDamageC.MAGIC_GetRequireClass(lpObj->Class, lpObj->CharacterData->ChangeUP, lpMagic->m_Skill) < 1) return;
		if (MagicDamageC.CheckStatus(lpMagic->m_Skill, lpObj->CharacterData->GuildStatus) == 0) {
			g_Log.AddC(TColor::Red,  "[0x4A] PROTOCOL_RageFighterAttack() - Invalid Status");
			return;
		}

		if (MagicDamageC.CheckKillCount(lpMagic->m_Skill, lpObj->m_btKillCount) < 0) {
			g_Log.AddC(TColor::Red,  "[0x4A] PROTOCOL_RageFighterAttack() - Invalid KillCount");
			return;
		}

		if (lpObj->CharacterData->m_bSecurityCheck == false) return;
	}
	...
	this->PROTOCOL_RageFighterMagicAttack(lpObj, MagicNumber, usernumber, TRUE);
}
void GameProtocol::PROTOCOL_RageFighterAttackRange(PMSG_RAGE_ATTACK_RANGE *lpMsg, int aIndex) {
	if (ObjectMaxRange(aIndex) == FALSE) return;
	if (gObj[aIndex].Type != OBJ_USER) return;
	if (gObj[aIndex].Teleport) return;
	...
	for (int i = 0; i < 5; i++) Target[i] = 10000;

	lpMagic = PLAYER_GetMagicSearch(lpObj, MagicNumber);

	if (lpMagic) {
		if (gObjUseSkill.RF_DarkSideGetTargetIndex(aIndex, TargetIndex, lpMagic, Target) == TRUE) {
			...
			for (int i = 0; i < 5; i++) {
				if (Target[i] != 10000) gObj[aIndex].CharacterData->DarkSideCount++;
			}

			memcpy(gObj[aIndex].CharacterData->DarkSideTarget, Target, sizeof(Target));
			IOCP.DataSend(aIndex, (LPBYTE)&pMsg, pMsg.h.size);
		}
	}
}
void GameProtocol::PROTOCOL_MagicAttackNumberSend(LPOBJ lpObj, WORD MagicNumber, int usernumber, unsigned char skillsuccess) {
	...
	if (skillsuccess == 1) pAttack.TargetNumberH |= 0x80;		
	if (lpObj->Type == OBJ_USER) IOCP.DataSend(lpObj->m_Index, (LPBYTE)&pAttack, pAttack.h.size);
...
void GameProtocol::PROTOCOL_RageFighterMagicAttack(LPOBJ lpObj, WORD MagicNumber, int usernumber,  unsigned char skillsuccess) {
...
void GameProtocol::PROTOCOL_MagicCancelSend(LPOBJ lpObj, WORD MagicNumber) {
	...
	if (lpObj->Type == OBJ_USER) IOCP.DataSend(lpObj->m_Index, (UCHAR*)&pMsg, pMsg.h.size);
	
	MsgSendV2(lpObj, (UCHAR*)&pMsg, pMsg.h.size);
}
void GameProtocol::PROTOCOL_UseEffectItem(LPOBJ lpObj, int iEffectUseOption, int iOptionType, int iEffectType, int iLeftTime) {
...
void GameProtocol::PROTOCOL_MagicCancel(PMSG_MAGICCANCEL * lpMsg, int aIndex) {
	if (!ObjectMaxRange(aIndex)) return;
	...
	switch (MagicNumber) {
		case 77:			BUFF_RemoveBuffEffect(lpObj, 6);			break;
		case 233:			BUFF_RemoveBuffEffect(lpObj, 82);			break;
		case 380:			BUFF_RemoveBuffEffect(lpObj, 138);			break;
		case 383:			BUFF_RemoveBuffEffect(lpObj, 139);			break;
		case 441:			BUFF_RemoveBuffEffect(lpObj, 143);			break;
	}
}
...
void GameProtocol::PROTOCOL_UseMonsterSkillSend(LPOBJ lpObj, LPOBJ lpTargetObj, int iSkillNumber) {	
...
void GameProtocol::PROTOCOL_StateInfoSend(LPOBJ lpObj, BYTE state, int BuffViewport) {
	...
	if (lpObj->Type == OBJ_USER) IOCP.DataSend(lpObj->m_Index, (LPBYTE)&pMsg, pMsg.h.size);
	if (CC_MAP_RANGE(lpObj->MapNumber) || lpObj->MapNumber == MAP_INDEX_CHAOSCASTLE_SURVIVAL) return;

	MsgSendV2(lpObj, (LPBYTE)&pMsg, pMsg.h.size);
}

void GameProtocol::PROTOCOL_TeleportRecv(PMSG_TELEPORT* lpMsg, int aIndex) {
	if (!ObjectMaxRange(aIndex)) return;
	if (BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_STUN) == TRUE || BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_SLEEP) == TRUE || BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_FREEZE) || BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_EARTHEN_PRISON)) {
	...
	if (lpObj->m_bMapSvrMoveReq == true || lpObj->m_bMapSvrMoveReq_2 == true || lpObj->m_bMapSvrMoveQuit == true || lpObj->m_State == 32) {
		g_Log.Add("[PROTOCOL_TeleportRecv] MapServerMove User. Can't Move. return!! [%s], IP [%s] ", lpObj->AccountID, lpObj->CharacterData->Ip_addr);
		return;
	}
	...
	if (CC_MAP_RANGE(gObj[aIndex].MapNumber) != FALSE) {
	...
	if (lpMsg->MoveNumber == 0) {
		...
		if (gObjCheckTeleportArea(aIndex, x, y) == FALSE) {
			g_Log.AddC(TColor::Red,  "[%s][%s] Try Teleport Not Move Area [%d,%d]", gObj[aIndex].AccountID, gObj[aIndex].Name, x, y);
		...
		if (g_ConfigRead.server.GetServerType() == SERVER_CASTLE) {
			if (gObj[aIndex].MapNumber == MAP_INDEX_CASTLESIEGE) {
				if (g_CastleSiege.CheckTeleportMagicAxisY(gObj[aIndex].Y, x, y) == FALSE) y = gObj[aIndex].Y;
			}
		}
		...
		lpMagic = PLAYER_GetMagicSearch(&gObj[aIndex], 6);

		if (lpMagic) {
			int usemana = PLAYER_MagicManaUse(&gObj[aIndex], lpMagic);
			
			if (usemana >= 0) {
				int usebp = PLAYER_MagicStamUse(&gObj[aIndex], lpMagic);
			
				if (usebp >= 0) {
					if (gObj[aIndex].Type == OBJ_USER) IOCP.DataSend(aIndex, (LPBYTE)&pAttack, pAttack.h.size);

					MsgSendV2(&gObj[aIndex], (LPBYTE)&pAttack, pAttack.h.size);
					PLAYER_TeleportMagicUse(aIndex, x, y);
					gObj[aIndex].Mana = usemana;
					gObj[aIndex].Stamina = usebp;
					PROTOCOL_ManaSend(gObj[aIndex].m_Index, gObj[aIndex].Mana, -1, 0, gObj[aIndex].Stamina);
				}
			}
		}
	}
	...
	if (IMPERIAL_MAP_RANGE(gObj[aIndex].MapNumber) == TRUE) {
		...
		if (nCurrentZoneIndex >= 0) g_ImperialGuardian.CGEnterPortal(aIndex, nCurrentZoneIndex+1);
	}

	if (lpObj->m_IfState.use == 1 && lpObj->m_IfState.type == 6) return;
...
void GameProtocol::PROTOCOL_ReqMapMove(PMSG_REQ_MAPMOVE *lpMsg, int iIndex) {
	...
	if (g_KeyGenerater.CheckKeyValue(lpObj->CharacterData->m_dwMapMoveKeyValue, lpMsg->dwBlockKey) == FALSE) {
		pMsg.btResult = 12;
		IOCP.DataSend(iIndex, (LPBYTE)&pMsg, pMsg.h.size);
		return;
	}
	...
	if (lpObj->m_bMapSvrMoveReq == true || lpObj->m_bMapSvrMoveReq_2 == true || lpObj->m_bMapSvrMoveQuit == true || lpObj->m_State == 32) {
		g_Log.Add("[PROTOCOL_ReqMapMove] MapServerMove User. Can't Move. return!! [%s], IP [%s] ", lpObj->AccountID, lpObj->CharacterData->Ip_addr);
		return;
	}
...
void GameProtocol::PROTOCOL_SendMapMoveCheckSum(LPOBJ lpObj) {
	PMSG_MAPMOVE_CHECKSUM pMsg;

	pMsg.dwKeyValue = lpObj->CharacterData->m_dwMapMoveKeyValue;
	PHeadSubSetB((LPBYTE)&pMsg, 0x8E, 0x01, sizeof(pMsg));
	IOCP.DataSend(lpObj->m_Index, (LPBYTE)&pMsg, pMsg.h.size);
}
void GameProtocol::PROTOCOL_TargetTeleportRecv(PMSG_TARGET_TELEPORT * lpMsg, int aIndex) {
	if (!ObjectMaxRange(aIndex)) return;
	if (BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_ICE_ARROW) || BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_STUN) || BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_SLEEP) ||	BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_FREEZE) || BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_EARTHEN_PRISON)) return;
	...
	if (!gObjIsConnectedGP(iTargetIndex)) {
		g_Log.AddC(TColor::Red,  "[%s][%s] Try Target Teleport Not Move Area [%d,%d]", gObj[aIndex].AccountID, gObj[aIndex].Name, x, y);
		return;
	}

	if (IT_MAP_RANGE(gObj[iTargetIndex].MapNumber)) {
		if (g_IT_Event.CheckRelics(iTargetIndex)) return;
	}

	if (gObj[aIndex].PartyNumber != gObj[iTargetIndex].PartyNumber || gObj[aIndex].PartyNumber == -1 || gObj[iTargetIndex].PartyNumber == -1) return;
	...
	WORD MagicNumber = DW_TELEPORTALLY;
	...
	lpMagic = PLAYER_GetMagicSearch(&gObj[aIndex], DW_TELEPORTALLY);
	...
	if (lpMagic) {
		...
		if (usemana >= 0) {
			...
			if (usebp >= 0) {
				...
				MsgSendV2(&gObj[aIndex], (LPBYTE)&pAttack, pAttack.h.size);
				PLAYER_TeleportMagicUse(iTargetIndex, x, y);
				gObj[aIndex].Mana = usemana;
				gObj[aIndex].Stamina = usebp;
				PROTOCOL_ManaSend(gObj[aIndex].m_Index, gObj[aIndex].Mana, -1, 0, gObj[aIndex].Stamina);				
				return;
...
void GameProtocol::PROTOCOL_TeleportSend(LPOBJ lpObj, WORD MoveNumber, BYTE MapNumber, BYTE MapX, BYTE MapY, BYTE Dir) {
	...
	if (MoveNumber > 0) pMsg.Type = 256; // Warp
	else pMsg.Type = 0; // Teleportacja
...
void GameProtocol::PROTOCOL_CheckAttackRecv(unsigned char* lpRecv, int aIndex, int magic_send) {
	if (aIndex < 0 || aIndex > g_ConfigRead.server.GetObjectMax() - 1) return;
	...
	if (lpCount->Count > 5) lpCount->Count = 5;
	...
	if (gObj[aIndex].Type == OBJ_USER) {
		...
		if ((attr & 1) == 1) {	// Safezone
			CHARACTER_Immobilize(aIndex, gObj[aIndex].X, gObj[aIndex].Y);
			return;
		}
		...
		lpMagic = PLAYER_GetMagicSearch(&gObj[aIndex], MagicNumber);
	} else {
		WORD MagicNumber = MAKE_NUMBERW(lpCount->MagicNumberH, lpCount->MagicNumberL);

		lpMagic = PLAYER_GetMagic(&gObj[aIndex], MagicNumber);
	}
	...
	// Avoid use of the following Skill Indexes
	if (lpMagic->m_Skill == 42 || lpMagic->m_Skill == 43 || lpMagic->m_Skill == 41 || g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 336 || g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 331 || lpMagic->m_Skill == 333 || lpMagic->m_Skill == 339 || lpMagic->m_Skill == 342 || lpMagic->m_Skill == 332 || lpMagic->m_Skill == 330) return;
	if (gObj[aIndex].Type == OBJ_USER) {
		// Check if Player can use Magic
		// Acording to its Class
		if (MagicDamageC.MAGIC_GetRequireClass(gObj[aIndex].Class, gObj[aIndex].CharacterData->ChangeUP, lpMagic->m_Skill) < 1) {
			// It's not his magic [%s][%s] .
			g_Log.AddC(TColor::Red, "It is not his magic [%s][%s][%d]", gObj[aIndex].AccountID, gObj[aIndex].Name, lpMagic->m_Skill);
			gObjUserKill(aIndex);
			return;
		}
		...
		if ((GetTickCount() - gObj[aIndex].UseMagicTime) > 8000) {
			g_Log.AddC(TColor::Red, "Too long time passed after casting magic [%s][%s] (%d)(%d)", gObj[aIndex].AccountID, gObj[aIndex].Name, lpMagic->m_Skill, GetTickCount() - gObj[aIndex].UseMagicTime);
			return;
		}

		// Check if user cast to much Spells
		// Npo longer thant 4
		if (gObj[aIndex].UseMagicCount > 4) return;
	...
	if (g_MasterLevelSkillTreeSystem.CheckMasterLevelSkill(lpMagic->m_Skill)) {
		...
		if (iBaseMLS != 403 && iBaseMLS != 388 && iBaseMLS != 330 && iBaseMLS != 413 && iBaseMLS != 414 && iBaseMLS != 481 && iBaseMLS != 356 && iBaseMLS != 382 && iBaseMLS != 512 && iBaseMLS != 508 && iBaseMLS != 385 && iBaseMLS != 391 && iBaseMLS != 336
			&& iBaseMLS != 331 && iBaseMLS != 417 && iBaseMLS != 420 && iBaseMLS != 490 && iBaseMLS != 482 && iBaseMLS != 518 && iBaseMLS != 487 && iBaseMLS != 326 && iBaseMLS != 327 && iBaseMLS != 328 && iBaseMLS != 329 && iBaseMLS != 332 && iBaseMLS != 333
			&& iBaseMLS != 337 && iBaseMLS != 339 && iBaseMLS != 340 && iBaseMLS != 342 && iBaseMLS != 343 && iBaseMLS != 344 && iBaseMLS != 346 && iBaseMLS != 360 && iBaseMLS != 363 && iBaseMLS != 378 && iBaseMLS != 379 && iBaseMLS != 380 && iBaseMLS != 381
			&& iBaseMLS != 383 && iBaseMLS != 384 && iBaseMLS != 386 && iBaseMLS != 387 && iBaseMLS != 389 && iBaseMLS != 392 && iBaseMLS != 393 && iBaseMLS != 404 && iBaseMLS != 406 && iBaseMLS != 415 && iBaseMLS != 416 && iBaseMLS != 418 && iBaseMLS != 419
			&& iBaseMLS != 425 && iBaseMLS != 426 && iBaseMLS != 427 && iBaseMLS != 428 && iBaseMLS != 429 && iBaseMLS != 430 && iBaseMLS != 432 && iBaseMLS != 433 && iBaseMLS != 441 && iBaseMLS != 459 && iBaseMLS != 460 && iBaseMLS != 461 && iBaseMLS != 462
			&& iBaseMLS != 466 && iBaseMLS != 468 && iBaseMLS != 469 && iBaseMLS != 470 && iBaseMLS != 472 && iBaseMLS != 479 && iBaseMLS != 480 && iBaseMLS != 483 && iBaseMLS != 484 && iBaseMLS != 486 && iBaseMLS != 488 && iBaseMLS != 489 && iBaseMLS != 492
			&& iBaseMLS != 493 && iBaseMLS != 494 && iBaseMLS != 495 && iBaseMLS != 496 && iBaseMLS != 497 && iBaseMLS != 509 && iBaseMLS != 510 && iBaseMLS != 514 && iBaseMLS != 515 && iBaseMLS != 516 && iBaseMLS != 519 && iBaseMLS != 520 && iBaseMLS != 523
			&& iBaseMLS != 539 && iBaseMLS != 551 && iBaseMLS != 552 && iBaseMLS != 554 && iBaseMLS != 555 && iBaseMLS != 556 && iBaseMLS != 558 && iBaseMLS != 559 && iBaseMLS != 560 && iBaseMLS != 561 && iBaseMLS != 562 && iBaseMLS != 563 && iBaseMLS != 564
			&& iBaseMLS != 565 && iBaseMLS != 566 && iBaseMLS != 567 && iBaseMLS != 575 && iBaseMLS != 577 && iBaseMLS != 411 && iBaseMLS != 424 && iBaseMLS != 431 && iBaseMLS != 463 && iBaseMLS != 491 && iBaseMLS != 522 && iBaseMLS != 521 && iBaseMLS != 524
			&& iBaseMLS != 551 && iBaseMLS != 552 && iBaseMLS != 554 && iBaseMLS != 555 && iBaseMLS != 556 && iBaseMLS != 558 && iBaseMLS != 559 && iBaseMLS != 560 && iBaseMLS != 561 && iBaseMLS != 562 && iBaseMLS != 563 && iBaseMLS != 564 && iBaseMLS != 565
			&& iBaseMLS != 566 && iBaseMLS != 567 && iBaseMLS != 575 && iBaseMLS != 577) {
			g_Log.Add("error-L3 %s %d, Skill %d, BaseML %d", __FILE__, __LINE__, lpMagic->m_Skill, iBaseMLS);
			return;
		}
	} else {
		if (lpMagic->m_Skill != 8 && lpMagic->m_Skill != 9 && lpMagic->m_Skill != 10 && lpMagic->m_Skill != 13 && lpMagic->m_Skill != 14 && lpMagic->m_Skill != 5 && lpMagic->m_Skill != 24 && lpMagic->m_Skill != 50 && lpMagic->m_Skill != 12 && lpMagic->m_Skill != 41 && lpMagic->m_Skill != 47 && lpMagic->m_Skill != 43 && lpMagic->m_Skill != 42 && lpMagic->m_Skill != 52 && lpMagic->m_Skill != 55 && lpMagic->m_Skill != 78 && lpMagic->m_Skill != 277) {
			g_Log.Add("Magic Attack Error: Invalid Skill: %d (%s)(%d)", lpMagic->m_Skill, __FILE__, __LINE__);
			return;
		}
	}

	if (lpMagic->m_Skill == 24 || lpMagic->m_Skill == 78 || g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 414 || g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 518 || lpMagic->m_Skill == 418 || lpMagic->m_Skill == 520) {
		int NSAttackSerial = lpCount->Serial;

		if (gObj[aIndex].OSAttackSerial >= 255 && (gObj[aIndex].OSAttackSerial - lpCount->Serial) > 50) gObj[aIndex].OSAttackSerial = -1;
	...
	if (lpMagic->m_Skill == 9 || g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 385 || g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 487) {
		if (gObj[aIndex].Class != CLASS_WIZARD && gObj[aIndex].Class != CLASS_MAGICGLADIATOR && gObj[aIndex].Class != CLASS_SUMMONER) return;
	}
	...
	for (int i = 0; i<lpCount->Count; i++) {
		...
		if (i >= 1) {
			...
			if (gObj[pTargetNumber[i]].Type == OBJ_MONSTER && nTargetDistance > 10) g_Log.Add("User Hack Detected [%s][%s] Skill: %d, Monster Distance: %d, Cnt:%d", gObj[aIndex].AccountID, gObj[aIndex].Name, lpMagic->m_Skill, nTargetDistance, lpCount->Count);
		}
	}
	...
	for (int n = 0; n < lpCount->Count; n++) {
		...
		if (!lpMsg->MagicKey && (lpMagic->m_Skill == 9 || g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 385 || g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 487)) return;
		if (lpMsg->MagicKey && (lpMagic->m_Skill == 9 || g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 385 || g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 487)) {
			if (lpObj->DurMagicKeyChecker->IsValidDurationTime(lpMsg->MagicKey) == FALSE) {
				g_Log.AddC(TColor::Red, "Invalid DurationTime Key = %d (Time : %d) [%s][%s]", lpMsg->MagicKey, lpObj->DurMagicKeyChecker->GetValidDurationTime(lpMsg->MagicKey), lpObj->AccountID, lpObj->Name);
				lOfs += sizeof(PMSG_BEATTACK);
				continue;
			}

			if (lpObj->DurMagicKeyChecker->IsValidCount(lpMsg->MagicKey) == FALSE) {
				g_Log.AddC(TColor::Red, "Invalid ValidCount = %d (Count : %d) [%s][%s]", lpMsg->MagicKey, lpObj->DurMagicKeyChecker->GetValidCount(lpMsg->MagicKey), lpObj->AccountID, lpObj->Name);
				lOfs += sizeof(PMSG_BEATTACK);
				continue;
			}
		}

		if (gWriteSkillLog) g_Log.Add("Magic Attack3 : %d, serial = %d, Tgt =  %d, cnt = %d", lpMagic->m_Skill, lpCount->Serial, tNumber, lpCount->Count);
		if (ObjectMaxRange(tNumber) == false) continue;

		int DistanceCheck = CHARACTER_CalcDistance(lpObj, &gObj[tNumber]);
		...
		if (tNumber >= 0 && tNumber < g_ConfigRead.server.GetObjectMax() - 1) {
			if (lpMagic->m_Skill == 55) {
				gObjUseSkill.MG_FireSlash(aIndex, tNumber, lpMagic->m_Level);
				gObjAttack(&gObj[aIndex], &gObj[tNumber], lpMagic, TRUE, 1, 0, FALSE, 0, 0);
			} else if (lpMagic->m_Skill == 78) {
				gObjUseSkill.DL_FireScream(aIndex, tNumber, lpMagic);
			} else if (g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 490) {
				g_MasterLevelSkillTreeSystem.ML_MG_ImprovedFireSlash(aIndex, tNumber);
				gObjAttack(&gObj[aIndex], &gObj[tNumber], lpMagic, TRUE, 1, 0, FALSE, 0, 0);
			} else if (g_MasterLevelSkillTreeSystem.GetBaseMasterLevelSkill(lpMagic->m_Skill) == 493) {
				g_MasterLevelSkillTreeSystem.ML_MG_SearingSlash(aIndex, tNumber, lpMagic);
				gObjAttack(&gObj[aIndex], &gObj[tNumber], lpMagic, TRUE, 1, 0, FALSE, 0, 0);
			} else if (lpMagic->m_Skill == 518 || lpMagic->m_Skill == 520) g_MasterLevelSkillTreeSystem.ML_DL_ImprovedFireScream(aIndex, tNumber, lpMagic);
			else if (lpMagic->m_Skill == AT_SKILL_SHINING_PEAK) gObjUseSkill.SkillShiningPeak(aIndex, lpMagic, tNumber);
			else if (magic_send) gObjAttack(&gObj[aIndex], &gObj[tNumber], lpMagic, TRUE, 1, 0, FALSE, 0, 0);
			else gObjAttack(&gObj[aIndex], &gObj[tNumber], lpMagic, FALSE, 1, 0, FALSE, 0, 0);
		}

		lOfs += sizeof(PMSG_BEATTACK);
	}
}
void GameProtocol::PROTOCOL_DurationMagicRecv(LPBYTE lpRecv, int aIndex) {
	if (aIndex < 0 || aIndex > g_ConfigRead.server.GetObjectMax() - 1) return;
	...
	if (gObj[aIndex].Type == OBJ_USER) lpMagic = PLAYER_GetMagicSearch(lpObj, MagicNumber);
	else lpMagic = PLAYER_GetMagic(lpObj, MagicNumber);
	if (lpMagic == NULL) return;	
	if (lpObj->Type == OBJ_USER) {
		if (MagicDamageC.CheckStatus(lpMagic->m_Skill, lpObj->CharacterData->GuildStatus) == FALSE) {
			g_Log.AddC(TColor::Red,  "[0x1E] PROTOCOL_DurationMagicRecv() - Invalid Status");	// #warning maybe protocol here change
			return;
		}

		if (MagicDamageC.CheckKillCount(lpMagic->m_Skill, lpObj->m_btKillCount) < 0) {
			g_Log.AddC(TColor::Red,  "[0x1E] PROTOCOL_DurationMagicRecv() - Invalid KillCount");
			return;
		}
	...
	if (lpMagic->m_Skill != 24) {
		if (!gObjUseSkill.SpeedHackCheck(aIndex)) return;
	}

	if (!gObjUseSkill.EnableSkill(lpMagic->m_Skill)) return;
	...
	if (lpMsg->MagicKey) lpObj->DurMagicKeyChecker->SetDurationTime(lpMsg->MagicKey, GetTickCount());
}
void GameProtocol::PROTOCOL_UseItemRecv(PMSG_USEITEM* lpMsg, int aIndex) {
	int pos;
	CItem * citem;
	...
	if (gObj[aIndex].m_IfState.use && gObj[aIndex].m_IfState.type != 3)	{
		PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
		g_Log.Add("[%s][%s] PROTOCOL_UseItemRecv()_If return %s %d", gObj[aIndex].AccountID, gObj[aIndex].Name, __FILE__, __LINE__);
		return;
	}
	...
	if ((GetTickCount() - gObj[aIndex].CharacterData->PotionTime) < g_ConfigRead.data.common.PotionTime) {
		PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
		return;
	}

	gObj[aIndex].CharacterData->PotionTime = GetTickCount();

	// Check if User is exiting
	if (gObj[aIndex].CloseType != -1) {
		PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
		g_Log.Add("[%s][%s] PROTOCOL_UseItemRecv()_CloseType return %s %d", gObj[aIndex].AccountID, gObj[aIndex].Name, __FILE__, __LINE__);
		return;
	}
	...
	// Dupe
	if (gObj[aIndex].pTransaction == 1) {
		g_Log.Add("[%s][%s] PROTOCOL_UseItemRecv() Failed : Transaction == 1, IF_TYPE : %d", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].m_IfState.type);
		return;
	}
	...
	if (pos > MAIN_INVENTORY_SIZE - 1) {
		...
		PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
		g_Log.Add("[%s][%s] PROTOCOL_UseItemRecv()_Inventory return %s %d", gObj[aIndex].AccountID, gObj[aIndex].Name,	__FILE__, __LINE__);
		return;
	}
	...
	if (lpMsg->inventoryPos == lpMsg->invenrotyTarget) {
		PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
		g_Log.Add("error-L1 : [%s][%s] PROTOCOL_UseItemRecv()_Pos return %s %d", gObj[aIndex].AccountID, gObj[aIndex].Name, __FILE__, __LINE__);
		return;
	}
	...
	if (citem->IsItem()) {
		...
		if (gObjCheckSerial0ItemList(citem)) {
			MsgOutput(aIndex, Lang.GetText(0,259));
			PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
			g_Log.Add("[ANTI-HACK][Serial 0 Item] [UseItem] (%s)(%s) Item(%s) Pos(%d)", gObj[aIndex].AccountID, gObj[aIndex].Name, citem->GetName(), pos);
			return;
		}
		...
		if (citem->m_Type == ITEMGET(14, 0) || citem->m_Type == ITEMGET(14, 1) || citem->m_Type == ITEMGET(14, 2) || citem->m_Type == ITEMGET(14, 3)) {
			...
			switch (citem->m_Type) {
				case ITEMGET(14, 0):		nAddRate = 10;			break;
				case ITEMGET(14, 1):		nAddRate = 20;			break;
				case ITEMGET(14, 2):		nAddRate = 30;			break;
				case ITEMGET(14, 3):		nAddRate = 40;			break;
			}

			if (citem->m_Level == 1) nAddRate += 5;
			...
			if (gObj[aIndex].FillLife > 0.0f) {
				...
				PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFF, 0, gObj[aIndex].iShield);
			}

			gObj[aIndex].FillLifeMax = tLife;
			gObj[aIndex].FillLife = tLife;

			if (citem->m_Type == ITEMGET(14, 0) && citem->m_Level < 2) gObj[aIndex].FillLifeCount = 0;
			else if (citem->m_Level == 1) gObj[aIndex].FillLifeCount = 2;
			else gObj[aIndex].FillLifeCount = 3;

			if (!gObjSearchItemMinus(&gObj[aIndex], pos, 1)) {
				gObjInventoryItemSet(aIndex, pos, -1);
				gObj[aIndex].pInventory[pos].Clear();
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
			}
			...
			switch (citem->m_Type) {
				case ITEMGET(14, 4):			tMana += ((int)(gObj[aIndex].MaxMana + gObj[aIndex].AddMana)) * 20 / 100;				break;
				case ITEMGET(14, 5):			tMana += ((int)(gObj[aIndex].MaxMana + gObj[aIndex].AddMana)) * 30 / 100;				break;
				case ITEMGET(14, 6):			tMana += ((int)(gObj[aIndex].MaxMana + gObj[aIndex].AddMana)) * 40 / 100;				break;
			}

			gObj[aIndex].Mana += tMana;

			if (gObj[aIndex].Mana > (gObj[aIndex].MaxMana + gObj[aIndex].AddMana - 1.0f)) gObj[aIndex].Mana = gObj[aIndex].MaxMana + gObj[aIndex].AddMana;

			PROTOCOL_ManaSend(aIndex, gObj[aIndex].Mana, 0xFF, 0, gObj[aIndex].Stamina);
			...
			if (gObj[aIndex].iShield < 0) gObj[aIndex].iShield = 0;
			if (gObj[aIndex].FillLife > 0.0f) {
				gObj[aIndex].Life += gObj[aIndex].FillLife;

				if (gObj[aIndex].Life > (gObj[aIndex].MaxLife + gObj[aIndex].AddLife)) gObj[aIndex].Life = gObj[aIndex].MaxLife + gObj[aIndex].AddLife;
			}

			if (gObj[aIndex].iFillShield > 0) {
				gObj[aIndex].iShield += gObj[aIndex].iFillShield;

				if (gObj[aIndex].iShield > (gObj[aIndex].iMaxShield + gObj[aIndex].iAddShield)) gObj[aIndex].iShield = gObj[aIndex].iMaxShield + gObj[aIndex].iAddShield;
			}
			...
			PROTOCOL_SendEffectInfo(aIndex, 3);
			...
			g_Log.Add("[%s][%s]Use Compound Potion Lv1 - SD[%d] HP[%f] -> SD[%d] HP[%f]", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].iShield, gObj[aIndex].Life, gObj[aIndex].iShield + iShieldGage, (double)(gObj[aIndex].Life + (float)iHPGage));
			...
			g_Log.Add("[%s][%s]Use Compound Potion Lv2 - SD[%d] HP[%f] -> SD[%d] HP[%f]", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].iShield, gObj[aIndex].Life, gObj[aIndex].iShield + iShieldGage, (double)(gObj[aIndex].Life + (float)iHPGage));
			...
			g_Log.Add("[%s][%s]Use Compound Potion Lv3 - SD[%d] HP[%f] -> SD[%d] HP[%f]", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].iShield, gObj[aIndex].Life, gObj[aIndex].iShield + iShieldGage, (double)(gObj[aIndex].Life + (float)iHPGage));
			...
			if (BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_POISON) == TRUE) {
				BUFF_RemoveBuffEffect(&gObj[aIndex], DEBUFFTYPE_POISON);
				gObj[aIndex].lpAttackObj = 0;
				PROTOCOL_MagicCancelSend(&gObj[aIndex], 1);
			}

			if (BUFF_TargetHasBuff(&gObj[aIndex], DEBUFFTYPE_CHILL) == TRUE) {
				BUFF_RemoveBuffEffect(&gObj[aIndex], DEBUFFTYPE_CHILL);
				gObj[aIndex].DelayActionTime = 0;
				gObj[aIndex].DelayLevel = 0;
				gObj[aIndex].lpAttackObj = 0;
				PROTOCOL_MagicCancelSend(&gObj[aIndex], 7);
			}
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_HALLOWEEN_BLESS);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_HALLOWEEN_ANGER);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_HALLOWEEN_CRY);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_HALLOWEEN_FOOD);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_HALLOWEEN_DRINK);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_CHERRYBLOSSOM_DRINK);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_CHERRYBLOSSOM_DUMPLING);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_CHERRYBLOSSOM_PETAL);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_CHARM_GUARDIAN);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_CHARM_PROTECTITEM);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_SEAL_OF_ASCENSION);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_SEAL_OF_WEALTH);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_SEAL_OF_SUSTENANCE);
		} else if (g_kJewelOfHarmonySystem.IsJewelOfHarmonyPurity(citem->m_Type) == TRUE && g_SocketOptionSystem.IsSocketItem(&gObj[aIndex].pInventory[lpMsg->invenrotyTarget]) == FALSE) {
			if (g_kJewelOfHarmonySystem.StrengthenItemByJewelOfHarmony(&gObj[aIndex], lpMsg->inventoryPos, lpMsg->invenrotyTarget) == TRUE) {
				...
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
			} else PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
		...
		} else if (citem->m_Type == ITEMGET(14, 13)) {
			if (ITEM_JewelOfBlessLevelUp(&gObj[aIndex], lpMsg->inventoryPos, lpMsg->invenrotyTarget) == TRUE) {
				gObjInventoryItemSet(aIndex, pos, -1);
				gObj[aIndex].pInventory[pos].Clear();
				GCInventoryItemOneSend(aIndex, lpMsg->invenrotyTarget);
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
			...
			if (ITEM_JewelOfBlessPackLevelUp(&gObj[aIndex], lpMsg->inventoryPos, lpMsg->invenrotyTarget) == TRUE) {
				gObjInventoryItemSet(aIndex, pos, -1);
				gObj[aIndex].pInventory[pos].Clear();
				GCInventoryItemOneSend(aIndex, lpMsg->invenrotyTarget);
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
			}
		} else if (citem->m_Type == ITEMGET(14, 14)) {
			if (ITEM_JewelOfSoulLevelUp(&gObj[aIndex], lpMsg->inventoryPos, lpMsg->invenrotyTarget) == TRUE) {
				gObjInventoryItemSet(aIndex, pos, -1);
				gObj[aIndex].pInventory[pos].Clear();
				GCInventoryItemOneSend(aIndex, lpMsg->invenrotyTarget);
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
		...
		} else if (citem->m_Type == ITEMGET(14, 209)) {
			if (g_PentagramSystem.ITEM_SealOfTrading(&gObj[aIndex], lpMsg->inventoryPos, lpMsg->invenrotyTarget) == TRUE) {
				gObjInventoryItemSet(aIndex, pos, -1);
				gObj[aIndex].pInventory[pos].Clear();
				GCInventoryItemOneSend(aIndex, lpMsg->invenrotyTarget);
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_LIGHT_BLESSING);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_LIGHT_BLESSING_LOW);
			...
			BUFF_AddBuffEffect(&gObj[aIndex], BUFFTYPE_LIGHT_BLESSING_MIDDLE);
		} else if (citem->m_Type == ITEMGET(14, 16)) {
			if (ITEM_JewelOfLifeLevelUp(&gObj[aIndex], lpMsg->inventoryPos, lpMsg->invenrotyTarget) == TRUE) {
				gObjInventoryItemSet(aIndex, pos, -1);
				gObj[aIndex].pInventory[pos].Clear();
				GCInventoryItemOneSend(aIndex, lpMsg->invenrotyTarget);
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
			} else PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
		} else if (citem->m_Type >= ITEMGET(15, 0) || citem->m_Type == ITEMGET(12, 7) || (citem->m_Type >= ITEMGET(12, 8) && citem->m_Type <= ITEMGET(12, 24)) || citem->m_Type == ITEMGET(12, 35) || (citem->m_Type >= ITEMGET(12, 44) && citem->m_Type <= ITEMGET(12, 48)) || (citem->m_Type >= ITEMGET(12,271) && citem->m_Type <= ITEMGET(12, 277))) {
			if ((gObj[aIndex].CharacterData->Strength + gObj[aIndex].AddStrength) < citem->m_RequireStrength) {
				PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
				return;
			}

			if ((gObj[aIndex].CharacterData->Dexterity + gObj[aIndex].AddDexterity) < citem->m_RequireDexterity) {
				PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
				return;
			}
			...
			if (citem->IsClass(gObj[aIndex].Class, gObj[aIndex].CharacterData->ChangeUP) == FALSE) PROTOCOL_InventoryItemDeleteSend(aIndex, -1, 1);
			else {
				int addskill = MAGIC_MagicAdd(&gObj[aIndex], ITEM_GET_TYPE(citem->m_Type), ITEM_GET_INDEX(citem->m_Type), citem->m_Level, skillnumber);
				...
				if (addskill >= 0) {
					...
					gObj[aIndex].pInventory[pos].Clear();
					PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
				} else PROTOCOL_InventoryItemDeleteSend(aIndex, -1, 1);
			}
		} else if (citem->m_Type == ITEMGET(14, 10)) {	// Town Portal Scroll
			if (g_ConfigRead.server.GetServerType() == SERVER_BATTLECORE) {
				g_Log.Add("[UBF][Return Scroll] [%s][%s][%s] - No Available", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->m_RealNameOfUBF);
				return;
			}

			g_Log.Add("[Using Item] [Return Scroll] [%s][%s] - Current Map:[%d]", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].MapNumber);

			if (BC_MAP_RANGE(gObj[aIndex].MapNumber)) {
				int iBridgeIndex = g_BloodCastle.GetBridgeIndex(gObj[aIndex].MapNumber);

				if (g_BloodCastle.GetCurrentState(iBridgeIndex) == 2) g_BloodCastle.SearchUserDropQuestItem(aIndex);
				else g_BloodCastle.SearchUserDeleteQuestItem(aIndex);
			}

			if (IT_MAP_RANGE(gObj[aIndex].MapNumber)) g_IT_Event.DropRelicsItem(gObj[aIndex].MapNumber, aIndex);
			if (gObj[aIndex].m_IfState.use && gObj[aIndex].m_IfState.type == 3) {
			...
			if (gObj[aIndex].MapNumber == MAP_INDEX_DEVIAS) gObjMoveGate(aIndex, 22);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_NORIA) gObjMoveGate(aIndex, 27);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_ELBELAND) gObjMoveGate(aIndex, 267);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_LOSTTOWER) gObjMoveGate(aIndex, 42);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_ATHLANSE) gObjMoveGate(aIndex, 49);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_TARKAN) gObjMoveGate(aIndex, 57);
			else if (BC_MAP_RANGE(gObj[aIndex].MapNumber) != FALSE) gObjMoveGate(aIndex, 22);
			else if (CC_MAP_RANGE(gObj[aIndex].MapNumber) != FALSE) gObjMoveGate(aIndex, 22);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_CHAOSCASTLE_SURVIVAL) gObjMoveGate(aIndex, 333);
			else if (KALIMA_MAP_RANGE(gObj[aIndex].MapNumber) != FALSE) gObjMoveGate(aIndex, 22);
			else if (IT_MAP_RANGE(gObj[aIndex].MapNumber) != FALSE) gObjMoveGate(aIndex, 267);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_AIDA) gObjMoveGate(aIndex, 27);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_CRYWOLF_FIRSTZONE) gObjMoveGate(aIndex, 27);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_BARRACKS) gObjMoveGate(aIndex, 114);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_REFUGEE) gObjMoveGate(aIndex, 114);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_CALMNESS) gObjMoveGate(aIndex, 273);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_RAKLION || gObj[aIndex].MapNumber == MAP_INDEX_HATCHERY) gObjMoveGate(aIndex, 287);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_SANTAVILLAGE) gObjMoveGate(aIndex, 22);
			else if (DG_MAP_RANGE(gObj[aIndex].MapNumber) != FALSE) gObjMoveGate(aIndex, 267);
			else if (IMPERIAL_MAP_RANGE(gObj[aIndex].MapNumber) != FALSE) gObjMoveGate(aIndex, 22);
			else if (gObj[aIndex].MapNumber == MAP_INDEX_LORENMARKET) gObjMoveGate(aIndex, 333);
			else if (g_ConfigRead.server.GetServerType() == SERVER_CASTLE && gObj[aIndex].MapNumber == MAP_INDEX_CASTLESIEGE) {
				if (g_CastleSiege.GetCastleState() == CASTLESIEGE_STATE_STARTSIEGE) {
					if (gObj[aIndex].m_btCsJoinSide == 1) gObjMoveGate(aIndex, 101);
					else gObjMoveGate(aIndex, 100);
				} else {
					if (g_CastleSiege.CheckCastleOwnerMember(aIndex) == TRUE || g_CastleSiege.CheckCastleOwnerUnionMember(aIndex) == TRUE) gObjMoveGate(aIndex, 101);
					else gObjMoveGate(aIndex, 100);
				}
			} else if (g_NewPVP.IsVulcanusMap(gObj[aIndex].MapNumber)) gObjMoveGate(aIndex, 294);
			...
			if (DG_MAP_RANGE(gObj[aIndex].MapNumber) == TRUE) {
				...
				if (g_DoppelGanger.GetDoppelgangerState() == 2) g_DoppelGanger.SendDoppelgangerResult(&gObj[aIndex], 1);
			}
			...
			if (gObj[aIndex].CharacterData->m_InventoryExpansion < 2) {
				gObjInventoryItemSet(aIndex, pos, -1);
				gObj[aIndex].pInventory[pos].Clear();
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
				gObj[aIndex].CharacterData->m_InventoryExpansion++;
				GDSetExpWare(aIndex, 1, gObj[aIndex].CharacterData->m_InventoryExpansion);
			...
			if (gObj[aIndex].CharacterData->m_WarehouseExpansion < 1) {
				gObjInventoryItemSet(aIndex, pos, -1);
				gObj[aIndex].pInventory[pos].Clear();
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
				GDSetExpWare(aIndex, 2, 1);
				gObj[aIndex].CharacterData->m_WarehouseExpansion = 1;
			...
			if (g_MasterLevelSkillTreeSystem.CheckMasterSkillPoint(aIndex, 1) == TRUE) {
				...
				gObj[aIndex].pInventory[pos].Clear();
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
			} else this->GCServerMsgStringSend(Lang.GetText(0,526), aIndex, 1);
			...
			gObj[aIndex].pInventory[pos].Clear();
			PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
			PLAYER_UseDrink(&gObj[aIndex], level);
		} else if (citem->m_Type == ITEMGET(14,20))	{	// Remedy of Love
			if (citem->m_Level == 0) {
				gObjInventoryItemSet(aIndex, pos, -1);
				gObj[aIndex].pInventory[pos].Clear();
				PROTOCOL_InventoryItemDeleteSend(aIndex, pos, 1);
				PLAYER_UseDrink(&gObj[aIndex], 2);
			}
		} else if (citem->m_Type == ITEMGET(13,15))	{	// Fruits
			if (iItemUseType == 0) gObjUsePlusStatFruit(aIndex, pos);
			else if (iItemUseType == 1) gObjUseMinusStatFruit(aIndex, pos);
		...
		} else if (citem->m_Type >= ITEMGET(13,54) && citem->m_Type <= ITEMGET(13,58)) CashShopExMinusStatFruit(aIndex, pos);
			...
			if (gObj[aIndex].Life > (gObj[aIndex].MaxLife+gObj[aIndex].AddLife - 1.0f)) gObj[aIndex].Life = gObj[aIndex].MaxLife+gObj[aIndex].AddLife;
			...
			if (gObj[aIndex].iShield < fSD) gObj[aIndex].iShield = fSD;

			PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFF, 1, gObj[aIndex].iShield);
			...
			if (gObj[aIndex].m_PK_Level == 6) gObj[aIndex].m_PK_Level = 5;
				else if (gObj[aIndex].m_PK_Level == 5) gObj[aIndex].m_PK_Level = 4;
				else if (gObj[aIndex].m_PK_Level == 4) gObj[aIndex].m_PK_Level = 3;
				else if (gObj[aIndex].m_PK_Level <= 3) gObj[aIndex].m_PK_Level = gObj[aIndex].m_PK_Level;
			...
			if (gObj[aIndex].CharacterData->lpGuild) g_Log.Add("[CastleSiege] Using CastleSiege Potion Lv[%d]/Si[%d]/Dur[%d] - [%s][%s] - (Guild : %s)", iLevel, iSerial, iDur, gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->lpGuild->Name);
			else g_Log.Add("[CastleSiege] Using CastleSiege Potion Lv[%d]/Si[%d]/Dur[%d] - [%s][%s]", iLevel, iSerial, iDur, gObj[aIndex].AccountID, gObj[aIndex].Name);
			if (iLevel == 0) gObjUseBlessAndSoulPotion(aIndex, iLevel);
			else if (iLevel == 1) gObjUseBlessAndSoulPotion(aIndex, iLevel);
			...
			if ((gObj[aIndex].MapNumber < MAP_INDEX_KALIMA1 || gObj[aIndex].MapNumber > MAP_INDEX_KALIMA6) && gObj[aIndex].MapNumber != MAP_INDEX_KALIMA7) {
				...
				} else g_Log.Add("[PCS] Use Free Kalima Ticket Failed");
			}
			...
			if (!L) g_Log.Add("[QuestExp] - Error - [%s] [%d]", __FILE__, __LINE__);
			else {
				if (Ep) {
			...
			g_Log.Add("error-L3 : %s return %s %d %d %s", gObj[aIndex].Name, __FILE__,__LINE__, pos, gObj[aIndex].pInventory[pos].GetName());
			PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
		}
	} else {
		PROTOCOL_ReFillSend(aIndex, gObj[aIndex].Life, 0xFD, 1, gObj[aIndex].iShield);
		g_Log.Add("error-L3 : %s return %s %d %d", gObj[aIndex].Name, __FILE__,__LINE__, pos);
	}
}
...
void GameProtocol::PROTOCOL_ReFillSend(int aIndex, int Life, BYTE Ipos, unsigned char flag, WORD wShield) {
	PMSG_REFILL pMsg;
...
void GameProtocol::PROTOCOL_ManaSend(int aIndex, int Mana, BYTE Ipos, unsigned char flag, WORD Stamina) {
	if (aIndex < 0 || aIndex > g_ConfigRead.server.GetObjectMax() - 1) {
		g_Log.Add("PROTOCOL_ManaSend() return %s %d", __FILE__, __LINE__);
		return;
	}
	...
	pMsg.BPH = SET_NUMBERH(Stamina);
	pMsg.BPL = SET_NUMBERL(Stamina);
	pMsg.IGCMana = Mana;
	IOCP.DataSend(aIndex, (UCHAR*)&pMsg, pMsg.h.size);
}
...
void GameProtocol::PROTOCOL_InventoryItemDeleteSend(int aIndex, BYTE pos, unsigned char flag) {
...
void GameProtocol::GCReqmoveDevilSquare(PMSG_REQ_MOVEDEVILSQUARE* lpMsg, int aIndex)
{
	...
	if (g_DevilSquare.DS_GetObjCount(cSquareNumber) >= g_DevilSquare.GetMaxUserInSquare())
	{
		pResult.Result = 5;
		IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
	...
	if (sitem->m_Type == ITEMGET(14,19) || (sitem->m_Type == ITEMGET(13,46) && sitem->m_Durability == 1.0f))
	{
		...
		PROTOCOL_InventoryItemDeleteSend(aIndex, cInvitationItemPos, 1);
		IOCP.DataSend(aIndex, (LPBYTE)&pResult, pResult.h.size);
	}
	...
	lpObj->m_bDevilSquareIndex = g_DevilSquare.DS_GetSquareIndex(movegateindex);
	...
	g_DevilSquare.DS_IncObjCount(cSquareNumber);
}
...
void GameProtocol::CGRequestQuestInfo(int aIndex)
{
	...
	if (lpObj->CharacterData->m_SendQuestInfo != 0)
		return;
	...
	memcpy(pMsg.State, lpObj->CharacterData->m_Quest, sizeof(pMsg.State));
	int i;
	...
	lpObj->CharacterData->m_SendQuestInfo = true;
}
...
void GameProtocol::CGRequestEnterBloodCastle(PMSG_REQ_MOVEBLOODCASTLE* lpMsg, int iIndex)
{
	...
	if (gObj[iIndex].pInventory[btInvisibleCourtItemPos].IsItem() == TRUE)
	{
		...
		{
			for (int i=0;i<MAX_CLOAK_LEVEL;i++)
			{
		...
		gObj[iIndex].pInventory[btInvisibleCourtItemPos].m_Durability == 1.0f))
	{
		...
		PROTOCOL_InventoryItemDeleteSend(iIndex, btInvisibleCourtItemPos, 1);
		IOCP.DataSend(iIndex, (LPBYTE)&pResult, pResult.h.size);
	}
...
void GameProtocol::PROTOCOL_ChaosCastleEntry(PMSG_REQ_MOVECHAOSCASTLE* lpMsg, int iIndex) {
	if (!ObjectMaxRange(iIndex)) {
		g_Log.Add("return %s %d", __FILE__, __LINE__);
		return;
	}
	...
	if (gObj[iIndex].Type != OBJ_USER || gObj[iIndex].Connected <= PLAYER_LOGGED) return;
	if (BC_MAP_RANGE(gObj[iIndex].MapNumber) || CC_MAP_RANGE(gObj[iIndex].MapNumber) || DS_MAP_RANGE(gObj[iIndex].MapNumber) || IT_MAP_RANGE(gObj[iIndex].MapNumber) || DG_MAP_RANGE(gObj[iIndex].MapNumber) || IMPERIAL_MAP_RANGE(gObj[iIndex].MapNumber) || gObj[iIndex].MapNumber == MAP_INDEX_CHAOSCASTLE_SURVIVAL || g_ConfigRead.server.GetServerType() == SERVER_ARCA || g_ConfigRead.server.GetServerType() == SERVER_MARKET) {
		PMSG_NOTICE pNotice;
	...
	if (gObj[iIndex].m_IfState.use && gObj[iIndex].m_IfState.type != 12) return;
	if (gObj[iIndex].CharacterData->m_bUsePartyMatching) {
	...
	if (g_ConfigRead.pk.bPkPenaltyDisable == FALSE) {
		...
		if (gObj[iIndex].PartyNumber >= 0) {
			if (gParty.GetPKPartyPenalty(gObj[iIndex].PartyNumber) >= 6) bPlayerKiller = TRUE;
		} else if (gObj[iIndex].m_PK_Level >= 6) bPlayerKiller = TRUE;
	...
	if (gObj[iIndex].CharacterData->lpGuild) {
		if (gObj[iIndex].CharacterData->lpGuild->WarState == 1) {
			PMSG_NOTICE pNotice;
	...
	// Mounts
	if (gObj[iIndex].pInventory[gObj[iIndex].m_btInvenPetPos].m_Type == ITEMGET(13,3) || gObj[iIndex].pInventory[gObj[iIndex].m_btInvenPetPos].m_Type == ITEMGET(13,2) ||  gObj[iIndex].pInventory[gObj[iIndex].m_btInvenPetPos].m_Type == ITEMGET(13,37)) {
		PMSG_NOTICE pNotice;
	...
	if (gObj[iIndex].PartyNumber >= 0) {
		if (gParty.GetPKPartyPenalty(gObj[iIndex].PartyNumber) >= 5) bPlayerKiller = TRUE;
	} else if (gObj[iIndex].m_PK_Level >= 4) bPlayerKiller = TRUE;
	...
	if (g_ChaosCastle.CC_CheckTransformationRing(iIndex) == TRUE) {
	...
	PROTOCOL_InventoryItemDeleteSend(iIndex, btGuardMailSetItemPos, 1);
	IOCP.DataSend(iIndex, (LPBYTE)&pResult, pResult.h.size);
	...
	if (gObj[iIndex].m_bPShopOpen == true) g_PersonalStore.CGPShopReqClose(iIndex);
	if (gObj[iIndex].PartyNumber >= 0) {
	...
	switch (iENTER_LEVEL + 1) {
		case 1:			gObjMoveGate(iIndex, 82);			break;
		case 2:			gObjMoveGate(iIndex, 83);			break;
		case 3:			gObjMoveGate(iIndex, 84);			break;
		case 4:			gObjMoveGate(iIndex, 85);			break;
		case 5:			gObjMoveGate(iIndex, 86);			break;
		case 6:			gObjMoveGate(iIndex, 87);			break;
		case 7:			gObjMoveGate(iIndex, 272);			break;
	}

	g_Log.Add("[Chaos Castle] (%d) (Account:%s, Name:%s) Entered Chaos Castle (Guard Mail Set Serial:%I64d)", iENTER_LEVEL+1, gObj[iIndex].AccountID, gObj[iIndex].Name, dwITEM_SERIAL);
}
...
void GameProtocol::CGRequestLottoRegister(PMSG_REQ_2ANV_LOTTO_EVENT* lpMsg, int aIndex) {
	...
	if (gObj[aIndex].UseEventServer) return;
	...
	wsDataCli.DataSend((PCHAR)&pMsg, sizeof(pMsg));
	g_Log.Add("[Mu_2Anv_Event] [%s][%s] Register Lotto Number (Serial: %s-%s-%s)", gObj[aIndex].AccountID, gObj[aIndex].Name, pMsg.SERIAL1, pMsg.SERIAL2, pMsg.SERIAL3);
}
...
void GameProtocol::CGReqMoveOtherServer(PMSG_REQ_MOVE_OTHERSERVER * lpMsg, int aIndex) {
	if (!gEnableServerDivision) return;
	if (!gObjIsConnectedGP(aIndex)) {
		g_Log.AddC(TColor::Red,  "error-L3 [%s][%d]", __FILE__, __LINE__);
		return;
	}
	...
	if (lpObj->m_MoveOtherServer) return;
	...
	if (!gObjPasswordCheck(aIndex, lpMsg->LastJoominNumber)) {
		...
		g_Log.Add("[CharTrasfer] Fail (JoominNumber) [%s][%s]", lpObj->AccountID, lpObj->Name);
	...
	g_Log.Add("[CharTrasfer] Request Character Trasfer [%s][%s]", lpObj->AccountID, lpObj->Name);
}
...
void GameProtocol::GCSendGetItemInfoForParty(int aIndex, CMapItem * lpItem) {
	...
	if (lpObj->PartyNumber >= 0) {
		...
		if (lpItem->m_Option1) pMsg.ItemInfo |= 0x2000;
		if (lpItem->m_Option2) pMsg.ItemInfo |= 0x4000;
		if (lpItem->m_Option3) pMsg.ItemInfo |= 0x8000;
		if (lpItem->m_NewOption) pMsg.ItemInfo |= 0x10000;
		if (lpItem->m_SetOption) pMsg.ItemInfo |= 0x20000;
		if (g_kItemSystemFor380.Is380OptionItem((lpItem != NULL) ? (CItem*) &lpItem->m_Number : NULL)) pMsg.ItemInfo |= 0x40000;
		...
		if (partycount >= 0) {
			for (int n = 0; n < MAX_USER_IN_PARTY; n++) {
				...
				if (number >= 0) IOCP.DataSend(number, (LPBYTE)&pMsg, pMsg.h.size);
			}
		}
	}
}
...
void GameProtocol::PROTOCOL_SendEffectInfo(int aIndex, BYTE btType) {
	if (ObjectMaxRange(aIndex) == FALSE) return;
	...
	if (btType == 17) IOCP.DataSend(aIndex, (LPBYTE)&pMsg, pMsg.h.size);
...
void GameProtocol::CGGuildAssignStatus(PMSG_GUILD_ASSIGN_STATUS_REQ * aRecv, int aIndex)
{
	...
	if (lpObj->CharacterData->GuildNumber <= 0 || lpObj->CharacterData->lpGuild == NULL)
	{
	...
	if (gObj[aIndex].CharacterData->GuildStatus != G_MASTER)
	{
	...
	if (aRecv->btType == 1 || aRecv->btType == 2)
	{
		...
		for (int n=0;n<MAX_USER_GUILD;n++)
		{
			if (lpObj->CharacterData->lpGuild->Use[n] > 0)
			{
				if (lpObj->CharacterData->lpGuild->GuildStatus[n] == G_SUB_MASTER)
				{
					iSubMasterCount++;
				}
				else if (lpObj->CharacterData->lpGuild->GuildStatus[n] == G_BATTLE_MASTER)
				{
					iBattleMasterCount++;
				}
			}
		...
		{
			if (iBattleMasterCount < (((lpObj->Level+lpObj->CharacterData->MasterLevel) / 200) +1))
			{
				GDGuildReqAssignStatus(aIndex, aRecv->btType, aRecv->szTagetName, aRecv->btGuildStatus);
				return;
			}
...
void GameProtocol::CGRelationShipReqJoinBreakOff(PMSG_RELATIONSHIP_JOIN_BREAKOFF_REQ * aRecv, int aIndex)
{
	...
	if (!gObj[aIndex].CharacterData->lpGuild || !gObj[iTargetUserIndex].CharacterData->lpGuild)
	{
		GCResultSend(aIndex, 0x51, 5);
		return;
	}

	if (gObj[aIndex].CharacterData->GuildStatus != G_MASTER && gObj[iTargetUserIndex].CharacterData->GuildStatus != G_MASTER)
	{
	...
	if (lpObj->CharacterData->GuildStatus != G_MASTER || lpTargetObj->CharacterData->GuildStatus != G_MASTER)
	{
	...
	_GUILD_INFO_STRUCT * lpGuildInfo = gObj[aIndex].CharacterData->lpGuild;
	_GUILD_INFO_STRUCT * lpTargetGuildInfo = gObj[iTargetUserIndex].CharacterData->lpGuild;
...
void GameProtocol::CGUnionList(PMSG_UNIONLIST_REQ * aRecv, int aIndex)
{
	...
	GDUnionListSend(aIndex, lpObj->CharacterData->lpGuild->iGuildUnion);
...
void GameProtocol::CGRelationShipReqKickOutUnionMember(PMSG_KICKOUT_UNIONMEMBER_REQ* aRecv, int aIndex)
{
	...
	if (lpObj->CharacterData->GuildStatus != GUILD_MASTER || lpObj->CharacterData->lpGuild->Number != lpObj->CharacterData->lpGuild->iGuildUnion)
	{
		ErrMsg.btResult = GUILD_ANS_NOTEXIST_PERMISSION;
		IOCP.DataSend(aIndex, (LPBYTE)&ErrMsg, ErrMsg.h.size);
	...
	if (!strcmp(lpObj->CharacterData->lpGuild->Name, szUnionMemberGuildName))
	{
		ErrMsg.btResult = GUILD_ANS_NOTEXIST_PERMISSION;
		IOCP.DataSend(aIndex, (LPBYTE)&ErrMsg, ErrMsg.h.size);
...
/*
	...
	if (gObj[iIndex].LoginMsgSnd != 0)
	{
		...
		{
			g_Log.Add("error: It is after authentication information is sended [%d][%s][%s]", iIndex, id, gObj[iIndex].CharacterData->Ip_addr);
		}
		else
		{
	...
	gObj[iIndex].CharacterData->VipType = 0;
	gObj[iIndex].CharacterData->VipEffect = VIP_EFFECT_NONE;
	gObj[iIndex].CharacterData->AntiHackCheckTime = GetTickCount();
	gObj[iIndex].CharacterData->dwLastHitHackTick = GetTickCount64();
...
void GameProtocol::CGReqRegCastleSiege(PMSG_REQ_REGCASTLESIEGE * lpMsg, int iIndex) 
{
	...
	if (strcmp(gObj[iIndex].CharacterData->GuildName, "") == 0)
	{
...
void GameProtocol::GCAnsRegCastleSiege(int iIndex, int iResult, LPSTR lpszGuildName) 
{
	...
	{
		g_Log.Add("[CastleSiege] [%s][%s] Registered Castle Siege (GUILD:%s) - Result:%d",	gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, iResult);
	}
}
...
void GameProtocol::GCAnsGiveUpCastleSiege(int iIndex, int iResult, int bGiveUp, int iMarkCount, LPSTR lpszGuildName)
{
	...
	{
		gObj[iIndex].CharacterData->Money += (iMarkCount*3000);

		if (gObj[iIndex].CharacterData->Money > MAX_ZEN) 
		{
			gObj[iIndex].CharacterData->Money = MAX_ZEN;
		}
		GCMoneySend(iIndex, gObj[iIndex].CharacterData->Money);
	}
	...
	if (gObjIsConnected(iIndex))
	{
		g_Log.Add("[CastleSiege] [%s][%s] GiveUp Castle Siege (GUILD:%s) - Result:%d", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, iResult);
	}
}
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				PROTOCOL_InventoryItemDeleteSend(iIndex,lpMsgResult->iItemPos,1);
			}
...
void GameProtocol::CGReqNpcBuy(PMSG_REQ_NPCBUY * lpMsg, int iIndex) 
{
	...
	if (g_CastleSiege.CheckGuildOwnCastle(gObj[iIndex].CharacterData->GuildName) == FALSE || (gObj[iIndex].CharacterData->GuildStatus != G_MASTER && gObj[iIndex].CharacterData->GuildStatus != G_SUB_MASTER))
	{
		g_Log.AddC(TColor::Red, "[CastleSiege] CGReqNpcBuy() ERROR - Authority Fail [%s][%s], Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)",	gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus,lpMsg->iNpcNumber,lpMsg->iNpcIndex);
	}
	else
	{
		BYTE btResult = 0;

		BOOL bRETVAL = g_CastleSiege.CS_CheckAddDbNPC(iIndex, lpMsg->iNpcNumber, lpMsg->iNpcIndex, btResult);

		if (bRETVAL == FALSE)
		{
			GCAnsNpcBuy(iIndex, btResult, lpMsg->iNpcNumber, lpMsg->iNpcIndex);
			g_Log.AddC(TColor::Red, "[CastleSiege] CGReqNpcBuy() ERROR - CCastleSiege::CS_CheckAddDbNPC() [%s][%s], Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus,lpMsg->iNpcNumber,lpMsg->iNpcIndex);
		}
		else
		{
			g_Log.AddC(TColor::Red, "[CastleSiege] CGReqNpcBuy() OK - [%s][%s], Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus,lpMsg->iNpcNumber,lpMsg->iNpcIndex);
		}
	}
}
...
void GameProtocol::CGReqNpcRepair(PMSG_REQ_NPCREPAIR * lpMsg, int iIndex) 
{
	...
	if ((g_CastleSiege.CheckGuildOwnCastle(gObj[iIndex].CharacterData->GuildName) == FALSE) || (gObj[iIndex].CharacterData->GuildStatus != G_MASTER) && (gObj[iIndex].CharacterData->GuildStatus != G_SUB_MASTER))
	{
		g_Log.AddC(TColor::Red, "[CastleSiege] CGReqNpcRepair() ERROR - Authority Fail [%s][%s], Guild:(%s)(%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus);
		return;
	}
	...
	if (bRETVAL == FALSE)
	{
		...
		g_Log.AddC(TColor::Red, "[CastleSiege] CGReqNpcRepair() ERROR - CL Request Fail [%s][%s], Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)",	gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus, lpMsg->iNpcNumber,lpMsg->iNpcIndex);
		return;
	}
	else
	{
		...
		{
			GCAnsNpcRepair(iIndex, 0, lpMsg->iNpcNumber, lpMsg->iNpcIndex, 0, 0);
			g_Log.AddC(TColor::Red, "[CastleSiege] CGReqNpcRepair() ERROR - Npc Alive Data Mismatch [%s][%s], Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus, pNpcData.m_iNPC_NUM, pNpcData.m_iNPC_INDEX);
			return;
		}
		...
		else
		{
			...
			else
			{
				...
				if (gObj[iIndex].CharacterData->Money < iRepairCost)
				{
					GCAnsNpcRepair(iIndex, 3, lpMsg->iNpcNumber, lpMsg->iNpcIndex, 0, 0);
					g_Log.AddC(TColor::Red, "[CastleSiege] CGReqNpcRepair() ERROR - Money isn't enough [%s][%s], Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus, pNpcData.m_iNPC_NUM, pNpcData.m_iNPC_INDEX);
					return;
				}
				else
				{
					g_Log.AddC(TColor::Red, "[CastleSiege] CGReqNpcRepair() OK - [%s][%s], Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus, pNpcData.m_iNPC_NUM, pNpcData.m_iNPC_INDEX);	
...
void GameProtocol::CGReqNpcUpgrade(PMSG_REQ_NPCUPGRADE * lpMsg, int iIndex) {
	...
	if (strcmp(gObj[iIndex].CharacterData->GuildName, "") == 0) return;
	if ((g_CastleSiege.CheckGuildOwnCastle(gObj[iIndex].CharacterData->GuildName) == FALSE) || (gObj[iIndex].CharacterData->GuildStatus != G_MASTER && gObj[iIndex].CharacterData->GuildStatus != G_SUB_MASTER)) {
		g_Log.Add("[CastleSiege] CGReqNpcUpgrade() ERROR - Authority Fail [%s][%s], Guild:(%s)(%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus);
		return;
	}
			...
			if (bResult) {
				switch (lpMsg->iNpcUpType) {
					...
					case 3:
						...
						for (int i = 0; i < 3; i++) {
							if (m_NpcData.m_iNPC_MAXHP >= *g_iNpcUpMaxHP_CGATE[i]) iCUR_UPLVL = (i+1);
						}

						iNXT_UPLVL = 0;

						for (int i = 0; i < 3; i++) {
							if (lpMsg->iNpcUpValue >= *g_iNpcUpMaxHP_CGATE[i]) iNXT_UPLVL = (i+1);
						}
			...
			if (bResult) {
				switch (lpMsg->iNpcUpType) {
					...
					case 3:
						...
						for (int i = 0; i < 3; i++) {
							if (m_NpcData.m_iNPC_MAXHP >= *g_iNpcUpMaxHP_CSTATUE[i]) iCUR_UPLVL = (i + 1);
						}

						iNXT_UPLVL = 0;

						for (int i = 0; i < 3; i++) {
							if (lpMsg->iNpcUpValue >= *g_iNpcUpMaxHP_CSTATUE[i]) iNXT_UPLVL = (i + 1);
						}
					...
					default:
						GCAnsNpcUpgrade(iIndex, 5, lpMsg->iNpcNumber, lpMsg->iNpcIndex, lpMsg->iNpcUpType, lpMsg->iNpcUpValue);
						g_Log.Add("[CastleSiege] CGReqNpcUpgrade() ERROR - UpType doesn't Exist [%s][%s], Guild:(%s)(%d), NPC CLS:%d, IDX:%d, UPTYPE:%d, UPVAL:%d", gObj[iIndex].AccountID,gObj[iIndex].Name,gObj[iIndex].CharacterData->GuildName,gObj[iIndex].CharacterData->GuildNumber,lpMsg->iNpcNumber,lpMsg->iNpcIndex,lpMsg->iNpcUpType,lpMsg->iNpcUpValue);
						return;
					break;
				}
			} else {
	...
	if (bENABLE_UPGRADE == FALSE) GCAnsNpcUpgrade(iIndex, 6, lpMsg->iNpcNumber, lpMsg->iNpcIndex, lpMsg->iNpcUpType, lpMsg->iNpcUpValue);
	else {
		if (gObj[iIndex].CharacterData->Money < iNEED_MONEY) {
			GCAnsNpcUpgrade(iIndex, 3, lpMsg->iNpcNumber, lpMsg->iNpcIndex, lpMsg->iNpcUpType, lpMsg->iNpcUpValue);
			g_Log.Add("[CastleSiege] CGReqNpcUpgrade() ERROR - Money is Low [%s][%s], Guild:(%s)(%d), NPC CLS:%d, IDX:%d, UPTYPE:%d, UPVAL:%d, NXTLV:%d, Money:%d, Need Money:%d", gObj[iIndex].AccountID,gObj[iIndex].Name,gObj[iIndex].CharacterData->GuildName,gObj[iIndex].CharacterData->GuildNumber,lpMsg->iNpcNumber,lpMsg->iNpcIndex,lpMsg->iNpcUpType,lpMsg->iNpcUpValue,iNXT_UPLVL,gObj[iIndex].CharacterData->Money,iNEED_MONEY);
		} else {
			for (iGEMOFDEFEND_COUNT = 0, x = 0; x < INVENTORY_SIZE; x++) {
				if (gObj[iIndex].pInventory[x].IsItem() == TRUE) {
					if (gObj[iIndex].pInventory[x].m_Type == ITEMGET(14,31)) iGEMOFDEFEND_COUNT += 1;
				}
			}
			...
			if (iGEMOFDEFEND_COUNT < iNEED_GEMOFDEFEND) {
				...
				g_Log.Add("[CastleSiege] CGReqNpcUpgrade() ERROR - Gem is Low [%s][%s], Guild:(%s)(%d), NPC CLS:%d, IDX:%d, UPTYPE:%d, UPVAL:%d, NXTLV:%d, Gem:%d, Need Gem:%d",	gObj[iIndex].AccountID,gObj[iIndex].Name,gObj[iIndex].CharacterData->GuildName,gObj[iIndex].CharacterData->GuildNumber,lpMsg->iNpcNumber,lpMsg->iNpcIndex,lpMsg->iNpcUpType,lpMsg->iNpcUpValue,iNXT_UPLVL,iGEMOFDEFEND_COUNT,iNEED_GEMOFDEFEND);
			} else {
				bRETVAL = g_CastleSiege.CS_PayForUpgradeDbNpc(iIndex,lpMsg->iNpcNumber,lpMsg->iNpcIndex,lpMsg->iNpcUpType,lpMsg->iNpcUpValue,(iNXT_UPLVL - 1));
				...
				if (bRETVAL != FALSE) {
					...
					g_Log.Add("[CastleSiege] CGReqNpcUpgrade() REQ OK - [%s][%s], Guild:(%s)(%d), NPC CLS:%d, IDX:%d, UPTYPE:%d, UPVAL:%d, NXTLV:%d", gObj[iIndex].AccountID,gObj[iIndex].Name,gObj[iIndex].CharacterData->GuildName,gObj[iIndex].CharacterData->GuildNumber,lpMsg->iNpcNumber,lpMsg->iNpcIndex,lpMsg->iNpcUpType,lpMsg->iNpcUpValue,iNXT_UPLVL);
				}	
			}
		}
...
void GameProtocol::CGReqTaxMoneyInfo(PMSG_REQ_TAXMONEYINFO * lpMsg, int iIndex) 
{
	...
	if ((g_CastleSiege.CheckGuildOwnCastle(gObj[iIndex].CharacterData->GuildName) == FALSE) || (gObj[iIndex].CharacterData->GuildStatus != G_MASTER))
	{
		g_Log.AddC(TColor::Red, "[CastleSiege] CGReqTaxMoneyInfo() ERROR - Authority Fail [%s][%s], Guild:(%s)(%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus);
	}
	else
	{
		GS_GDReqTaxInfo(g_MapServerManager.GetMapSvrGroup(), iIndex);
		g_Log.Add("[CastleSiege] CGReqTaxMoneyInfo() REQ OK - [%s][%s], Guild:(%s)(%d)",	gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus);
	}
}
...
void GameProtocol::CGReqTaxRateChange(PMSG_REQ_TAXRATECHANGE * lpMsg, int iIndex) 
{
	...
	if ((g_CastleSiege.CheckGuildOwnCastle(gObj[iIndex].CharacterData->GuildName) == FALSE) || (gObj[iIndex].CharacterData->GuildStatus != G_MASTER))
	{
		g_Log.AddC(TColor::Red, "[CastleSiege] CGReqTaxRateChange() ERROR - Authority Fail [%s][%s], Guild:(%s)(%d)",	gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus);
	}
	else
	{
		iMaxTaxRate = 0;
		...
		if ((iTaxRate < 0) || (iTaxRate > iMaxTaxRate))
		{
			...
			g_Log.Add("[CastleSiege] CGReqTaxRateChange() ERROR - Tax Rate Out of Range [%s][%s], Guild:(%s)(%d), TaxType:%d, TaxRate:%d", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus, lpMsg->btTaxType, iTaxRate);
		}
		else
		{
			GS_GDReqTaxRateChange(g_MapServerManager.GetMapSvrGroup(), iIndex, lpMsg->btTaxType, iTaxRate);
			g_Log.Add("[CastleSiege] CGReqTaxRateChange() REQ OK - [%s][%s], Guild:(%s)(%d), TaxType:%d, TaxRate:%d", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus, lpMsg->btTaxType, iTaxRate);
		}
	}
}
...
void GameProtocol::CGReqMoneyDrawOut(PMSG_REQ_MONEYDRAWOUT * lpMsg, int iIndex) 
{
	...
	if ((g_CastleSiege.CheckGuildOwnCastle(gObj[iIndex].CharacterData->GuildName) == FALSE) || (gObj[iIndex].CharacterData->GuildStatus != G_MASTER))
	{
		g_Log.AddC(TColor::Red, "[CastleSiege] CGReqMoneyDrawOut() ERROR - Authority Fail [%s][%s], Guild:(%s)(%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus);
	}
	else
	{
		...
		if (iMoneyChange <= 0)
		{
			...
			g_Log.Add("[CastleSiege] CGReqMoneyDrawOut() ERROR - Req Money < 0 [%s][%s], Guild:(%s)(%d), Money:%d, TotMoney:%d",	gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus, iMoneyChange, gObj[iIndex].CharacterData->Money);
		}
		else
		{
			...
			{
				GCAnsMoneyDrawOut(iIndex, 0, 0);
				g_Log.Add("[CastleSiege] CGReqMoneyDrawOut() ERROR - Castle Money is Low [%s][%s], Guild:(%s)(%d), Money:%d, TotMoney:%d", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus, iMoneyChange, gObj[iIndex].CharacterData->Money);
			}
			else
			{
				if ((gObj[iIndex].CharacterData->Money + iMoneyChange) > MAX_ZEN)
				{
					GCAnsMoneyDrawOut(iIndex, 0, 0);
				}
				else
				{
					...
					g_Log.Add("[CastleSiege] CGReqMoneyDrawOut() REQ OK - [%s][%s], Guild:(%s)(%d), Money:%d, TotMoney:%d", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus, iMoneyChange, gObj[iIndex].CharacterData->Money);
				}
			}
		}
	}
...
void GameProtocol::CGReqCsGateOperate(PMSG_REQ_CSGATEOPERATE * lpMsg, int iIndex) 
{
	...
	if (g_CastleSiege.GetCastleState() == CASTLESIEGE_STATE_STARTSIEGE)
	{
		...
		{
			g_Log.Add("[CastleSiege] CGReqCsGateOperate() ERROR - Authority Fail [%s][%s], Guild:(%s)(%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus);
			return;
		}
	}
	else
	...
	if (g_CastleSiege.CheckCsGateAlive(iGateIndex) == TRUE) 
	{
		...
		if (iOperateGate == 0)
		{
			...
			g_Log.Add("[CastleSiege] CGReqCsGateOperate() ERROR - Operate Gate Failed [%s][%s], Guild:(%s)(%d)",	gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus);	
		}
		else
		{
			GCAnsCsGateOperate(iIndex, 1, iGateIndex, lpMsg->btOperate);
			g_CastleSiege.SendCsGateStateViewPort(iGateIndex, lpMsg->btOperate);
			g_Log.Add("[CastleSiege] CGReqCsGateOperate() OK - [%s][%s], Guild:(%s)(%d), DOOR:(%d)(X:%d,Y:%d)(STATUE:%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildNumber,iGateIndex, gObj[iGateIndex].X, gObj[iGateIndex].Y, gObj[iGateIndex].m_btCsGateOpen);
		}
	}
	else
	{
		GCAnsCsGateOperate(iIndex, 2, -1, 0);
		g_Log.Add("[CastleSiege] CGReqCsGateOperate() ERROR - Gate Doesn't Exist [%s][%s], Guild:(%s)(%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus);	
	}
}
...
void GameProtocol::GCAnsCsAccessCrownState(int iIndex, BYTE btCrownState) 
{
	...
	if (btCrownState == 0)
	{
		...
		g_Log.Add("[CastleSiege] [Reg. Attempt] Accumulated Crown AccessTime : %d [%s](%s)(%s)",	gObj[iIndex].m_iAccumulatedCrownAccessTime,gObj[iIndex].CharacterData->GuildName,gObj[iIndex].AccountID,gObj[iIndex].Name);
	}

	if (btCrownState == 1)
	{
		g_Log.Add("[CastleSiege] [Reg. Success] Accumulated Crown AccessTime : %d [%s](%s)(%s)",	gObj[iIndex].m_iAccumulatedCrownAccessTime,gObj[iIndex].CharacterData->GuildName,gObj[iIndex].AccountID,gObj[iIndex].Name);
		gObj[iIndex].m_iAccumulatedCrownAccessTime = 0;
	}
	...
	if (btCrownState == 2)
	{
		...
		g_Log.Add("[CastleSiege] [Reg. Fail] Accumulated Crown AccessTime : %d [%s](%s)(%s)", gObj[iIndex].m_iAccumulatedCrownAccessTime, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].AccountID, gObj[iIndex].Name);
	}
...
void GameProtocol::PROTOCOL_GetCastleNpcData(PMSG_REQ_NPCDBLIST* lpMsg, int iIndex) {
	PMSG_ANS_NPCDBLIST pResult;

	if (lpMsg == NULL) return;
	if (strcmp(gObj[iIndex].CharacterData->GuildName, "") == FALSE) return;	
	if (g_CastleSiege.CheckGuildOwnCastle(gObj[iIndex].CharacterData->GuildName) == FALSE || ((gObj[iIndex].CharacterData->GuildStatus != 128) && (gObj[iIndex].CharacterData->GuildStatus != 64))) {
		g_Log.AddC(TColor::Red, "[CastleSiege] PROTOCOL_GetCastleNpcData() ERROR - Authority Fail [%s][%s], Guild:(%s)(%d)", gObj[iIndex].AccountID, gObj[iIndex].Name, gObj[iIndex].CharacterData->GuildName, gObj[iIndex].CharacterData->GuildStatus);
...
void GameProtocol::PROTOCOL_LandOfTrialsEntry(PMSG_REQ_MOVE_TO_CASTLE_HUNTZONE * aRecv, int iIndex) {
	if (!ObjectMaxRange(iIndex)) return;
	...
	if (iEnterTaxMoney < 0) iEnterTaxMoney = 0;

	BOOL bPermission = FALSE;

	if (g_CastleSiege.GetHuntZoneEnter()) bPermission = TRUE;
	if (lpObj->CharacterData->lpGuild) {
		if (g_CastleSiege.CheckCastleOwnerMember(lpObj->m_Index)) bPermission = TRUE;
		if (g_CastleSiege.CheckCastleOwnerUnionMember(lpObj->m_Index)) bPermission = TRUE;
	} else {
		if (g_CastleSiege.GetHuntZoneEnter()) bPermission = TRUE;
	}

	if (bPermission == TRUE) {
		if (lpObj->CharacterData->Money >= iEnterTaxMoney) {
			if (lpObj->MapNumber == MAP_INDEX_CASTLESIEGE) {
				if (gObjMoveGate(lpObj->m_Index, 95) == TRUE) {
					pMsg.btResult = 1;

					int iOldMoney = lpObj->CharacterData->Money;

					lpObj->CharacterData->Money -= iEnterTaxMoney;
					g_CastleSiegeSync.AddTributeMoney(iEnterTaxMoney);
					
					if (lpObj->CharacterData->Money < 0) lpObj->CharacterData->Money = 0;
					
					GCMoneySend(lpObj->m_Index, lpObj->CharacterData->Money);
					g_Log.Add("[Castle HuntZone] [%s][%s] - Entrance TAX : %d - %d = %d", lpObj->AccountID, lpObj->Name, iOldMoney, iEnterTaxMoney, lpObj->CharacterData->Money);
				}
			}
		}
	}
...
void GameProtocol::PROTOCOL_CheckJewelPack(PMSG_REQ_JEWEL_MIX * lpMsg, int iIndex) {
	if (lpMsg == NULL) return;
...
void GameProtocol::PROTOCOL_JewelPack(int iIndex, int iResult) {
...
void GameProtocol::PROTOCOL_CheckJewelUnpack(PMSG_REQ_JEWEL_UNMIX * lpMsg, int iIndex) {
	if (lpMsg == NULL) return;
...
void GameProtocol::PROTOCOL_JewelUnpack(int iIndex, int iResult) {
	PMSG_ANS_JEWEL_UNMIX pMsg;
...
void GameProtocol::CGReqCrywolfInfo(PMSG_REQ_CRYWOLF_INFO* lpMsg, int iIndex)
{
	...
	{
		GCAnsCrywolfInfo(iIndex, g_CrywolfSync.CW_OccupationState(), g_CrywolfSync.GetCrywolfState());
	}
}
...
void GameProtocol::PROTOCOL_CrywolfBenefitChaosSuccessRate(PMSG_REQ_CRYWOLF_BENEFIT_PLUS_CHAOSRATE* lpMsg, int iIndex) {
	if (ObjectMaxRange(iIndex) == FALSE) return;
...
void GameProtocol::GCMasterLevelUpMsgSend(int aIndex) {
	...
	pMsg.MasterLevel = gObj[aIndex].CharacterData->MasterLevel;
	pMsg.MLPoint = gObj[aIndex].CharacterData->MasterPoint;
	...
	pMsg.IGCMaxMana = gObj[aIndex].MaxMana + gObj[aIndex].AddMana;
	IOCP.DataSend(aIndex, (LPBYTE)&pMsg, pMsg.h.size);
	PROTOCOL_SendEffectInfo(aIndex, 16);
}
	...
	for (int i=INVENTORY_BAG_START;i<MAIN_INVENTORY_SIZE;++i)
	{
		if (lpObj->pInventory[i].IsItem() == TRUE && lpObj->pInventory[i].m_Type == ITEMGET(14,100))
		{
			...
			else
			{
				...
				PROTOCOL_InventoryItemDeleteSend(aIndex, i, 1);
			}
			if (Count == 0)
				break;
		}
...
void GameProtocol::CGReqMuBotUse(int aIndex, PMSG_MUBOT_SWITCH *aRecv)
{
	...
	LPOBJ lpObj = &gObj[aIndex];
	DWORD Money = (lpObj->Level+lpObj->CharacterData->MasterLevel) * g_ConfigRead.data.mubot.cost;
	...
	if (lpObj->CharacterData->Money < Money)
	{
	...
	if (lpObj->CharacterData->VipType < g_ConfigRead.data.mubot.viplevel)
	{
	...
	if (lpObj->CharacterData->VipType == 0 && g_ConfigRead.data.mubot.viplevel > 0)
	{
	...
	if (aRecv->Status == 0)
	{
		...
		lpObj->CharacterData->m_MuBotTotalTime = 0;
		lpObj->CharacterData->m_MuBotTick = GetTickCount();
		lpObj->CharacterData->m_MuBotEnable = true;
	...
	else
	{
		lpObj->CharacterData->m_MuBotPayTime = 0;
		lpObj->CharacterData->m_MuBotTotalTime = 0;
		lpObj->CharacterData->m_MuBotTick = 0;
...
void GameProtocol::GCSendObjectHP(int aIndex, int aTargetIndex)
{
	...
	pMsg.m_bIceEffect = BUFF_TargetHasBuff(&gObj[aTargetIndex], DEBUFFTYPE_CHILL);
	pMsg.m_bPoisonEffect = BUFF_TargetHasBuff(&gObj[aTargetIndex], DEBUFFTYPE_POISON);

	IOCP.DataSend(aIndex, (LPBYTE)&pMsg, pMsg.h.size);
	this->MsgSendV2(&gObj[aTargetIndex], (LPBYTE)&pMsg, pMsg.h.size);
}

void GameProtocol::PROTOCOL_CheckSpeedHack(int aIndex, PMSG_SEND_AH_INFO *aRecv) {
	if (!ObjectMaxRange(aIndex)) return;
	if (!gObjIsConnected(aIndex)) return;
	if (gObj[aIndex].Type != OBJ_USER) return;
	if (gObj[aIndex].Connected != PLAYER_PLAYING) return;
	if (gObj[aIndex].CharacterData->LivePacketTime == 0 || g_ConfigRead.antihack.EnablePacketTimeCheck == FALSE) gObj[aIndex].CharacterData->LivePacketTime = GetTickCount();
	else {
		DWORD tick = GetTickCount() -  gObj[aIndex].CharacterData->LivePacketTime;

		if (tick < g_ConfigRead.antihack.PacketTimeMinTime) {
			g_Log.AddC(TColor::Red, "[ANTI-HACK] (%s)(%s)(%s) (Map:%d)(X:%d)(Y:%d) SpeedHack detected -> Tick (Current:%d/Minimum:%d)", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr, gObj[aIndex].MapNumber, gObj[aIndex].X, gObj[aIndex].Y, tick, g_ConfigRead.antihack.PacketTimeMinTime);
			AntiHackLog->Output("[ANTI-HACK] (%s)(%s)(%s) (Map:%d)(X:%d)(Y:%d) SpeedHack detected -> Tick (Current:%d/Minimum:%d)", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr, gObj[aIndex].MapNumber, gObj[aIndex].X, gObj[aIndex].Y, tick, g_ConfigRead.antihack.PacketTimeMinTime);
			gObj[aIndex].CharacterData->LiveCheckDetectCount++;

			if (gObj[aIndex].CharacterData->LiveCheckDetectCount >= 3) {

				if (g_ConfigRead.antihack.EnableHackDetectMessage == TRUE) MsgOutput(aIndex, (char *)g_ConfigRead.antihack.HackDetectMessage.c_str());
				if (g_ConfigRead.antihack.EnableAutoBanUserAccount == TRUE) GDReqBanUser(aIndex, 1, 1);
				
				this->GCSendDisableReconnect(aIndex);
				//IOCP.CloseClient(aIndex);
				return;
			}
		} else gObj[aIndex].CharacterData->LivePacketTime = GetTickCount();
	}
	...
	if (gObj[aIndex].CharacterData->BlessSkillCast == true) {
		gObj[aIndex].AgiCheckTime = GetTickCount();
		return;
	}

	WORD Agility = gObj[aIndex].CharacterData->Dexterity + gObj[aIndex].AddDexterity;
	int AgilityDiff = (gObj[aIndex].CharacterData->Dexterity + gObj[aIndex].AddDexterity) - aRecv->Agi;

	if (aRecv->type == 1) {
		if (AgilityDiff <= -30 || AgilityDiff >= 30) {
			g_Log.AddC(TColor::Red,  "[ANTI-HACK] (%s)(%s)(%s) Dexterity check error: %d/%d", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr, Agility, aRecv->Agi);
			AntiHackLog->Output("[ANTI-HACK] (%s)(%s)(%s) Dexterity check error: %d/%d", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr, Agility, aRecv->Agi);
			...
			this->GCSendDisableReconnect(aIndex);
			//IOCP.CloseClient(aIndex);
		} else gObj[aIndex].AgiCheckTime = GetTickCount();
	} else {
		g_Log.AddC(TColor::Red,  "[ANTI-HACK] (%s)(%s)(%s) Cheat detected: %s", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr, aRecv->Agi == 0 ? "SpeedHack" : "Proxy");
		AntiHackLog->Output("[ANTI-HACK] (%s)(%s)(%s) Cheat detected: %s", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].CharacterData->Ip_addr, aRecv->Agi == 0 ? "SpeedHack" : "Proxy");
...
void GameProtocol::PROTOCOL_CheckCRC(int aIndex, PMSG_REQ_CRCDATA *aRecv) {
	if (!ObjectMaxRange(aIndex)) return;
	...
	if (aRecv->MainExe == g_ConfigRead.antihack.MainCRC && aRecv->IGCDLL == g_ConfigRead.antihack.DLLCRC && aRecv->PlayerBMD == g_ConfigRead.antihack.PlayerCRC && aRecv->SkillCRC == g_ConfigRead.antihack.SkillCRC) lpObj->CrcCheckTime = 0;
	else {
		g_Log.Add("[ANTI-HACK] (%s)(%s)(%s) Invalid Game-Client files (Recv/Valid) (Main:%X/%X) (IGC:%X/%X) (Player:%X/%X) (SkillCRC: %X/%X) (AntiHackCRC: %X/%X)", lpObj->AccountID, lpObj->Name, lpObj->CharacterData->Ip_addr, aRecv->MainExe, g_ConfigRead.antihack.MainCRC, aRecv->IGCDLL, g_ConfigRead.antihack.DLLCRC, aRecv->PlayerBMD, g_ConfigRead.antihack.PlayerCRC, aRecv->SkillCRC, g_ConfigRead.antihack.SkillCRC, aRecv->AntiHackCRC, g_ConfigRead.antihack.AntiHackCRC);
		AntiHackLog->Output("[ANTI-HACK] (%s)(%s)(%s) Invalid Game-Client files (Recv/Valid) (Main:%X/%X) (IGC:%X/%X) (Player:%X/%X) (SkillCRC: %X/%X) (AntiHackCRC: %X/%X)", lpObj->AccountID, lpObj->Name, lpObj->CharacterData->Ip_addr, aRecv->MainExe, g_ConfigRead.antihack.MainCRC, aRecv->IGCDLL, g_ConfigRead.antihack.DLLCRC, aRecv->PlayerBMD, g_ConfigRead.antihack.PlayerCRC,  aRecv->SkillCRC, g_ConfigRead.antihack.SkillCRC, aRecv->AntiHackCRC, g_ConfigRead.antihack.AntiHackCRC);
...
void GameProtocol::PROTOCOL_ElementalDamageSend(int aIndex, int TargetIndex, int Damage, int Elemental) {
...
void GameProtocol::PROTOCOL_AcheronEntry(int aIndex) {
	if (!ObjectMaxRange(aIndex)) return;
	if (gObj[aIndex].Type != OBJ_USER) return;

	int iTargetNumber = gObj[aIndex].TargetNumber;

	if (iTargetNumber == -1) return;
	if (gObj[iTargetNumber].Class != 580) return;
	...
	g_Log.AddC(TColor::Blue, "[%s][%s] Entered to Acheron Map (Spirit Map serial: %I64d)", gObj[aIndex].AccountID, gObj[aIndex].Name, gObj[aIndex].pInventory[pos].m_Number);
...
void GameProtocol::CGReqRegGensMember(_tagPMSG_REQ_REG_GENS_MEMBER *lpMsg, int iIndex)
{
	...
	_GUILD_INFO_STRUCT *lpGuildInfo = gObj[iIndex].CharacterData->lpGuild;
...
void GameProtocol::CGReqSecedeGensMember(_tagPMSG_REQ_SEGEDE_GENS_MEMBER *lpMsg, int iIndex)
{
	...
	if (gObjIsConnectedGP(iIndex))
	{
		...
		else if (lpObj->CharacterData->GuildStatus == GUILD_MASTER)
		{
		...
		else if (lpObj->CharacterData->m_bUsePartyMatching)
		{
			pMsg.bResult = 4; bRet = 0;
		}
...
void GameProtocol::CGReqGensReward(_tagPMSG_GENS_REWARD_CODE *lpMsg, int iIndex) {
	...
	if (gObjIsConnectedGP(iIndex)) g_GensSystem.ReqExDBGensRewardCheck(lpObj, lpMsg->bReward);
}
...
void GameProtocol::CGInventoryEquipment(_tagPMSG_REQ_INVENTORY_EQUIPMENT_ITEM *lpMsg, int iIndex) {
	if (ObjectMaxRange(iIndex) == FALSE) return;
	if (gObj[iIndex].Type != OBJ_USER) return;
	...
	if (!IsInvenPet(lpObj->pInventory[lpMsg->btItemPos].m_Type) && lpObj->pInventory[lpMsg->btItemPos].m_Durability == 0.0) {
		pMsg.btResult = -1;
		IOCP.DataSend(iIndex, (LPBYTE)&pMsg, pMsg.h.size);
		return;
	}
	...
	switch (lpObj->pInventory[lpMsg->btItemPos].m_Type) {
		case ITEMGET(13, 128):
		case ITEMGET(13, 129):
			if (lpObj->CharacterData->m_btSculptPos == 0) {
				if (lpMsg->btValue == (BYTE)-2 && lpObj->pInventory[lpMsg->btItemPos].m_Durability == 255.0) {
					lpObj->CharacterData->m_btSculptPos = lpMsg->btItemPos;
			...
			if (lpObj->CharacterData->m_btSculptPos < INVETORY_WEAR_SIZE || lpObj->CharacterData->m_btSculptPos >= MAIN_INVENTORY_SIZE) goto DEF_SWITCH;
			if (lpMsg->btValue == (BYTE)-1 && lpObj->CharacterData->m_btSculptPos == lpMsg->btItemPos) {
		...
		case ITEMGET(13, 132):
		case ITEMGET(13, 133):
			if (lpObj->CharacterData->m_btCharmPos == 0) {
				if (lpMsg->btValue == (BYTE)-2 && lpObj->pInventory[lpMsg->btItemPos].m_Durability == 255.0) {
					lpObj->CharacterData->m_btCharmPos = lpMsg->btItemPos;
					lpObj->pInventory[lpMsg->btItemPos].m_Durability = 254.0;
					pMsg.btResult = -2;
				}
			...
			if (lpObj->CharacterData->m_btCharmPos < INVETORY_WEAR_SIZE || lpObj->CharacterData->m_btCharmPos >= MAIN_INVENTORY_SIZE) goto DEF_SWITCH;
			if (lpMsg->btValue == (BYTE)-1 && lpObj->CharacterData->m_btCharmPos == lpMsg->btItemPos) {
				if (lpObj->pInventory[lpMsg->btItemPos].m_Durability == 254.0) {
					lpObj->pInventory[lpMsg->btItemPos].m_Durability = 255.0;
					pMsg.btResult = -1;
				}
		...
		case ITEMGET(13, 134):
			if (lpObj->CharacterData->m_btArtifactPos == 0) {
				if (lpMsg->btValue == (BYTE)-2 && lpObj->pInventory[lpMsg->btItemPos].m_Durability == 255.0) {
					lpObj->CharacterData->m_btArtifactPos = lpMsg->btItemPos;
					lpObj->pInventory[lpMsg->btItemPos].m_Durability = 254.0;
					pMsg.btResult = -2;
				}
			...
			if (lpObj->CharacterData->m_btArtifactPos < INVETORY_WEAR_SIZE || lpObj->CharacterData->m_btArtifactPos >= MAIN_INVENTORY_SIZE) goto DEF_SWITCH;
			if (lpMsg->btValue == (BYTE)-1 && lpObj->CharacterData->m_btArtifactPos == lpMsg->btItemPos) {
				if (lpObj->pInventory[lpMsg->btItemPos].m_Durability == 254.0) {
					lpObj->pInventory[lpMsg->btItemPos].m_Durability = 255.0;
					pMsg.btResult = -1;
				}
		...
		case ITEMGET(13,178):
		case ITEMGET(13,179):
			if (lpObj->CharacterData->m_btExpUpCharmPos == 0) {
				if (lpMsg->btValue == (BYTE)-2 && lpObj->pInventory[lpMsg->btItemPos].m_Durability == 255.0) {
					lpObj->CharacterData->m_btExpUpCharmPos = lpMsg->btItemPos;
					lpObj->pInventory[lpMsg->btItemPos].m_Durability = 254.0;
					pMsg.btResult = -2;
				}
			...
			if (lpObj->CharacterData->m_btExpUpCharmPos < INVETORY_WEAR_SIZE || lpObj->CharacterData->m_btExpUpCharmPos >= MAIN_INVENTORY_SIZE) goto DEF_SWITCH;
			if (lpMsg->btValue == (BYTE)-1 && lpObj->CharacterData->m_btExpUpCharmPos == lpMsg->btItemPos) {
				if (lpObj->pInventory[lpMsg->btItemPos].m_Durability == 254.0) {
					lpObj->pInventory[lpMsg->btItemPos].m_Durability = 255.0;
					pMsg.btResult = -1;
				}
			...
			if (lpObj->m_btInvenPetPos != 0) {
				if (lpObj->m_btInvenPetPos >= INVETORY_WEAR_SIZE && lpObj->m_btInvenPetPos < MAIN_INVENTORY_SIZE) {
					...
					if (gObjUseInvenPetCheck(lpObj, &lpObj->pInventory[lpMsg->btItemPos], 0) == FALSE) {
						g_Log.Add("[CRenewal][InvenPet][ReqTakeOffPet][%s][%s] PetIndex:[%d],Pos:[%d], Map:[%d] [Fail] Cannot Take Off InvenPet.", lpObj->AccountID, lpObj->Name, lpObj->pInventory[lpMsg->btItemPos].m_Type, lpMsg->btItemPos, lpObj->MapNumber);
						this->GCServerMsgStringSend(Lang.GetText(0,616), iIndex, 1);
						return;
					}

					if (lpObj->pInventory[lpMsg->btItemPos].m_JewelOfHarmonyOption == 1) {
						g_Log.Add("[CRenewal][InvenPet][ReqTakeOffPet][%s][%s] PetIndex:[%d],Pos:[%d], Map:[%d] [Success] Take Off InvenPet.", lpObj->AccountID, lpObj->Name, lpObj->pInventory[lpMsg->btItemPos].m_Type, lpMsg->btItemPos, lpObj->MapNumber);
				...
				if (lpObj->m_wInvenPet != (WORD) - 1 || lpObj->pInventory[lpMsg->btItemPos].m_JewelOfHarmonyOption == 1) {
					g_Log.Add("[CRenewal][InvenPet][ReqRidePet][%s][%s] [Fail] Already Ride InvenPet", lpObj->AccountID, lpObj->Name);
					this->GCServerMsgStringSend(Lang.GetText(0,615), iIndex, 1);
					return;
				}

				if (gObjUseInvenPetCheck(lpObj, &lpObj->pInventory[lpMsg->btItemPos], 1) == FALSE) {
					g_Log.Add("[CRenewal][InvenPet][ReqRidePet][%s][%s] Map:[%d] [Fail] Cannot Ride InvenPet", lpObj->AccountID, lpObj->Name, lpObj->MapNumber);
				...
				g_Log.Add("[CRenewal][InvenPet][ReqRidePet][%s][%s] PetIndex:[%d], Pos:[%d], Map:[%d]  [Success] Ride InvenPet", lpObj->AccountID, lpObj->Name, lpObj->pInventory[lpMsg->btItemPos].m_Type, lpMsg->btItemPos, lpObj->MapNumber);
			}
		...
		default:
DEF_SWITCH:
			gObjCalCharacter.CHARACTER_Calc(iIndex);
			IOCP.DataSend(iIndex, (LPBYTE)&pMsg, pMsg.h.size);
		break;
	}
}
...
void GameProtocol::CGReqUseTransformationRing(PMSG_REQ_USETRANSFORMATIONRING * lpMsg, int aIndex)
{
	...
	if (lpMsg->btState == 1)
	{
		...
		{
			gObj[aIndex].CharacterData->m_EnableUseChangeSkin = 0;
		}
	}

	else
	{
		gObj[aIndex].CharacterData->m_EnableUseChangeSkin = 1;
	}
	...
	PROTOCOL_MoveProc(&pMove, aIndex);
	gObjViewportListProtocolCreate(&gObj[aIndex]);
}

void GameProtocol::PROTOCOL_AttackSpeedSend(int aIndex) {
	PMSG_ATTACKSPEEDSEND pMsg;

	PHeadSubSetB((LPBYTE)&pMsg, 0xEC, 0x30, sizeof(pMsg));
	pMsg.AttackSpeed = gObj[aIndex].AttackSpeed;
	pMsg.MagicSpeed = gObj[aIndex].MagicSpeed;
	IOCP.DataSend(aIndex, (LPBYTE)&pMsg, pMsg.h.size);
}
...
void GameProtocol::CGReqArcaBattleGuildMasterJoin(_tagPMSG_REQ_ARCA_BATTLE_JOIN *lpMsg, int iIndex)
{
	...
	_GUILD_INFO_STRUCT * lpGuildInfo = lpObj->CharacterData->lpGuild;
	...
	g_ArcaBattle.GDReqArcaBattleIsTopRank(lpObj->m_Index, lpObj->CharacterData->GuildNumber);
}
...
void GameProtocol::CGReqAcheronEnter(_tagPMSG_REQ_ACHERON_ENTER *lpMsg, int iIndex)
{
	...
	for (int pos = INVETORY_WEAR_SIZE; pos < MAIN_INVENTORY_SIZE; pos++)
	{
		if (lpObj->pInventory[pos].IsItem() && lpObj->pInventory[pos].m_Type == ITEMGET(13, 146))
		{
			...
			this->PROTOCOL_InventoryItemDeleteSend(iIndex, pos, 1);
	...
	if (ObjectMaxRange(aIndex))
	{
		...
		if (gObjIsConnected(aIndex))
		{
			...
			if (lpObj->CharacterData->lpGuild)
			{
				...
				pMsg.h.subcode = 0x45;
				pMsg.iIndex = aIndex;
				pMsg.iGuildNumber = lpObj->CharacterData->GuildNumber;
...
void GameProtocol::PROTOCOL_CheckHackBreach(int aIndex, PMSG_ANTIHACK_BREACH *lpMsg) {
	LPOBJ lpObj = &gObj[aIndex];

	if (lpObj->Type != OBJ_USER) return;

	g_Log.AddC(TColor::Red, "[%s][%s][%s][%s] AntiHack breach -> Code:%d", lpObj->AccountID, lpObj->Name, lpObj->CharacterData->Ip_addr, lpObj->CharacterData->HWID, lpMsg->dwErrorCode);
	AntiHackLog->Output("[%s][%s][%s][%s] AntiHack breach -> Code: %d", lpObj->AccountID, lpObj->Name, lpObj->CharacterData->Ip_addr, lpObj->CharacterData->HWID, lpMsg->dwErrorCode);
...
void GameProtocol::PROTOCOL_HookAntiHack(int aIndex, PMSG_ANTIHACK_CHECK *lpMsg) {
	LPOBJ lpObj = &gObj[aIndex];
	...
	if (memcmp(lpMsg->checkdata, MainRecvHeader, 5) != 0 && g_ConfigRead.antihack.AntiHackRecvHookProtect == true) {	// data is wrong, recv is probably hooked
		g_Log.AddC(TColor::Red, "[%s][%s][%s][%s] AntiHack breach -> Recv header data is wrong", lpObj->AccountID, lpObj->Name, lpObj->CharacterData->Ip_addr, lpObj->CharacterData->HWID);
		AntiHackLog->Output("[%s][%s][%s][%s] AntiHack breach -> Recv header data is wrong", lpObj->AccountID, lpObj->Name, lpObj->CharacterData->Ip_addr, lpObj->CharacterData->HWID);
	} else lpObj->CharacterData->AntiHackCheckTime = GetTickCount();
}
...
void GameProtocol::CGReqRefinePentagramJewel(PMSG_REQ_REFINE_PENTAGRAM_JEWEL *lpMsg, int aIndex)
{
	...
	gObj[aIndex].CharacterData->m_bIsPentagramMixCompleted = true;
...
void GameProtocol::CGReqRegGuildMatchingList(PMSG_REQ_REGGUILDMATCHINGDATA *lpMsg, int nUserIndex)
{
	...
	int nGuildNumber = lpObj->CharacterData->GuildNumber;
	...
	memcpy(stGuildMatchingList.szGuildName, lpObj->CharacterData->GuildName, MAX_GUILD_LEN + 1);
	...
	stGuildMatchingList.nGuildMasterLevel = lpObj->Level + lpObj->CharacterData->MasterLevel;
...
void GameProtocol::CGReqJoinGuildMatching(PMSG_REQ_JOIN_GUILDMATCHING *lpMsg, int nUserIndex)
{
	...
	stAllowList.nApplicantLevel = lpObj->Level + lpObj->CharacterData->MasterLevel;
	...
	else if (lpObj->CharacterData->ChangeUP == 2)
	{
		stAllowList.btApplicantClass |= 0x08;
...
void GameProtocol::CGReqAllowJoinGuildMatching(PMSG_REQ_ALLOW_JOIN_GUILDMATCHING *lpMsg, int nUserIndex)
{
	...
	if (gObjIsConnected(lpObj))
	{
		GDReqAllowJoinGuildMatching(nUserIndex, lpMsg->nAllowType, szMemberName, lpObj->CharacterData->GuildName);
	}
}
...
void GameProtocol::CGReqRegWantedPartyMember(PMSG_REQ_REG_WANTED_PARTYMEMBER *lpMsg, int nUserIndex)
{
	...
	stList.nLeaderLevel = gObj[nUserIndex].Level + gObj[nUserIndex].CharacterData->MasterLevel;
	stList.btLeaderClass = gObj[nUserIndex].Class;
	stList.btApprovalType = lpMsg->btApprovalType;

	if (gObj[nUserIndex].CharacterData->ChangeUP == 1)
	{
		stList.btLeaderClass |= 0x08;
	}

	else if (gObj[nUserIndex].CharacterData->ChangeUP == 2)
	{
		stList.btLeaderClass |= 0x08;
...
void GameProtocol::GCDisplayBuffeffectPartyMember(int aIndex)
{
	...
	if (g_ConfigRead.server.GetServerType() == SERVER_BATTLECORE)
	{
		memcpy(pMsg.Name, lpObj->CharacterData->m_RealNameOfUBF, MAX_ACCOUNT_LEN+1);
	}
...
void GameProtocol::GCPartyMemberPosition(int nIndex)
{
	...
	if (gObj[nIndex].CharacterData->m_bSendMemberPos == FALSE)
	{
		return;
	}
	...
	if (ObjectMaxRange(nPartyNumber))
	{
		...
		for (int i = 0; i < 5; i++)
		{
			...
			if (g_ConfigRead.server.GetServerType() == SERVER_BATTLECORE)
			{
				memcpy(pMsg.stPosInfo[pMsg.btCount].szName, gObj[nTargetIndex].CharacterData->m_RealNameOfUBF, MAX_ACCOUNT_LEN + 1);
			}
...
void GameProtocol::CGReqSendMemberPosInfoStart(int nIndex)
{
	...
	gObj[nIndex].CharacterData->m_bSendMemberPos = TRUE;
}
...
void GameProtocol::CGReqSendMemberPosInfoStop(int nIndex)
{
	...
	gObj[nIndex].CharacterData->m_bSendMemberPos = FALSE;
}
...
void GameProtocol::GCReqSendNpcPosInfo(PMSG_REQ_NPC_POSITION *lpMsg, int nIndex)
{
	...
	if (lpMsg->btType)
	{
		gObj[nIndex].CharacterData->m_bSendNpcPos = FALSE;
	}

	else
	{
		gObj[nIndex].CharacterData->m_bSendNpcPos = TRUE;
	}
}
...
void GameProtocol::CGReqCCF_EnterCheck(int iIndex)
{
	...
	if (gObj[iIndex].CharacterData->lpGuild && gObj[iIndex].CharacterData->lpGuild->WarState == 1)
	{
		PMSG_NOTICE pNotice;
...
void GameProtocol::CGMuunItemSellRequestRecv(PMSG_MUUN_ITEM_SELLREQUEST *lpMsg, int aIndex)
{
	...
	else
	{
		...
		lpObj->CharacterData->Money += sellmoney;
		pResult.Result = 1;
		pResult.Money = lpObj->CharacterData->Money;
...
bool GameProtocol::CGEventItemDropRequest(PMSG_EVENTITEM_THROW *lpMsg, int aIndex)
{
	...
	if (pResult.Result == 1)
	{
		...
		if (bIsItem == TRUE)
		{
			...
			{
				if (MapC[map].ItemDrop(type, level, dur, lpMsg->px, lpMsg->py, Option1, Option2, Option3, NOption, SOption, serial2, aIndex, PetLevel, PetExp, btItemEffectEx, SocketOption, SocketIndex, 0) == TRUE)
				{
					gObjEventInventoryDeleteItem(aIndex, lpMsg->Ipos);
					pResult.Result = true;
...
void GameProtocol::CG_ReqAcceptEnterITR(PMSG_REQ_ACCEPTENTER_ITR *lpMsg, int iIndex)
{
	...
	if (gParty.AllAgreeEnterITR(lpObj->PartyNumber) == FALSE)
	{
		g_Log.Add("[ ITR ] [CGReqAcceptEnterITR] Enter Agree NAME:%s, G.NAME:%s,AgreeCnt:%d",
			lpObj->Name, lpObj->CharacterData->GuildName, gParty.ReturnOKCountITR(lpObj->PartyNumber));
		return;
	}
...
BYTE GameProtocol::EnterITRCheckUser(int iIndex, int &TroubleUserIndex)
{
	...
	for (int i = 0; i < MAX_USER_IN_PARTY; i++)
	{
		...
		if (useridx > 0)
		{
			...
			if (gObj[useridx].CharacterData->lpGuild != NULL &&
				gObj[useridx].CharacterData->lpGuild->WarState == TRUE)
			{
				return 16;
			}
...
void GameProtocol::CGReqDSFEnter(int iIndex)
{
	...
	if (gParty.GetLorenMarketUserCount(gObj[iIndex].PartyNumber) != 2)
	{
		g_Log.Add("[DSF][CGReqDSFEnter][%s][%s][%s][%d] EnterError : Party User is not in RorenMarket",
			gObj[iIndex].AccountID, gObj[iIndex].CharacterData->m_RealNameOfUBF, gObj[iIndex].Name, gObj[iIndex].CharacterData->m_nServerCodeOfHomeWorld);
	...
	if (g_DevilSquareFinal.m_nDSF_TYPE == 1)
	{
		...
		if (bUpdateOk != FALSE)
		{
			g_Log.Add("[DSF][CGReqDSFEnter][%s][%s][%s][%d] ERROR code:%d",
				gObj[iIndex].AccountID, gObj[iIndex].CharacterData->m_RealNameOfUBF, gObj[iIndex].Name, gObj[iIndex].CharacterData->m_nServerCodeOfHomeWorld, bUpdateOk);
		...
		for (int i = 0; i < 2; i++)
		{
			...
			if (useridx > 0)
			{
				...
				g_Log.Add("[DSF][CGReqDSFEnter][%s][%s][%s][%d] Request DSF Enter Success And Ask To Party Member, DSFType : %d",
					gObj[iIndex].AccountID, gObj[iIndex].CharacterData->m_RealNameOfUBF, 
					gObj[iIndex].Name, gObj[iIndex].CharacterData->m_nServerCodeOfHomeWorld,
	...
	else if (g_DevilSquareFinal.m_nDSF_TYPE == 2)
	{
		...
		for (int i = 0; i < 2; i++)
		{
			...
			if (useridx > 0)
			{
				if (i == 0)
				{
					memcpy(szUserName1, gObj[useridx].CharacterData->m_NameConvertOfUBF.ConvertNameToRealName(gObj[useridx].Name), MAX_ACCOUNT_LEN+1);
					wServerCode1 = gObj[useridx].CharacterData->m_NameConvertOfUBF.FindServerCodeAtCharacterName(gObj[useridx].Name);
				}

				else if (i == 1)
				{
					memcpy(szUserName2, gObj[useridx].CharacterData->m_NameConvertOfUBF.ConvertNameToRealName(gObj[useridx].Name), MAX_ACCOUNT_LEN+1);
					wServerCode2 = gObj[useridx].CharacterData->m_NameConvertOfUBF.FindServerCodeAtCharacterName(gObj[useridx].Name);
				}
			}
		}
...
void GameProtocol::CGReqAcceptEnterDSF(PMSG_REQ_DSF_ACCEPTENTER *lpMsg, int iIndex)
{
	...
	if (gParty.IsParty(lpObj->PartyNumber) == FALSE)
	{
		g_Log.Add("[DSF][CGReqAcceptEnterDSF][%s][%s][%s][%d] reqman is not party Error",
			lpObj->AccountID, lpObj->CharacterData->m_RealNameOfUBF,
			lpObj->Name, lpObj->CharacterData->m_nServerCodeOfHomeWorld);
	...
	if (gParty.AllAgreeEnterDSF(lpObj->PartyNumber) == FALSE)
	{
		...
		g_Log.Add("[DSF[CGReqAcceptEnterDSF][%s][%s][%s][%d] Party Enter Agree AgreeCnt:%d",
			lpObj->AccountID, lpObj->CharacterData->m_RealNameOfUBF,
			lpObj->Name, lpObj->CharacterData->m_nServerCodeOfHomeWorld, AgreeCnt);
		...
		if (useridx != -1)
		{
			...
			if (bReturn != FALSE)
			{
				g_Log.Add("[DSF][Find_ExistingPartyInfo][%s][%s][%s][%d] ERROR bReturn:%d, mapnumber:%d, btSlotNum:%d ",
					lpObj->AccountID, lpObj->CharacterData->m_RealNameOfUBF, lpObj->Name, lpObj->CharacterData->m_nServerCodeOfHomeWorld,
			...
			else
			{
				...
				g_Log.Add("[DSF][CGReqAcceptEnterDSF][%s][%s][%s][%d] Enter DSF - PartyNo:%d, btSlotNum:%d ",
						gObj[useridx].AccountID, gObj[useridx].CharacterData->m_RealNameOfUBF,
					gObj[useridx].Name, gObj[useridx].CharacterData->m_nServerCodeOfHomeWorld,
...
void GameProtocol::PROTOCOL_CheckHitHack(int aIndex, PMSG_SEND_HITHACK_INFO * lpMsg) {
	if (!g_ConfigRead.data.common.bHitHackDetection) return;
	if (!ObjectMaxRange(aIndex)) return;
	if (!gObjIsConnectedGP(aIndex)) return;
	...
	if (lpObj->CharacterData->Dexterity > g_ConfigRead.data.common.iHitHackMaxAgility) {
		lpObj->CharacterData->dwLastHitHackTick = GetTickCount64();
		return;
	}

	if ((lpObj->CharacterData->dwHitHackCounter1 + 1) % 7 != 0) {
		lpObj->CharacterData->dwLastHitHackValue1[lpObj->CharacterData->dwHitHackCounter1] = lpMsg->dwHitHackVal1;
		lpObj->CharacterData->dwLastHitHackValue2[lpObj->CharacterData->dwHitHackCounter1] = lpMsg->dwHitHackVal2;
		lpObj->CharacterData->dwHitHackCounter1++;
	} else {
		lpObj->CharacterData->dwLastHitHackValue1[6] = lpMsg->dwHitHackVal1;
		lpObj->CharacterData->dwLastHitHackValue2[6] = lpMsg->dwHitHackVal2;
		lpObj->CharacterData->dwHitHackCounter1 = 0;
	}
  
	for (int i = 0; i < 6; i++) {
        if (lpObj->CharacterData->dwLastHitHackValue1[i] != lpObj->CharacterData->dwLastHitHackValue1[i + 1]) bMismatchFound = true;
    }
    
	if (!bMismatchFound) {
		if (lpObj->CharacterData->dwLastHitHackValue1[0] != 0) bIsAllValues1Equal = true;
	}

	bMismatchFound = false;
   
	for (int i = 0; i < 6; i++) {
        if (lpObj->CharacterData->dwLastHitHackValue2[i] != lpObj->CharacterData->dwLastHitHackValue2[i + 1]) bMismatchFound = true;
    }

	if (!bMismatchFound) {
		if (lpObj->CharacterData->dwLastHitHackValue2[0] != 0) bIsAllValues2Equal = true;
	}

	if (bIsAllValues1Equal || bIsAllValues2Equal) {
		g_Log.AddC(TColor::Red,"[AntiHack][%s][%s][%s] Hit Hack detected", lpObj->CharacterData->Ip_addr, lpObj->AccountID, lpObj->Name);
		AntiHackLog->Output("[AntiHack][%s][%s][%s] Hit Hack detected", lpObj->CharacterData->Ip_addr, lpObj->AccountID, lpObj->Name);
