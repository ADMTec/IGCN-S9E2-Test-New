...
void CMonsterAttr::LoadAttr(char* filename) {
	...
	for (pugi::xml_node monster = main_section.child("Monster"); monster; monster = monster.next_sibling()) {
		...
		this->m_MonsterAttr[nCount].Defense = monster.attribute("Defense").as_int(0);
		this->m_MonsterAttr[nCount].m_MagicDefense = monster.attribute("MagicDefense").as_int(0);
		this->m_MonsterAttr[nCount].HitRating = monster.attribute("AttackRate").as_int(0);
		...
		this->m_MonsterAttr[nCount].AttackSpeed = monster.attribute("AttackSpeed").as_int(0);
		...
		this->m_MonsterAttr[nCount].m_Resistance[R_COLD] = monster.attribute("IceRes").as_int(0);
		...
		this->m_MonsterAttr[nCount].m_Resistance[R_EARTH] = monster.attribute("EarthRes").as_int(0);
		this->m_MonsterAttr[nCount].m_Resistance[R_WIND] = monster.attribute("WindRes").as_int(0);
		this->m_MonsterAttr[nCount].m_Resistance[R_WATER] = monster.attribute("WaterRes").as_int(0);
