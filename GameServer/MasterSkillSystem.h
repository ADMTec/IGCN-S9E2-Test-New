...
public:
	...
	bool ML_LevelUp(LPOBJ lpObj, UINT64& addexp, int iMonsterType, const char* szEventType);
	UINT64 ML_CalcNextMLExp(LPOBJ lpObj);
	bool ML_IsMasterCharacter(LPOBJ lpObj);
	bool ML_ReceiveExp(LPOBJ lpObj, LPOBJ lpTargetObj);
	void ML_SetExpTable();
