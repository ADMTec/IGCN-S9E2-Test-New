...
static char * ServerCSText[1] = { "! CASTLE SIEGE ONGOING !" };
static char * ServerCWText[1] = { "! CRYWOLF ONGOING !" };
static char * ServerTypeText[1] = {	"- MU ONLINE SERVER -" };
static char * ServerErrorText[1] = { "! ERROR !" };
...
static char * AuthMessage[1] = { "AuthServer - disconnected, reconnecting", };
