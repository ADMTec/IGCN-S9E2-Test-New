...
{
	ITEMGET(12,15), 1, ITEMGET(14,13), 2,	// Chaos Castle 1
	ITEMGET(12,15), 1, ITEMGET(14,13), 2,	// Chaos Castle 2
	ITEMGET(12,15), 2, ITEMGET(14,13), 4,	// Chaos Castle 3
	ITEMGET(12,15), 2, ITEMGET(14,13), 4,	// Chaos Castle 4
	ITEMGET(12,15), 3, ITEMGET(14,13), 6,	// Chaos Castle 5
	ITEMGET(12,15), 3, ITEMGET(14,13), 6,	// Chaos Castle 6
	ITEMGET(12,15), 4, ITEMGET(14,13), 8	// Chaos Castle 7
};
...
public:
	...
	int CC_SendRewardEXP(int iUserIndex, int iEXP);
	int CC_CalcRewardEXP(int iUserIndex, UINT64 iAddExp);
	...
	void CC_RewardUserEXP(int iChaosCastleIndex, int iChaosCastleSubIndex, BOOL bWinner);
	void ProcessTrapStatus(int iChaosCastleIndex);
	void CalUsersInTrap(int iChaosCastleIndex);
	int CC_CheckTransformationRing(int iUserIndex);
