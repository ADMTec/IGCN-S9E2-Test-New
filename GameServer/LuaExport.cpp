...
void LuaExport::AddTable(lua_State* Lua) {
	lua_register(Lua, "PROTOCOL_NPCChatSend", this->LuaChatTargetSend);
	...
	lua_register(Lua, "CHARACTER_CalcDistance", this->LuagObjCalDistance);
	...
	lua_register(Lua, "BUFF_AddBuffEffect", this->LuagObjAddBuffEffect);
	lua_register(Lua, "PROTOCOL_ReFillSend", this->LuaGCReFillSend);
	lua_register(Lua, "PROTOCOL_ManaSend", this->LuaGCManaSend);
	...
	lua_register(Lua, "CHARACTER_GuildMasterCapacityTest", this->LuagObjGuildMasterCapacityTest);
