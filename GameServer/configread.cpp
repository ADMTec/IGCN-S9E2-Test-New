...
void CConfigread::ReadConfig() {
	...
	this->data.common.LoadCustom = ReadCommon.ReadInt("General", "CustomSettingsByLeylei", 0);
	...
	if (this->data.common.GuardSayText.length() > 60) g_Log.MsgBox("Error -  Guard Say text is too long");
	...
	// Custom Settings By Leylei
	this->data.common.FreeWarehouse = ReadCommon.ReadInt("General", "FreeWarehouse", 0);
	this->data.common.joinmuDropItemUnderCharacter[0] = ReadCommon.ReadInt("General", "IsDropItemUnderCharacterDW", 0);
	this->data.common.joinmuDropItemUnderCharacter[1] = ReadCommon.ReadInt("General", "IsDropItemUnderCharacterDK", 0);
	this->data.common.joinmuDropItemUnderCharacter[2] = ReadCommon.ReadInt("General", "IsDropItemUnderCharacterElf", 0);
	this->data.common.joinmuDropItemUnderCharacter[3] = ReadCommon.ReadInt("General", "IsDropItemUnderCharacterMG", 0);
	this->data.common.joinmuDropItemUnderCharacter[4] = ReadCommon.ReadInt("General", "IsDropItemUnderCharacterDL", 0);
	this->data.common.joinmuDropItemUnderCharacter[5] = ReadCommon.ReadInt("General", "IsDropItemUnderCharacterSU", 0);
	this->data.common.joinmuDropItemUnderCharacter[6] = ReadCommon.ReadInt("General", "IsDropItemUnderCharacterRF", 0);
	this->data.common.joinmuDropItemUnderCharacter[7] = ReadCommon.ReadInt("General", "IsDropItemUnderCharacterGL", 0);
}
...
void CConfigread::ReadCalcCharacter()
{
	...
	this->calc.PvMDamageRate[CLASS_MAGICGLADIATOR] = ReadCalChar.ReadInt("PvMDamage", "MGPvMDamageRate", 100);
	...
	this->calc.ElementalPvMDamageRate[CLASS_MAGICGLADIATOR] = ReadCalChar.ReadInt("Elemental", "MGPvMDamageRate", 100);
